...
const Ping$json = const {
  ...
  '2': const [
    ...
    const {'1': 'should_trigger_active_user', '3': 3, '4': 1, '5': 8, '10': 'shouldTriggerActiveUser'},
  ],
};

/// Descriptor for `Ping`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List pingDescriptor = $convert.base64Decode('CgRQaW5nEiQKDmxhc3RfcG9uZ190aW1lGAEgASgDUgxsYXN0UG9uZ1RpbWUSKAoQY2xpZW50X2lzX2FjdGl2ZRgCIAEoCFIOY2xpZW50SXNBY3RpdmUSOwoac2hvdWxkX3RyaWdnZXJfYWN0aXZlX3VzZXIYAyABKAhSF3Nob3VsZFRyaWdnZXJBY3RpdmVVc2Vy');
