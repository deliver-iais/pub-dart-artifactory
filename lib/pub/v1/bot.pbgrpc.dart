...
class BotServiceClient extends $grpc.Client {
  ...
  static final _$callbackQuery =
      $grpc.ClientMethod<$2.CallbackQueryReq, $2.CallbackQueryRes>(
          '/proto.pub.v1.bot.BotService/CallbackQuery',
          ($2.CallbackQueryReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $2.CallbackQueryRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.CallbackQueryRes> callbackQuery(
      $2.CallbackQueryReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$callbackQuery, request, options: options);
  }
}
...
abstract class BotServiceBase extends $grpc.Service {
  ...
  BotServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.CallbackQueryReq, $2.CallbackQueryRes>(
        'CallbackQuery',
        callbackQuery_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.CallbackQueryReq.fromBuffer(value),
        ($2.CallbackQueryRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$2.CallbackQueryRes> callbackQuery_Pre($grpc.ServiceCall call,
      $async.Future<$2.CallbackQueryReq> request) async {
    return callbackQuery(call, await request);
  }
  ...
  $async.Future<$2.CallbackQueryRes> callbackQuery(
      $grpc.ServiceCall call, $2.CallbackQueryReq request);
}
