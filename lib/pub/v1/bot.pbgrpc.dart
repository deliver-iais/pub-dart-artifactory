...
class BotServiceClient extends $grpc.Client {
  ...
  static final _$inlineQuery =
      $grpc.ClientMethod<$1.InlineQueryReq, $1.InlineQueryRes>(
          '/proto.pub.v1.bot.BotService/InlineQuery',
          ($1.InlineQueryReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.InlineQueryRes.fromBuffer(value));
  static final _$formQuery =
      $grpc.ClientMethod<$1.FormQueryReq, $1.FormQueryRes>(
          '/proto.pub.v1.bot.BotService/FormQuery',
          ($1.FormQueryReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.FormQueryRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.InlineQueryRes> inlineQuery($1.InlineQueryReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$inlineQuery, request, options: options);
  }

  $grpc.ResponseFuture<$1.FormQueryRes> formQuery($1.FormQueryReq request,
      {$grpc.CallOptions? options}) {
...
abstract class BotServiceBase extends $grpc.Service {
  ...
  BotServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.InlineQueryReq, $1.InlineQueryRes>(
        'InlineQuery',
        inlineQuery_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.InlineQueryReq.fromBuffer(value),
        ($1.InlineQueryRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.FormQueryReq, $1.FormQueryRes>(
        'FormQuery',
        formQuery_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $1.FormQueryReq.fromBuffer(value),
        ($1.FormQueryRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$1.InlineQueryRes> inlineQuery_Pre(
      $grpc.ServiceCall call, $async.Future<$1.InlineQueryReq> request) async {
    return inlineQuery(call, await request);
  }

  $async.Future<$1.FormQueryRes> formQuery_Pre(
      $grpc.ServiceCall call, $async.Future<$1.FormQueryReq> request) async {
  ...
  $async.Future<$1.InlineQueryRes> inlineQuery(
      $grpc.ServiceCall call, $1.InlineQueryReq request);
  $async.Future<$1.FormQueryRes> formQuery(
      $grpc.ServiceCall call, $1.FormQueryReq request);
}
