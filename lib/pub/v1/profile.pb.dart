...
import 'models/phone.pb.dart' as $25;
import 'models/contact.pb.dart' as $26;
import 'models/user.pb.dart' as $27;
import 'models/uid.pb.dart' as $13;
import 'models/session.pb.dart' as $28;
...
class GetVerificationCodeReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetVerificationCodeReq', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$25.PhoneNumber>(1, 'phoneNumber', subBuilder: $25.PhoneNumber.create)
  ...
  @$pb.TagNumber(1)
  $25.PhoneNumber get phoneNumber => $_getN(0);
  @$pb.TagNumber(1)
  set phoneNumber($25.PhoneNumber v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPhoneNumber() => $_has(0);
  @$pb.TagNumber(1)
  void clearPhoneNumber() => clearField(1);
  @$pb.TagNumber(1)
  $25.PhoneNumber ensurePhoneNumber() => $_ensure(0);
...
class SaveContactsReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SaveContactsReq', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$26.Contact>(2, 'contactList', $pb.PbFieldType.PM, protoName: 'contactList', subBuilder: $26.Contact.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$26.Contact> get contactList => $_getList(0);
}
...
class GetContactListUsersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetContactListUsersRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$27.UserAsContact>(1, 'userList', $pb.PbFieldType.PM, protoName: 'userList', subBuilder: $27.UserAsContact.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$27.UserAsContact> get userList => $_getList(0);
...
class GetContactListRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetContactListRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$26.Contact>(1, 'contactList', $pb.PbFieldType.PM, protoName: 'contactList', subBuilder: $26.Contact.create)
    ..a<$core.int>(2, 'nextPageNumber', $pb.PbFieldType.O3)
    ..a<$core.int>(3, 'totalSize', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class GetUserByUidRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetUserByUidRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$27.UserAsContact>(1, 'user', subBuilder: $27.UserAsContact.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $27.UserAsContact get user => $_getN(0);
  @$pb.TagNumber(1)
  set user($27.UserAsContact v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUser() => $_has(0);
  @$pb.TagNumber(1)
  void clearUser() => clearField(1);
  @$pb.TagNumber(1)
  $27.UserAsContact ensureUser() => $_ensure(0);
}
...
class GetUserProfileRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetUserProfileRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$27.UserPrivateData>(1, 'profile', subBuilder: $27.UserPrivateData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $27.UserPrivateData get profile => $_getN(0);
  @$pb.TagNumber(1)
  set profile($27.UserPrivateData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProfile() => $_has(0);
  @$pb.TagNumber(1)
  void clearProfile() => clearField(1);
  @$pb.TagNumber(1)
  $27.UserPrivateData ensureProfile() => $_ensure(0);
}
...
class GetMySessionsRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetMySessionsRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$28.Session>(1, 'sessions', $pb.PbFieldType.PM, subBuilder: $28.Session.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$28.Session> get sessions => $_getList(0);
}
