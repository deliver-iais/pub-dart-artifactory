...
import 'models/phone.pb.dart' as $38;
import 'models/platform.pb.dart' as $17;
import 'models/contact.pb.dart' as $39;
import 'models/user.pb.dart' as $40;
import 'models/uid.pb.dart' as $20;
import 'models/session.pb.dart' as $41;

import 'profile.pbenum.dart';

export 'profile.pbenum.dart';

class DownloadLink extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DownloadLink', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'url')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'label')
    ..hasRequiredFields = false
  ;

  DownloadLink._() : super();
  factory DownloadLink({
    $core.String? url,
    $core.String? label,
  }) {
  ...
  factory DownloadLink.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DownloadLink.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DownloadLink clone() => DownloadLink()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DownloadLink copyWith(void Function(DownloadLink) updates) => super.copyWith((message) => updates(message as DownloadLink)) as DownloadLink; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DownloadLink create() => DownloadLink._();
  DownloadLink createEmptyInstance() => create();
  static $pb.PbList<DownloadLink> createRepeated() => $pb.PbList<DownloadLink>();
  @$core.pragma('dart2js:noInline')
  static DownloadLink getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DownloadLink>(create);
  static DownloadLink? _defaultInstance;
...
class NewerVersionInformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NewerVersionInformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ...
    ..pc<DownloadLink>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'downloadLinks', $pb.PbFieldType.PM, subBuilder: DownloadLink.create)
    ..hasRequiredFields = false
  ;

  NewerVersionInformation._() : super();
  factory NewerVersionInformation({
    $core.String? version,
    $core.String? description,
    $core.String? size,
    $core.Iterable<DownloadLink>? downloadLinks,
  }) {
    final _result = create();
    if (version != null) {
    ...
    if (downloadLinks != null) {
      _result.downloadLinks.addAll(downloadLinks);
    }
    return _result;
  }
  factory NewerVersionInformation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory NewerVersionInformation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  NewerVersionInformation clone() => NewerVersionInformation()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NewerVersionInformation copyWith(void Function(NewerVersionInformation) updates) => super.copyWith((message) => updates(message as NewerVersionInformation)) as NewerVersionInformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static NewerVersionInformation create() => NewerVersionInformation._();
  NewerVersionInformation createEmptyInstance() => create();
  static $pb.PbList<NewerVersionInformation> createRepeated() => $pb.PbList<NewerVersionInformation>();
  @$core.pragma('dart2js:noInline')
  static NewerVersionInformation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<NewerVersionInformation>(create);
  static NewerVersionInformation? _defaultInstance;
  ...
  @$pb.TagNumber(4)
  $core.List<DownloadLink> get downloadLinks => $_getList(3);
}
...
class GetVerificationCodeReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetVerificationCodeReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$38.PhoneNumber>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber', subBuilder: $38.PhoneNumber.create)
  ...
  @$pb.TagNumber(1)
  $38.PhoneNumber get phoneNumber => $_getN(0);
  @$pb.TagNumber(1)
  set phoneNumber($38.PhoneNumber v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPhoneNumber() => $_has(0);
  @$pb.TagNumber(1)
  void clearPhoneNumber() => clearField(1);
  @$pb.TagNumber(1)
  $38.PhoneNumber ensurePhoneNumber() => $_ensure(0);
...
class GetVerificationCodeRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetVerificationCodeRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ...
    ..aOM<NewerVersionInformation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newerVersionInformation', subBuilder: NewerVersionInformation.create)
    ..hasRequiredFields = false
  ;
  ...
  factory GetVerificationCodeRes({
    VerificationType? type,
    NewerVersionInformation? newerVersionInformation,
  }) {
    final _result = create();
    if (type != null) {
      _result.type = type;
    }
    if (newerVersionInformation != null) {
      _result.newerVersionInformation = newerVersionInformation;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  NewerVersionInformation get newerVersionInformation => $_getN(1);
  @$pb.TagNumber(2)
  set newerVersionInformation(NewerVersionInformation v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasNewerVersionInformation() => $_has(1);
  @$pb.TagNumber(2)
  void clearNewerVersionInformation() => clearField(2);
  @$pb.TagNumber(2)
  NewerVersionInformation ensureNewerVersionInformation() => $_ensure(1);
}
...
class VerifyCodeReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VerifyCodeReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ...
    ..aOM<$17.Platform>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'platform', subBuilder: $17.Platform.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $17.Platform get platform => $_getN(4);
  @$pb.TagNumber(5)
  set platform($17.Platform v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPlatform() => $_has(4);
  @$pb.TagNumber(5)
  void clearPlatform() => clearField(5);
  @$pb.TagNumber(5)
  $17.Platform ensurePlatform() => $_ensure(4);
}
...
class GetWebViewIdentifyTokenReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetWebViewIdentifyTokenReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  GetWebViewIdentifyTokenReq._() : super();
  factory GetWebViewIdentifyTokenReq() => create();
  factory GetWebViewIdentifyTokenReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetWebViewIdentifyTokenReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetWebViewIdentifyTokenReq clone() => GetWebViewIdentifyTokenReq()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetWebViewIdentifyTokenReq copyWith(void Function(GetWebViewIdentifyTokenReq) updates) => super.copyWith((message) => updates(message as GetWebViewIdentifyTokenReq)) as GetWebViewIdentifyTokenReq; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetWebViewIdentifyTokenReq create() => GetWebViewIdentifyTokenReq._();
  GetWebViewIdentifyTokenReq createEmptyInstance() => create();
  static $pb.PbList<GetWebViewIdentifyTokenReq> createRepeated() => $pb.PbList<GetWebViewIdentifyTokenReq>();
  @$core.pragma('dart2js:noInline')
  static GetWebViewIdentifyTokenReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetWebViewIdentifyTokenReq>(create);
  static GetWebViewIdentifyTokenReq? _defaultInstance;
}

class GetWebViewIdentifyTokenRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetWebViewIdentifyTokenRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identifyToken', protoName: 'identifyToken')
    ..hasRequiredFields = false
  ;

  GetWebViewIdentifyTokenRes._() : super();
  factory GetWebViewIdentifyTokenRes({
    $core.String? identifyToken,
  }) {
    final _result = create();
    if (identifyToken != null) {
      _result.identifyToken = identifyToken;
    }
    return _result;
  }
  factory GetWebViewIdentifyTokenRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetWebViewIdentifyTokenRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetWebViewIdentifyTokenRes clone() => GetWebViewIdentifyTokenRes()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetWebViewIdentifyTokenRes copyWith(void Function(GetWebViewIdentifyTokenRes) updates) => super.copyWith((message) => updates(message as GetWebViewIdentifyTokenRes)) as GetWebViewIdentifyTokenRes; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetWebViewIdentifyTokenRes create() => GetWebViewIdentifyTokenRes._();
  GetWebViewIdentifyTokenRes createEmptyInstance() => create();
  static $pb.PbList<GetWebViewIdentifyTokenRes> createRepeated() => $pb.PbList<GetWebViewIdentifyTokenRes>();
  @$core.pragma('dart2js:noInline')
  static GetWebViewIdentifyTokenRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetWebViewIdentifyTokenRes>(create);
  static GetWebViewIdentifyTokenRes? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get identifyToken => $_getSZ(0);
  @$pb.TagNumber(1)
  set identifyToken($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasIdentifyToken() => $_has(0);
  @$pb.TagNumber(1)
  void clearIdentifyToken() => clearField(1);
}
...
class AccessTokenRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessTokenRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ...
    ..aOM<NewerVersionInformation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newerVersionInformation', subBuilder: NewerVersionInformation.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  NewerVersionInformation get newerVersionInformation => $_getN(5);
  @$pb.TagNumber(6)
  set newerVersionInformation(NewerVersionInformation v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNewerVersionInformation() => $_has(5);
  @$pb.TagNumber(6)
  void clearNewerVersionInformation() => clearField(6);
  @$pb.TagNumber(6)
  NewerVersionInformation ensureNewerVersionInformation() => $_ensure(5);
}
...
class RenewAccessTokenReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RenewAccessTokenReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ...
    ..aOM<$17.Platform>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'platform', subBuilder: $17.Platform.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $17.Platform get platform => $_getN(1);
  @$pb.TagNumber(2)
  set platform($17.Platform v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPlatform() => $_has(1);
  @$pb.TagNumber(2)
  void clearPlatform() => clearField(2);
  @$pb.TagNumber(2)
  $17.Platform ensurePlatform() => $_ensure(1);
}
...
class RenewAccessTokenRes extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  NewerVersionInformation get newerVersionInformation => $_getN(2);
  @$pb.TagNumber(6)
  set newerVersionInformation(NewerVersionInformation v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasNewerVersionInformation() => $_has(2);
  @$pb.TagNumber(6)
  void clearNewerVersionInformation() => clearField(6);
  @$pb.TagNumber(6)
  NewerVersionInformation ensureNewerVersionInformation() => $_ensure(2);
}
...
class SendErasePasswordEmailReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SendErasePasswordEmailReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$38.PhoneNumber>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber', subBuilder: $38.PhoneNumber.create)
    ..aOM<$17.Platform>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'platform', subBuilder: $17.Platform.create)
    ..hasRequiredFields = false
  ;

  SendErasePasswordEmailReq._() : super();
  factory SendErasePasswordEmailReq({
    $38.PhoneNumber? phoneNumber,
    $17.Platform? platform,
  }) {
    final _result = create();
  ...
  factory SendErasePasswordEmailReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SendErasePasswordEmailReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SendErasePasswordEmailReq clone() => SendErasePasswordEmailReq()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SendErasePasswordEmailReq copyWith(void Function(SendErasePasswordEmailReq) updates) => super.copyWith((message) => updates(message as SendErasePasswordEmailReq)) as SendErasePasswordEmailReq; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SendErasePasswordEmailReq create() => SendErasePasswordEmailReq._();
  SendErasePasswordEmailReq createEmptyInstance() => create();
  static $pb.PbList<SendErasePasswordEmailReq> createRepeated() => $pb.PbList<SendErasePasswordEmailReq>();
  @$core.pragma('dart2js:noInline')
  static SendErasePasswordEmailReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SendErasePasswordEmailReq>(create);
  static SendErasePasswordEmailReq? _defaultInstance;
...
class SendErasePasswordEmailRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SendErasePasswordEmailRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<NewerVersionInformation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newerVersionInformation', subBuilder: NewerVersionInformation.create)
    ..hasRequiredFields = false
  ;

  SendErasePasswordEmailRes._() : super();
  factory SendErasePasswordEmailRes({
    NewerVersionInformation? newerVersionInformation,
  }) {
    final _result = create();
    if (newerVersionInformation != null) {
  ...
  factory SendErasePasswordEmailRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SendErasePasswordEmailRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SendErasePasswordEmailRes clone() => SendErasePasswordEmailRes()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SendErasePasswordEmailRes copyWith(void Function(SendErasePasswordEmailRes) updates) => super.copyWith((message) => updates(message as SendErasePasswordEmailRes)) as SendErasePasswordEmailRes; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SendErasePasswordEmailRes create() => SendErasePasswordEmailRes._();
  SendErasePasswordEmailRes createEmptyInstance() => create();
  static $pb.PbList<SendErasePasswordEmailRes> createRepeated() => $pb.PbList<SendErasePasswordEmailRes>();
  @$core.pragma('dart2js:noInline')
  static SendErasePasswordEmailRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SendErasePasswordEmailRes>(create);
  static SendErasePasswordEmailRes? _defaultInstance;

  @$pb.TagNumber(1)
  NewerVersionInformation get newerVersionInformation => $_getN(0);
  @$pb.TagNumber(1)
  set newerVersionInformation(NewerVersionInformation v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasNewerVersionInformation() => $_has(0);
  @$pb.TagNumber(1)
  void clearNewerVersionInformation() => clearField(1);
  @$pb.TagNumber(1)
  NewerVersionInformation ensureNewerVersionInformation() => $_ensure(0);
}

class ErasePasswordReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ErasePasswordReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hash')
    ..hasRequiredFields = false
  ;

  ErasePasswordReq._() : super();
  factory ErasePasswordReq({
    $core.String? hash,
  }) {
    final _result = create();
    if (hash != null) {
  ...
  factory ErasePasswordReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ErasePasswordReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ErasePasswordReq clone() => ErasePasswordReq()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ErasePasswordReq copyWith(void Function(ErasePasswordReq) updates) => super.copyWith((message) => updates(message as ErasePasswordReq)) as ErasePasswordReq; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ErasePasswordReq create() => ErasePasswordReq._();
  ErasePasswordReq createEmptyInstance() => create();
  static $pb.PbList<ErasePasswordReq> createRepeated() => $pb.PbList<ErasePasswordReq>();
  @$core.pragma('dart2js:noInline')
  static ErasePasswordReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ErasePasswordReq>(create);
  static ErasePasswordReq? _defaultInstance;
...
class ErasePasswordRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ErasePasswordRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  ErasePasswordRes._() : super();
  factory ErasePasswordRes() => create();
  factory ErasePasswordRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ErasePasswordRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ErasePasswordRes clone() => ErasePasswordRes()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ErasePasswordRes copyWith(void Function(ErasePasswordRes) updates) => super.copyWith((message) => updates(message as ErasePasswordRes)) as ErasePasswordRes; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ErasePasswordRes create() => ErasePasswordRes._();
  ErasePasswordRes createEmptyInstance() => create();
  static $pb.PbList<ErasePasswordRes> createRepeated() => $pb.PbList<ErasePasswordRes>();
  @$core.pragma('dart2js:noInline')
  static ErasePasswordRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ErasePasswordRes>(create);
  static ErasePasswordRes? _defaultInstance;
}
...
class SaveContactsReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SaveContactsReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$39.Contact>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactList', $pb.PbFieldType.PM, subBuilder: $39.Contact.create)
    ..pc<$38.PhoneNumber>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'returnUserContactByPhoneNumberList', $pb.PbFieldType.PM, subBuilder: $38.PhoneNumber.create)
    ..hasRequiredFields = false
  ;

  SaveContactsReq._() : super();
  factory SaveContactsReq({
    $core.Iterable<$39.Contact>? contactList,
    $core.Iterable<$38.PhoneNumber>? returnUserContactByPhoneNumberList,
  }) {
    final _result = create();
    if (contactList != null) {
  ...
  @$pb.TagNumber(2)
  $core.List<$39.Contact> get contactList => $_getList(0);

  @$pb.TagNumber(3)
  $core.List<$38.PhoneNumber> get returnUserContactByPhoneNumberList => $_getList(1);
}
...
class SaveContactsRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SaveContactsRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$40.UserAsContact>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userList', $pb.PbFieldType.PM, protoName: 'user_List', subBuilder: $40.UserAsContact.create)
    ..hasRequiredFields = false
  ;

  SaveContactsRes._() : super();
  factory SaveContactsRes({
    $core.Iterable<$40.UserAsContact>? userList,
  }) {
    final _result = create();
    if (userList != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$40.UserAsContact> get userList => $_getList(0);
}
...
class GetContactListUsersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetContactListUsersRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$40.UserAsContact>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userList', $pb.PbFieldType.PM, protoName: 'userList', subBuilder: $40.UserAsContact.create)
...
class GetContactListRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetContactListRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$39.Contact>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactList', $pb.PbFieldType.PM, protoName: 'contactList', subBuilder: $39.Contact.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageNumber', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalSize', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class GetUserByUidRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetUserByUidRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$40.UserAsContact>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'user', subBuilder: $40.UserAsContact.create)
    ..hasRequiredFields = false
  ;

  GetUserByUidRes._() : super();
  factory GetUserByUidRes({
    $40.UserAsContact? user,
  }) {
    final _result = create();
    if (user != null) {
      _result.user = user;
  ...
  @$pb.TagNumber(1)
  $40.UserAsContact get user => $_getN(0);
  @$pb.TagNumber(1)
  set user($40.UserAsContact v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUser() => $_has(0);
  @$pb.TagNumber(1)
  void clearUser() => clearField(1);
  @$pb.TagNumber(1)
  $40.UserAsContact ensureUser() => $_ensure(0);
}
...
class GetUserProfileRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetUserProfileRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$40.UserPrivateData>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'profile', subBuilder: $40.UserPrivateData.create)
    ..hasRequiredFields = false
  ;

  GetUserProfileRes._() : super();
  factory GetUserProfileRes({
    $40.UserPrivateData? profile,
  }) {
    final _result = create();
    if (profile != null) {
  ...
  @$pb.TagNumber(1)
  $40.UserPrivateData get profile => $_getN(0);
  @$pb.TagNumber(1)
  set profile($40.UserPrivateData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProfile() => $_has(0);
  @$pb.TagNumber(1)
  void clearProfile() => clearField(1);
  @$pb.TagNumber(1)
  $40.UserPrivateData ensureProfile() => $_ensure(0);
}
...
class GetMySessionsRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetMySessionsRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$41.Session>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessions', $pb.PbFieldType.PM, subBuilder: $41.Session.create)
    ..hasRequiredFields = false
  ;

  GetMySessionsRes._() : super();
  factory GetMySessionsRes({
    $core.Iterable<$41.Session>? sessions,
  }) {
    final _result = create();
    if (sessions != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$41.Session> get sessions => $_getList(0);
}
