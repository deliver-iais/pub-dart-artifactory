...
class GetQrCodeTokenReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetQrCodeTokenReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$28.Platform>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'platform', subBuilder: $28.Platform.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientSecretKey', protoName: 'clientSecretKey')
    ..hasRequiredFields = false
  ;

  GetQrCodeTokenReq._() : super();
  factory GetQrCodeTokenReq({
    $28.Platform platform,
    ...
    if (clientSecretKey != null) {
      _result.clientSecretKey = clientSecretKey;
    }
    return _result;
  }
  factory GetQrCodeTokenReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetQrCodeTokenReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetQrCodeTokenReq clone() => GetQrCodeTokenReq()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetQrCodeTokenReq copyWith(void Function(GetQrCodeTokenReq) updates) => super.copyWith((message) => updates(message as GetQrCodeTokenReq)) as GetQrCodeTokenReq; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetQrCodeTokenReq create() => GetQrCodeTokenReq._();
  GetQrCodeTokenReq createEmptyInstance() => create();
  static $pb.PbList<GetQrCodeTokenReq> createRepeated() => $pb.PbList<GetQrCodeTokenReq>();
  @$core.pragma('dart2js:noInline')
  static GetQrCodeTokenReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetQrCodeTokenReq>(create);
  static GetQrCodeTokenReq _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.String get clientSecretKey => $_getSZ(1);
  @$pb.TagNumber(2)
  set clientSecretKey($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasClientSecretKey() => $_has(1);
  @$pb.TagNumber(2)
  void clearClientSecretKey() => clearField(2);
}

class GetQrCodeTokenRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetQrCodeTokenRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'token')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validUntil')
    ..hasRequiredFields = false
  ;

  GetQrCodeTokenRes._() : super();
  factory GetQrCodeTokenRes({
    $core.String token,
  ...
  factory GetQrCodeTokenRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetQrCodeTokenRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetQrCodeTokenRes clone() => GetQrCodeTokenRes()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetQrCodeTokenRes copyWith(void Function(GetQrCodeTokenRes) updates) => super.copyWith((message) => updates(message as GetQrCodeTokenRes)) as GetQrCodeTokenRes; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetQrCodeTokenRes create() => GetQrCodeTokenRes._();
  GetQrCodeTokenRes createEmptyInstance() => create();
  static $pb.PbList<GetQrCodeTokenRes> createRepeated() => $pb.PbList<GetQrCodeTokenRes>();
  @$core.pragma('dart2js:noInline')
  static GetQrCodeTokenRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetQrCodeTokenRes>(create);
  static GetQrCodeTokenRes _defaultInstance;
