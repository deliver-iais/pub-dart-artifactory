...
class NewerVersionInformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NewerVersionInformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newerVersion')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newerVersionDescription')
  ...
  @$pb.TagNumber(1)
  $core.String get newerVersion => $_getSZ(0);
  @$pb.TagNumber(1)
  set newerVersion($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasNewerVersion() => $_has(0);
  @$pb.TagNumber(1)
  void clearNewerVersion() => clearField(1);

  @$pb.TagNumber(2)
  $core.String get newerVersionDescription => $_getSZ(1);
  @$pb.TagNumber(2)
  set newerVersionDescription($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasNewerVersionDescription() => $_has(1);
  @$pb.TagNumber(2)
  void clearNewerVersionDescription() => clearField(2);
}
