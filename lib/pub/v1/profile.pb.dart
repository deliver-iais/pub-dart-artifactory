...
import 'models/phone.pb.dart' as $16;
import 'models/contact.pb.dart' as $17;
import 'models/user.pb.dart' as $18;
import 'models/uid.pb.dart' as $10;
import 'models/session.pb.dart' as $19;

import 'profile.pbenum.dart';

export 'profile.pbenum.dart';

class CheckUsernameReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CheckUsernameReq', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOS(1, 'username')
    ..hasRequiredFields = false
  ;

  CheckUsernameReq._() : super();
  factory CheckUsernameReq() => create();
  factory CheckUsernameReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CheckUsernameReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  CheckUsernameReq clone() => CheckUsernameReq()..mergeFromMessage(this);
  CheckUsernameReq copyWith(void Function(CheckUsernameReq) updates) => super.copyWith((message) => updates(message as CheckUsernameReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CheckUsernameReq create() => CheckUsernameReq._();
  CheckUsernameReq createEmptyInstance() => create();
  static $pb.PbList<CheckUsernameReq> createRepeated() => $pb.PbList<CheckUsernameReq>();
  @$core.pragma('dart2js:noInline')
  static CheckUsernameReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CheckUsernameReq>(create);
  static CheckUsernameReq _defaultInstance;
...
class CheckUsernameRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CheckUsernameRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..e<CheckUsernameRes_Status>(1, 'status', $pb.PbFieldType.OE, defaultOrMaker: CheckUsernameRes_Status.OK, valueOf: CheckUsernameRes_Status.valueOf, enumValues: CheckUsernameRes_Status.values)
    ..hasRequiredFields = false
  ;

  CheckUsernameRes._() : super();
  factory CheckUsernameRes() => create();
  factory CheckUsernameRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CheckUsernameRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  CheckUsernameRes clone() => CheckUsernameRes()..mergeFromMessage(this);
  CheckUsernameRes copyWith(void Function(CheckUsernameRes) updates) => super.copyWith((message) => updates(message as CheckUsernameRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CheckUsernameRes create() => CheckUsernameRes._();
  CheckUsernameRes createEmptyInstance() => create();
  static $pb.PbList<CheckUsernameRes> createRepeated() => $pb.PbList<CheckUsernameRes>();
  @$core.pragma('dart2js:noInline')
  static CheckUsernameRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CheckUsernameRes>(create);
  static CheckUsernameRes _defaultInstance;

  @$pb.TagNumber(1)
  CheckUsernameRes_Status get status => $_getN(0);
  @$pb.TagNumber(1)
  set status(CheckUsernameRes_Status v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class GetVerificationCodeReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetVerificationCodeReq', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$16.PhoneNumber>(1, 'phoneNumber', subBuilder: $16.PhoneNumber.create)
  ...
  @$pb.TagNumber(1)
  $16.PhoneNumber get phoneNumber => $_getN(0);
  @$pb.TagNumber(1)
  set phoneNumber($16.PhoneNumber v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPhoneNumber() => $_has(0);
  @$pb.TagNumber(1)
  void clearPhoneNumber() => clearField(1);
  @$pb.TagNumber(1)
  $16.PhoneNumber ensurePhoneNumber() => $_ensure(0);
...
class SaveContactsReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SaveContactsReq', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$17.Contact>(2, 'contactList', $pb.PbFieldType.PM, protoName: 'contactList', subBuilder: $17.Contact.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$17.Contact> get contactList => $_getList(0);
}
...
class GetContactListUsersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetContactListUsersRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$18.UserAsContact>(1, 'userList', $pb.PbFieldType.PM, protoName: 'userList', subBuilder: $18.UserAsContact.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$18.UserAsContact> get userList => $_getList(0);
...
class GetContactListRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetContactListRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$17.Contact>(1, 'contactList', $pb.PbFieldType.PM, protoName: 'contactList', subBuilder: $17.Contact.create)
    ..a<$core.int>(2, 'nextPageNumber', $pb.PbFieldType.O3)
    ..a<$core.int>(3, 'totalSize', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class GetUserByUidRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetUserByUidRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$18.UserAsContact>(1, 'user', subBuilder: $18.UserAsContact.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $18.UserAsContact get user => $_getN(0);
  @$pb.TagNumber(1)
  set user($18.UserAsContact v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUser() => $_has(0);
  @$pb.TagNumber(1)
  void clearUser() => clearField(1);
  @$pb.TagNumber(1)
  $18.UserAsContact ensureUser() => $_ensure(0);
}

class GetUserByUsernameReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetUserByUsernameReq', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOS(1, 'username')
    ..hasRequiredFields = false
  ;

  GetUserByUsernameReq._() : super();
  factory GetUserByUsernameReq() => create();
  factory GetUserByUsernameReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetUserByUsernameReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetUserByUsernameReq clone() => GetUserByUsernameReq()..mergeFromMessage(this);
  GetUserByUsernameReq copyWith(void Function(GetUserByUsernameReq) updates) => super.copyWith((message) => updates(message as GetUserByUsernameReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetUserByUsernameReq create() => GetUserByUsernameReq._();
  GetUserByUsernameReq createEmptyInstance() => create();
  static $pb.PbList<GetUserByUsernameReq> createRepeated() => $pb.PbList<GetUserByUsernameReq>();
  @$core.pragma('dart2js:noInline')
  static GetUserByUsernameReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetUserByUsernameReq>(create);
  static GetUserByUsernameReq _defaultInstance;
...
class GetUserByUsernameRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetUserByUsernameRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$18.UserAsContact>(1, 'user', subBuilder: $18.UserAsContact.create)
    ..hasRequiredFields = false
  ;

  GetUserByUsernameRes._() : super();
  factory GetUserByUsernameRes() => create();
  factory GetUserByUsernameRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetUserByUsernameRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetUserByUsernameRes clone() => GetUserByUsernameRes()..mergeFromMessage(this);
  GetUserByUsernameRes copyWith(void Function(GetUserByUsernameRes) updates) => super.copyWith((message) => updates(message as GetUserByUsernameRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetUserByUsernameRes create() => GetUserByUsernameRes._();
  GetUserByUsernameRes createEmptyInstance() => create();
  static $pb.PbList<GetUserByUsernameRes> createRepeated() => $pb.PbList<GetUserByUsernameRes>();
  @$core.pragma('dart2js:noInline')
  static GetUserByUsernameRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetUserByUsernameRes>(create);
  static GetUserByUsernameRes _defaultInstance;
...
class GetUserProfileRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetUserProfileRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..aOM<$18.UserPrivateData>(1, 'profile', subBuilder: $18.UserPrivateData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $18.UserPrivateData get profile => $_getN(0);
  @$pb.TagNumber(1)
  set profile($18.UserPrivateData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProfile() => $_has(0);
  @$pb.TagNumber(1)
  void clearProfile() => clearField(1);
  @$pb.TagNumber(1)
  $18.UserPrivateData ensureProfile() => $_ensure(0);
}
...
class GetMySessionsRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetMySessionsRes', package: const $pb.PackageName('proto.pub.v1.profile'), createEmptyInstance: create)
    ..pc<$19.Session>(1, 'sessions', $pb.PbFieldType.PM, subBuilder: $19.Session.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$19.Session> get sessions => $_getList(0);
}
