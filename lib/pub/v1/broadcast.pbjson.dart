...
const BroadcastInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'last_updated_time', '3': 3, '4': 1, '5': 3, '10': 'lastUpdatedTime'},
  ],
};

/// Descriptor for `BroadcastInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List broadcastInfoDescriptor = $convert.base64Decode('Cg1Ccm9hZGNhc3RJbmZvEhIKBG5hbWUYASABKAlSBG5hbWUSEgoEaW5mbxgCIAEoCVIEaW5mbxIqChFsYXN0X3VwZGF0ZWRfdGltZRgDIAEoA1IPbGFzdFVwZGF0ZWRUaW1l');
