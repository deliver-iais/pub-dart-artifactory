...
class PollServiceClient extends $grpc.Client {
  ...
  PollServiceClient($grpc.ClientChannel channel, {$grpc.CallOptions options})
      : super(channel, options: options);

  $grpc.ResponseFuture<$7.CreatePollRes> createPoll($7.CreatePollReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$createPoll, $async.Stream.fromIterable([request]),
        options: options);
  ...
  $grpc.ResponseFuture<$7.DoPollRes> doPoll($7.DoPollReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(_$doPoll, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$7.GetMeRes> getMe($7.GetMeReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(_$getMe, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$7.GetOverallResultRes> getOverallResult(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$getOverallResult, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$7.GetUsersSelectedOptionResultRes>
      getUsersSelectedOptionResult($7.GetUsersSelectedOptionResultReq request,
          {$grpc.CallOptions options}) {
    final call = $createCall(
        _$getUsersSelectedOptionResult, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
}
