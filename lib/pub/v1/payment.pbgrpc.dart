...
class PaymentServiceClient extends $grpc.Client {
  ...
  static final _$getDonateStatus =
      $grpc.ClientMethod<$7.GetDonateStatusReq, $7.GetDonateStatusRes>(
          '/proto.pub.v1.payment.PaymentService/getDonateStatus',
          ($7.GetDonateStatusReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $7.GetDonateStatusRes.fromBuffer(value));
  static final _$getDonateCount =
      $grpc.ClientMethod<$7.GetDonateCountReq, $7.GetDonateCountRes>(
          '/proto.pub.v1.payment.PaymentService/getDonateCount',
          ($7.GetDonateCountReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $7.GetDonateCountRes.fromBuffer(value));
  static final _$getDonateDetails =
      $grpc.ClientMethod<$7.GetDonateDetailsReq, $7.GetDonateDetailsRes>(
          '/proto.pub.v1.payment.PaymentService/getDonateDetails',
          ($7.GetDonateDetailsReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $7.GetDonateDetailsRes.fromBuffer(value));
  ...
  static final _$donate = $grpc.ClientMethod<$7.DonateReq, $7.DonateRes>(
      '/proto.pub.v1.payment.PaymentService/donate',
      ($7.DonateReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $7.DonateRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$7.GetDonateStatusRes> getDonateStatus(
      $7.GetDonateStatusReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getDonateStatus, request, options: options);
  }

  $grpc.ResponseFuture<$7.GetDonateCountRes> getDonateCount(
      $7.GetDonateCountReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getDonateCount, request, options: options);
  }

  $grpc.ResponseFuture<$7.GetDonateDetailsRes> getDonateDetails(
      $7.GetDonateDetailsReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getDonateDetails, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$7.DonateRes> donate($7.DonateReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$donate, request, options: options);
  }
...
abstract class PaymentServiceBase extends $grpc.Service {
  ...
  PaymentServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$7.GetDonateStatusReq, $7.GetDonateStatusRes>(
            'getDonateStatus',
            getDonateStatus_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $7.GetDonateStatusReq.fromBuffer(value),
            ($7.GetDonateStatusRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$7.GetDonateCountReq, $7.GetDonateCountRes>(
        'getDonateCount',
        getDonateCount_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $7.GetDonateCountReq.fromBuffer(value),
        ($7.GetDonateCountRes value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$7.GetDonateDetailsReq, $7.GetDonateDetailsRes>(
            'getDonateDetails',
            getDonateDetails_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $7.GetDonateDetailsReq.fromBuffer(value),
            ($7.GetDonateDetailsRes value) => value.writeToBuffer()));
    $addMethod(
    ...
    $addMethod($grpc.ServiceMethod<$7.DonateReq, $7.DonateRes>(
        'donate',
        donate_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $7.DonateReq.fromBuffer(value),
        ($7.DonateRes value) => value.writeToBuffer()));
  ...
  $async.Future<$7.GetDonateStatusRes> getDonateStatus_Pre(
      $grpc.ServiceCall call,
      $async.Future<$7.GetDonateStatusReq> request) async {
    return getDonateStatus(call, await request);
  }

  $async.Future<$7.GetDonateCountRes> getDonateCount_Pre($grpc.ServiceCall call,
      $async.Future<$7.GetDonateCountReq> request) async {
    return getDonateCount(call, await request);
  }

  $async.Future<$7.GetDonateDetailsRes> getDonateDetails_Pre(
      $grpc.ServiceCall call,
      $async.Future<$7.GetDonateDetailsReq> request) async {
    return getDonateDetails(call, await request);
  }
  ...
  $async.Future<$7.DonateRes> donate_Pre(
      $grpc.ServiceCall call, $async.Future<$7.DonateReq> request) async {
    return donate(call, await request);
  }
  ...
  $async.Future<$7.GetDonateStatusRes> getDonateStatus(
      $grpc.ServiceCall call, $7.GetDonateStatusReq request);
  $async.Future<$7.GetDonateCountRes> getDonateCount(
      $grpc.ServiceCall call, $7.GetDonateCountReq request);
  $async.Future<$7.GetDonateDetailsRes> getDonateDetails(
      $grpc.ServiceCall call, $7.GetDonateDetailsReq request);
  ...
  $async.Future<$7.DonateRes> donate(
      $grpc.ServiceCall call, $7.DonateReq request);
