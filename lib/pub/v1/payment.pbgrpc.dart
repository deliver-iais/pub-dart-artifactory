...
class PaymentServiceClient extends $grpc.Client {
  ...
  static final _$getPaymentInformation = $grpc.ClientMethod<
          $8.GetPaymentInformationReq, $8.GetPaymentInformationRes>(
      '/proto.pub.v1.payment.PaymentService/GetPaymentInformation',
      ($8.GetPaymentInformationReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $8.GetPaymentInformationRes.fromBuffer(value));
  ...
  static final _$payConfirm =
      $grpc.ClientMethod<$8.PayConfirmReq, $8.PayConfirmRes>(
          '/proto.pub.v1.payment.PaymentService/PayConfirm',
          ($8.PayConfirmReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $8.PayConfirmRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$8.GetPaymentInformationRes> getPaymentInformation(
      $8.GetPaymentInformationReq request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$8.PayConfirmRes> payConfirm($8.PayConfirmReq request,
      {$grpc.CallOptions? options}) {
...
abstract class PaymentServiceBase extends $grpc.Service {
  ...
  PaymentServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$8.GetPaymentInformationReq,
            $8.GetPaymentInformationRes>(
        'GetPaymentInformation',
        getPaymentInformation_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $8.GetPaymentInformationReq.fromBuffer(value),
        ($8.GetPaymentInformationRes value) => value.writeToBuffer()));
    $addMethod(
    ...
    $addMethod($grpc.ServiceMethod<$8.PayConfirmReq, $8.PayConfirmRes>(
        'PayConfirm',
        payConfirm_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $8.PayConfirmReq.fromBuffer(value),
        ($8.PayConfirmRes value) => value.writeToBuffer()));
  ...
  $async.Future<$8.GetPaymentInformationRes> getPaymentInformation_Pre(
      $grpc.ServiceCall call,
      $async.Future<$8.GetPaymentInformationReq> request) async {
  ...
  $async.Future<$8.PayConfirmRes> payConfirm_Pre(
  ...
  $async.Future<$8.GetPaymentInformationRes> getPaymentInformation(
      $grpc.ServiceCall call, $8.GetPaymentInformationReq request);
  ...
  $async.Future<$8.PayConfirmRes> payConfirm(
