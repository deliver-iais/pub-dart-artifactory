...
class ClientVersion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientVersion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.lb'), createEmptyInstance: create)
    ...
    ..aOM<$18.File>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'animation', subBuilder: $18.File.create)
    ..pc<ClientVersionLink>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'links', $pb.PbFieldType.PM, subBuilder: ClientVersionLink.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $18.File get animation => $_getN(3);
  @$pb.TagNumber(4)
  set animation($18.File v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAnimation() => $_has(3);
  @$pb.TagNumber(4)
  void clearAnimation() => clearField(4);
  @$pb.TagNumber(4)
  $18.File ensureAnimation() => $_ensure(3);

  @$pb.TagNumber(5)
  $core.List<ClientVersionLink> get links => $_getList(4);
}
