...
class QueryDirection extends $pb.ProtobufEnum {
  static const QueryDirection FORWARD_INCLUSIVE = QueryDirection._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FORWARD_INCLUSIVE');
  static const QueryDirection BACKWARD_INCLUSIVE = QueryDirection._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BACKWARD_INCLUSIVE');
  static const QueryDirection FORWARD_EXCLUSIVE = QueryDirection._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FORWARD_EXCLUSIVE');
  static const QueryDirection BACKWARD_EXCLUSIVE = QueryDirection._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BACKWARD_EXCLUSIVE');

  static const $core.List<QueryDirection> values = <QueryDirection> [
    FORWARD_INCLUSIVE,
    BACKWARD_INCLUSIVE,
    FORWARD_EXCLUSIVE,
    BACKWARD_EXCLUSIVE,
  ...
  static final $core.Map<$core.int, QueryDirection> _byValue = $pb.ProtobufEnum.initByValue(values);
  static QueryDirection? valueOf($core.int value) => _byValue[value];

  const QueryDirection._($core.int v, $core.String n) : super(v, n);
}
