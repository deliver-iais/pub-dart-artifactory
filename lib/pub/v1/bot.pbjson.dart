...
const GetInfoRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'commands', '3': 3, '4': 3, '5': 11, '6': '.proto.pub.v1.sticker.GetInfoRes.CommandsEntry', '10': 'commands'},
  ],
...
const SearchByNameRes$json = const {
  '1': 'SearchByNameRes',
  '2': const [
    const {'1': 'bot', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.sticker.SearchByNameRes.SearchBotResult', '10': 'bot'},
  ],
