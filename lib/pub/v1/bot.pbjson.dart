...
const GetInfoRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'can_be_add_in_groups_and_channels', '3': 6, '4': 1, '5': 8, '10': 'canBeAddInGroupsAndChannels'},
  ],
...
final $typed_data.Uint8List getInfoResDescriptor = $convert.base64Decode('');
...
const CallbackQueryReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pin_code', '3': 6, '4': 1, '5': 9, '10': 'pinCode'},
  ],
};

/// Descriptor for `CallbackQueryReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callbackQueryReqDescriptor = $convert.base64Decode('');
...
const CallbackQueryRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'is_error', '3': 4, '4': 1, '5': 8, '10': 'isError'},
    const {'1': 'redirection_url', '3': 5, '4': 1, '5': 9, '10': 'redirectionUrl'},
  ],
};

/// Descriptor for `CallbackQueryRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callbackQueryResDescriptor = $convert.base64Decode('ChBDYWxsYmFja1F1ZXJ5UmVzEioKEWNhbGxiYWNrX3F1ZXJ5X2lkGAEgASgJUg9jYWxsYmFja1F1ZXJ5SWQSEgoEdGV4dBgCIAEoCVIEdGV4dBIdCgpzaG93X2FsZXJ0GAMgASgIUglzaG93QWxlcnQSGQoIaXNfZXJyb3IYBCABKAhSB2lzRXJyb3ISJwoPcmVkaXJlY3Rpb25fdXJsGAUgASgJUg5yZWRpcmVjdGlvblVybA==');
