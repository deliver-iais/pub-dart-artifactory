...
const CallbackQueryRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'redirection_url', '3': 4, '4': 1, '5': 9, '10': 'redirectionUrl'},
  ],
};

/// Descriptor for `CallbackQueryRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callbackQueryResDescriptor = $convert.base64Decode('ChBDYWxsYmFja1F1ZXJ5UmVzEioKEWNhbGxiYWNrX3F1ZXJ5X2lkGAEgASgJUg9jYWxsYmFja1F1ZXJ5SWQSEgoEdGV4dBgCIAEoCVIEdGV4dBIdCgpzaG93X2FsZXJ0GAMgASgIUglzaG93QWxlcnQSJwoPcmVkaXJlY3Rpb25fdXJsGAQgASgJUg5yZWRpcmVjdGlvblVybA==');
