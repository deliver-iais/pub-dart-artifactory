...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$getUserRoomMeta =
      $grpc.ClientMethod<$9.GetUserRoomMetaReq, $9.GetUserRoomMetaRes>(
          '/proto.pub.v1.query.QueryService/GetUserRoomMeta',
          ($9.GetUserRoomMetaReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $9.GetUserRoomMetaRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$9.GetUserRoomMetaRes> getUserRoomMeta(
      $9.GetUserRoomMetaReq request,
      {$grpc.CallOptions options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$9.GetUserRoomMetaReq, $9.GetUserRoomMetaRes>(
            'GetUserRoomMeta',
            getUserRoomMeta_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $9.GetUserRoomMetaReq.fromBuffer(value),
            ($9.GetUserRoomMetaRes value) => value.writeToBuffer()));
    $addMethod(
  ...
  $async.Future<$9.GetUserRoomMetaRes> getUserRoomMeta_Pre(
      $grpc.ServiceCall call,
      $async.Future<$9.GetUserRoomMetaReq> request) async {
  ...
  $async.Future<$9.GetUserRoomMetaRes> getUserRoomMeta(
      $grpc.ServiceCall call, $9.GetUserRoomMetaReq request);
