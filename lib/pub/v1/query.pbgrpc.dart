...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$countIsHiddenMessages = $grpc.ClientMethod<
          $10.CountIsHiddenMessagesReq, $10.CountIsHiddenMessagesRes>(
      '/proto.pub.v1.query.QueryService/CountIsHiddenMessages',
      ($10.CountIsHiddenMessagesReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $10.CountIsHiddenMessagesRes.fromBuffer(value));
  ...
  static final _$fetchUserCalls =
      $grpc.ClientMethod<$10.FetchUserCallsReq, $10.FetchUserCallsRes>(
          '/proto.pub.v1.query.QueryService/FetchUserCalls',
          ($10.FetchUserCallsReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $10.FetchUserCallsRes.fromBuffer(value));
  ...
  static final _$removePrivateRoom =
      $grpc.ClientMethod<$10.RemovePrivateRoomReq, $10.RemovePrivateRoomRes>(
          '/proto.pub.v1.query.QueryService/RemovePrivateRoom',
          ($10.RemovePrivateRoomReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $10.RemovePrivateRoomRes.fromBuffer(value));
  static final _$searchInMessages =
      $grpc.ClientMethod<$10.SearchInMessagesReq, $10.SearchInMessagesRes>(
          '/proto.pub.v1.query.QueryService/SearchInMessages',
          ($10.SearchInMessagesReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $10.SearchInMessagesRes.fromBuffer(value));
  static final _$sendGlitch =
      $grpc.ClientMethod<$10.SendGlitchReq, $10.SendGlitchRes>(
          '/proto.pub.v1.query.QueryService/SendGlitch',
          ($10.SendGlitchReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $10.SendGlitchRes.fromBuffer(value));
  static final _$sendFeedback =
      $grpc.ClientMethod<$10.SendFeedbackReq, $10.SendFeedbackRes>(
          '/proto.pub.v1.query.QueryService/SendFeedback',
          ($10.SendFeedbackReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $10.SendFeedbackRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$10.CountIsHiddenMessagesRes> countIsHiddenMessages(
      $10.CountIsHiddenMessagesReq request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$10.FetchUserCallsRes> fetchUserCalls(
      $10.FetchUserCallsReq request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$10.RemovePrivateRoomRes> removePrivateRoom(
      $10.RemovePrivateRoomReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$removePrivateRoom, request, options: options);
  }

  $grpc.ResponseFuture<$10.SearchInMessagesRes> searchInMessages(
      $10.SearchInMessagesReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$searchInMessages, request, options: options);
  }

  $grpc.ResponseFuture<$10.SendGlitchRes> sendGlitch($10.SendGlitchReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$sendGlitch, request, options: options);
  }

  $grpc.ResponseFuture<$10.SendFeedbackRes> sendFeedback(
      $10.SendFeedbackReq request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$10.CountIsHiddenMessagesReq,
            $10.CountIsHiddenMessagesRes>(
        'CountIsHiddenMessages',
        countIsHiddenMessages_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $10.CountIsHiddenMessagesReq.fromBuffer(value),
        ($10.CountIsHiddenMessagesRes value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$10.FetchSeenCountOfChannelMessageReq,
        ...
        ($10.FetchSeenCountOfChannelMessageRes value) =>
            value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$10.FetchUserCallsReq, $10.FetchUserCallsRes>(
            'FetchUserCalls',
            fetchUserCalls_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $10.FetchUserCallsReq.fromBuffer(value),
            ($10.FetchUserCallsRes value) => value.writeToBuffer()));
    ...
    $addMethod(
        $grpc.ServiceMethod<$10.RemovePrivateRoomReq, $10.RemovePrivateRoomRes>(
            'RemovePrivateRoom',
            removePrivateRoom_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $10.RemovePrivateRoomReq.fromBuffer(value),
            ($10.RemovePrivateRoomRes value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$10.SearchInMessagesReq, $10.SearchInMessagesRes>(
            'SearchInMessages',
            searchInMessages_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $10.SearchInMessagesReq.fromBuffer(value),
            ($10.SearchInMessagesRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$10.SendGlitchReq, $10.SendGlitchRes>(
        'SendGlitch',
        sendGlitch_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $10.SendGlitchReq.fromBuffer(value),
        ($10.SendGlitchRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$10.SendFeedbackReq, $10.SendFeedbackRes>(
        'SendFeedback',
        sendFeedback_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $10.SendFeedbackReq.fromBuffer(value),
        ($10.SendFeedbackRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$10.CountIsHiddenMessagesRes> countIsHiddenMessages_Pre(
      $grpc.ServiceCall call,
      $async.Future<$10.CountIsHiddenMessagesReq> request) async {
  ...
  $async.Future<$10.FetchUserCallsRes> fetchUserCalls_Pre(
      $grpc.ServiceCall call,
      $async.Future<$10.FetchUserCallsReq> request) async {
  ...
  $async.Future<$10.RemovePrivateRoomRes> removePrivateRoom_Pre(
      $grpc.ServiceCall call,
      $async.Future<$10.RemovePrivateRoomReq> request) async {
    return removePrivateRoom(call, await request);
  }

  $async.Future<$10.SearchInMessagesRes> searchInMessages_Pre(
      $grpc.ServiceCall call,
      $async.Future<$10.SearchInMessagesReq> request) async {
    return searchInMessages(call, await request);
  }

  $async.Future<$10.SendGlitchRes> sendGlitch_Pre(
      $grpc.ServiceCall call, $async.Future<$10.SendGlitchReq> request) async {
    return sendGlitch(call, await request);
  }

  $async.Future<$10.SendFeedbackRes> sendFeedback_Pre($grpc.ServiceCall call,
      $async.Future<$10.SendFeedbackReq> request) async {
  ...
  $async.Future<$10.CountIsHiddenMessagesRes> countIsHiddenMessages(
      $grpc.ServiceCall call, $10.CountIsHiddenMessagesReq request);
  ...
  $async.Future<$10.FetchSeenCountOfChannelMessageRes>
      fetchSeenCountOfChannelMessage($grpc.ServiceCall call,
          $10.FetchSeenCountOfChannelMessageReq request);
  $async.Future<$10.FetchUserCallsRes> fetchUserCalls(
      $grpc.ServiceCall call, $10.FetchUserCallsReq request);
  ...
  $async.Future<$10.RemovePrivateRoomRes> removePrivateRoom(
      $grpc.ServiceCall call, $10.RemovePrivateRoomReq request);
  $async.Future<$10.SearchInMessagesRes> searchInMessages(
      $grpc.ServiceCall call, $10.SearchInMessagesReq request);
  $async.Future<$10.SendGlitchRes> sendGlitch(
      $grpc.ServiceCall call, $10.SendGlitchReq request);
  $async.Future<$10.SendFeedbackRes> sendFeedback(
      $grpc.ServiceCall call, $10.SendFeedbackReq request);
}
