...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$block = $grpc.ClientMethod<$6.BlockReq, $6.BlockRes>(
      '/proto.pub.v1.query.QueryService/Block',
      ($6.BlockReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $6.BlockRes.fromBuffer(value));
  static final _$unblock = $grpc.ClientMethod<$6.UnblockReq, $6.UnblockRes>(
      '/proto.pub.v1.query.QueryService/Unblock',
      ($6.UnblockReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $6.UnblockRes.fromBuffer(value));
  static final _$subscribeOnActivity =
      $grpc.ClientMethod<$6.SubscribeOnActivityReq, $6.SubscribeOnActivityReq>(
          '/proto.pub.v1.query.QueryService/SubscribeOnActivity',
          ($6.SubscribeOnActivityReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.SubscribeOnActivityReq.fromBuffer(value));
  static final _$report = $grpc.ClientMethod<$6.ReportReq, $6.ReportRes>(
      '/proto.pub.v1.query.QueryService/Report',
      ($6.ReportReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $6.ReportRes.fromBuffer(value));
  static final _$getBlockedList =
      $grpc.ClientMethod<$6.GetBlockedListReq, $6.GetBlockedListRes>(
          '/proto.pub.v1.query.QueryService/GetBlockedList',
          ($6.GetBlockedListReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $6.GetBlockedListRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$6.BlockRes> block($6.BlockReq request,
      {$grpc.CallOptions options}) {
  ...
  $grpc.ResponseFuture<$6.UnblockRes> unblock($6.UnblockReq request,
      {$grpc.CallOptions options}) {
  ...
  $grpc.ResponseFuture<$6.SubscribeOnActivityReq> subscribeOnActivity(
      $6.SubscribeOnActivityReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$subscribeOnActivity, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }

  $grpc.ResponseFuture<$6.ReportRes> report($6.ReportReq request,
      {$grpc.CallOptions options}) {
  ...
  $grpc.ResponseFuture<$6.GetBlockedListRes> getBlockedList(
      $6.GetBlockedListReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$6.BlockReq, $6.BlockRes>(
        'Block',
        block_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $6.BlockReq.fromBuffer(value),
        ($6.BlockRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$6.UnblockReq, $6.UnblockRes>(
        'Unblock',
        unblock_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $6.UnblockReq.fromBuffer(value),
        ($6.UnblockRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$6.SubscribeOnActivityReq,
            $6.SubscribeOnActivityReq>(
        'SubscribeOnActivity',
        subscribeOnActivity_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $6.SubscribeOnActivityReq.fromBuffer(value),
        ($6.SubscribeOnActivityReq value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$6.ReportReq, $6.ReportRes>(
        'Report',
        report_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $6.ReportReq.fromBuffer(value),
        ($6.ReportRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$6.GetBlockedListReq, $6.GetBlockedListRes>(
        'GetBlockedList',
        getBlockedList_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $6.GetBlockedListReq.fromBuffer(value),
        ($6.GetBlockedListRes value) => value.writeToBuffer()));
  ...
  $async.Future<$6.BlockRes> block_Pre(
      $grpc.ServiceCall call, $async.Future<$6.BlockReq> request) async {
    return block(call, await request);
  }

  $async.Future<$6.UnblockRes> unblock_Pre(
      $grpc.ServiceCall call, $async.Future<$6.UnblockReq> request) async {
    return unblock(call, await request);
  }

  $async.Future<$6.SubscribeOnActivityReq> subscribeOnActivity_Pre(
      $grpc.ServiceCall call,
      $async.Future<$6.SubscribeOnActivityReq> request) async {
    return subscribeOnActivity(call, await request);
  }

  $async.Future<$6.ReportRes> report_Pre(
      $grpc.ServiceCall call, $async.Future<$6.ReportReq> request) async {
    return report(call, await request);
  }

  $async.Future<$6.GetBlockedListRes> getBlockedList_Pre($grpc.ServiceCall call,
      $async.Future<$6.GetBlockedListReq> request) async {
  ...
  $async.Future<$6.BlockRes> block($grpc.ServiceCall call, $6.BlockReq request);
  $async.Future<$6.UnblockRes> unblock(
      $grpc.ServiceCall call, $6.UnblockReq request);
  $async.Future<$6.SubscribeOnActivityReq> subscribeOnActivity(
      $grpc.ServiceCall call, $6.SubscribeOnActivityReq request);
  $async.Future<$6.ReportRes> report(
      $grpc.ServiceCall call, $6.ReportReq request);
  $async.Future<$6.GetBlockedListRes> getBlockedList(
      $grpc.ServiceCall call, $6.GetBlockedListReq request);
