...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$subscribeOnGroupActivity = $grpc.ClientMethod<
          $6.SubscribeOnGroupActivityReq, $6.SubscribeOnGroupActivityRes>(
      '/proto.pub.v1.query.QueryService/SubscribeOnGroupActivity',
      ($6.SubscribeOnGroupActivityReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $6.SubscribeOnGroupActivityRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$6.SubscribeOnGroupActivityRes> subscribeOnGroupActivity(
      $6.SubscribeOnGroupActivityReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$6.SubscribeOnGroupActivityReq,
            $6.SubscribeOnGroupActivityRes>(
        'SubscribeOnGroupActivity',
        subscribeOnGroupActivity_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $6.SubscribeOnGroupActivityReq.fromBuffer(value),
        ($6.SubscribeOnGroupActivityRes value) => value.writeToBuffer()));
  ...
  $async.Future<$6.SubscribeOnGroupActivityRes> subscribeOnGroupActivity_Pre(
      $grpc.ServiceCall call,
      $async.Future<$6.SubscribeOnGroupActivityReq> request) async {
  ...
  $async.Future<$6.SubscribeOnGroupActivityRes> subscribeOnGroupActivity(
      $grpc.ServiceCall call, $6.SubscribeOnGroupActivityReq request);
