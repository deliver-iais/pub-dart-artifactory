...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$block = $grpc.ClientMethod<$11.BlockReq, $11.BlockRes>(
      '/proto.pub.v1.query.QueryService/Block',
      ($11.BlockReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $11.BlockRes.fromBuffer(value));
  static final _$unblock = $grpc.ClientMethod<$11.UnblockReq, $11.UnblockRes>(
      '/proto.pub.v1.query.QueryService/Unblock',
      ($11.UnblockReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $11.UnblockRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$11.BlockRes> block($11.BlockReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$block, request, options: options);
  }

  $grpc.ResponseFuture<$11.UnblockRes> unblock($11.UnblockReq request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$11.BlockReq, $11.BlockRes>(
        'Block',
        block_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $11.BlockReq.fromBuffer(value),
        ($11.BlockRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$11.UnblockReq, $11.UnblockRes>(
        'Unblock',
        unblock_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $11.UnblockReq.fromBuffer(value),
        ($11.UnblockRes value) => value.writeToBuffer()));
  ...
  $async.Future<$11.BlockRes> block_Pre(
      $grpc.ServiceCall call, $async.Future<$11.BlockReq> request) async {
    return block(call, await request);
  }

  $async.Future<$11.UnblockRes> unblock_Pre(
      $grpc.ServiceCall call, $async.Future<$11.UnblockReq> request) async {
  ...
  $async.Future<$11.BlockRes> block(
      $grpc.ServiceCall call, $11.BlockReq request);
  $async.Future<$11.UnblockRes> unblock(
      $grpc.ServiceCall call, $11.UnblockReq request);
