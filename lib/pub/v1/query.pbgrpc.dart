...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$removeRoom =
      $grpc.ClientMethod<$10.RemoveRoomReq, $10.RemoveRoomRes>(
          '/proto.pub.v1.query.QueryService/RemoveRoom',
          ($10.RemoveRoomReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $10.RemoveRoomRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$10.RemoveRoomRes> removeRoom($10.RemoveRoomReq request,
      {$grpc.CallOptions options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$10.RemoveRoomReq, $10.RemoveRoomRes>(
        'RemoveRoom',
        removeRoom_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $10.RemoveRoomReq.fromBuffer(value),
        ($10.RemoveRoomRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$10.RemoveRoomRes> removeRoom_Pre(
      $grpc.ServiceCall call, $async.Future<$10.RemoveRoomReq> request) async {
  ...
  $async.Future<$10.RemoveRoomRes> removeRoom(
      $grpc.ServiceCall call, $10.RemoveRoomReq request);
}
