...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$getAnnouncement =
      $grpc.ClientMethod<$12.GetAnnouncementReq, $12.GetAnnouncementRes>(
          '/proto.pub.v1.query.QueryService/GetAnnouncement',
          ($12.GetAnnouncementReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $12.GetAnnouncementRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$12.GetAnnouncementRes> getAnnouncement(
      $12.GetAnnouncementReq request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$12.GetAnnouncementReq, $12.GetAnnouncementRes>(
            'GetAnnouncement',
            getAnnouncement_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $12.GetAnnouncementReq.fromBuffer(value),
            ($12.GetAnnouncementRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$12.GetAnnouncementRes> getAnnouncement_Pre(
      $grpc.ServiceCall call,
      $async.Future<$12.GetAnnouncementReq> request) async {
  ...
  $async.Future<$12.GetAnnouncementRes> getAnnouncement(
      $grpc.ServiceCall call, $12.GetAnnouncementReq request);
}
