...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$fetchMetaList =
      $grpc.ClientMethod<$12.FetchMetaReq, $12.FetchMetaRes>(
          '/proto.pub.v1.query.QueryService/FetchMetaList',
          ($12.FetchMetaReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $12.FetchMetaRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$12.FetchMetaRes> fetchMetaList($12.FetchMetaReq request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$12.FetchMetaReq, $12.FetchMetaRes>(
        'FetchMetaList',
        fetchMetaList_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $12.FetchMetaReq.fromBuffer(value),
        ($12.FetchMetaRes value) => value.writeToBuffer()));
    $addMethod(
  ...
  $async.Future<$12.FetchMetaRes> fetchMetaList_Pre(
      $grpc.ServiceCall call, $async.Future<$12.FetchMetaReq> request) async {
  ...
  $async.Future<$12.FetchMetaRes> fetchMetaList(
      $grpc.ServiceCall call, $12.FetchMetaReq request);
