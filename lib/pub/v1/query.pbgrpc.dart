...
class QueryServiceClient extends $grpc.Client {
  ...
  static final _$forwardMessages =
      $grpc.ClientMethod<$11.ForwardMessagesReq, $11.ForwardMessagesRes>(
          '/proto.pub.v1.query.QueryService/ForwardMessages',
          ($11.ForwardMessagesReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $11.ForwardMessagesRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$11.ForwardMessagesRes> forwardMessages(
      $11.ForwardMessagesReq request,
      {$grpc.CallOptions? options}) {
...
abstract class QueryServiceBase extends $grpc.Service {
  ...
  QueryServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$11.ForwardMessagesReq, $11.ForwardMessagesRes>(
            'ForwardMessages',
            forwardMessages_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $11.ForwardMessagesReq.fromBuffer(value),
            ($11.ForwardMessagesRes value) => value.writeToBuffer()));
  ...
  $async.Future<$11.ForwardMessagesRes> forwardMessages_Pre(
      $grpc.ServiceCall call,
      $async.Future<$11.ForwardMessagesReq> request) async {
  ...
  $async.Future<$11.ForwardMessagesRes> forwardMessages(
      $grpc.ServiceCall call, $11.ForwardMessagesReq request);
