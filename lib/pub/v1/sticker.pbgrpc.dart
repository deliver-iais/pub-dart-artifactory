...
class StickerServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$8.GetTrendPacksReq> getTrendPacks(
...
abstract class StickerServiceBase extends $grpc.Service {
  ...
  StickerServiceBase() {
    $addMethod($grpc.ServiceMethod<$8.GetTrendPacksReq, $8.GetTrendPacksReq>(
        'GetTrendPacks',
        getTrendPacks_Pre,
        false,
        false,
  ...
  $async.Future<$8.GetTrendPacksReq> getTrendPacks_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$8.GetTrendPacksReq> getTrendPacks(
