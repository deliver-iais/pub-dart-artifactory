...
const HasPermissionReq$json = const {
  '1': 'HasPermissionReq',
  '2': const [
    const {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'group'},
    const {'1': 'access_field', '3': 2, '4': 1, '5': 14, '6': '.proto.pub.v1.group.HasPermissionReq.AccessField', '10': 'accessField'},
  ],
  '4': const [HasPermissionReq_AccessField$json],
};

const HasPermissionReq_AccessField$json = const {
  '1': 'AccessField',
  '2': const [
...
const HasPermissionRes$json = const {
  '1': 'HasPermissionRes',
  '2': const [
