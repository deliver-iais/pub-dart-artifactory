...
const GetPermissionInGroupReq$json = const {
  '1': 'GetPermissionInGroupReq',
  '2': const [
    const {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'group'},
    const {'1': 'access_field', '3': 2, '4': 1, '5': 14, '6': '.proto.pub.v1.group.GetPermissionInGroupReq.AccessField', '10': 'accessField'},
  ],
  '4': const [GetPermissionInGroupReq_AccessField$json],
};

const GetPermissionInGroupReq_AccessField$json = const {
  '1': 'AccessField',
  '2': const [
...
const GetPermissionInGroupRes$json = const {
  '1': 'GetPermissionInGroupRes',
  '2': const [
