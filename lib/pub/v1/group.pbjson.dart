...
const GetAccessTokenReq$json = const {
  '1': 'GetAccessTokenReq',
  '2': const [
    const {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'group'},
    const {'1': 'access_field', '3': 2, '4': 1, '5': 14, '6': '.proto.pub.v1.group.GetAccessTokenReq.AccessField', '10': 'accessField'},
  ],
  '4': const [GetAccessTokenReq_AccessField$json],
};

const GetAccessTokenReq_AccessField$json = const {
  '1': 'AccessField',
  '2': const [
...
const GetAccessTokenRes$json = const {
  '1': 'GetAccessTokenRes',
  '2': const [
    const {'1': 'expire_at', '3': 1, '4': 1, '5': 3, '10': 'expireAt'},
