...
const GroupInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'is_sending_message_is_blocked', '3': 4, '4': 1, '5': 3, '10': 'isSendingMessageIsBlocked'},
  ],
};

/// Descriptor for `GroupInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List groupInfoDescriptor = $convert.base64Decode('CglHcm91cEluZm8SEgoEbmFtZRgBIAEoCVIEbmFtZRISCgRpbmZvGAIgASgJUgRpbmZvEjYKF21lc3NhZ2luZ190aW1lX2ludGVydmFsGAMgASgDUhVtZXNzYWdpbmdUaW1lSW50ZXJ2YWwSQAodaXNfc2VuZGluZ19tZXNzYWdlX2lzX2Jsb2NrZWQYBCABKANSGWlzU2VuZGluZ01lc3NhZ2VJc0Jsb2NrZWQ=');
