...
const GroupInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'is_sending_message_disabled', '3': 4, '4': 1, '5': 8, '10': 'isSendingMessageDisabled'},
    const {'1': 'last_updated_time', '3': 5, '4': 1, '5': 3, '10': 'lastUpdatedTime'},
  ],
};

/// Descriptor for `GroupInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List groupInfoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use syncLocalGroupReqDescriptor instead')
const SyncLocalGroupReq$json = const {
  '1': 'SyncLocalGroupReq',
  '2': const [
    const {'1': 'group_uid', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'groupUid'},
...
/// Descriptor for `SyncLocalGroupReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List syncLocalGroupReqDescriptor = $convert.base64Decode('ChFTeW5jTG9jYWxHcm91cFJlcRI1Cglncm91cF91aWQYASABKAsyGC5wcm90by5wdWIudjEubW9kZWxzLlVpZFIIZ3JvdXBVaWQSLgoFb3duZXIYAiABKAsyGC5wcm90by5wdWIudjEubW9kZWxzLlVpZFIFb3duZXISEgoEbmFtZRgDIAEoCVIEbmFtZRISCgRpbmZvGAQgASgJUgRpbmZv');
@$core.Deprecated('Use syncLocalGroupResDescriptor instead')
const SyncLocalGroupRes$json = const {
  '1': 'SyncLocalGroupRes',
  '2': const [
    const {'1': 'synced', '3': 1, '4': 1, '5': 8, '10': 'synced'},
  ],
};

/// Descriptor for `SyncLocalGroupRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List syncLocalGroupResDescriptor = $convert.base64Decode('ChFTeW5jTG9jYWxHcm91cFJlcxIWCgZzeW5jZWQYASABKAhSBnN5bmNlZA==');
...
@$core.Deprecated('Use createLocalGroupReqDescriptor instead')
const CreateLocalGroupReq$json = const {
  '1': 'CreateLocalGroupReq',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'info', '3': 2, '4': 1, '5': 9, '10': 'info'},
    const {'1': 'group_node', '3': 3, '4': 1, '5': 9, '10': 'groupNode'},
  ],
};

/// Descriptor for `CreateLocalGroupReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createLocalGroupReqDescriptor = $convert.base64Decode('ChNDcmVhdGVMb2NhbEdyb3VwUmVxEhIKBG5hbWUYASABKAlSBG5hbWUSEgoEaW5mbxgCIAEoCVIEaW5mbxIdCgpncm91cF9ub2RlGAMgASgJUglncm91cE5vZGU=');
...
@$core.Deprecated('Use addMembersToLocalMucReqDescriptor instead')
const AddMembersToLocalMucReq$json = const {
  '1': 'AddMembersToLocalMucReq',
  '2': const [
    const {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'group'},
    const {'1': 'members', '3': 2, '4': 3, '5': 11, '6': '.proto.pub.v1.models.Member', '10': 'members'},
  ],
...
/// Descriptor for `AddMembersToLocalMucReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addMembersToLocalMucReqDescriptor = $convert.base64Decode('ChdBZGRNZW1iZXJzVG9Mb2NhbE11Y1JlcRIuCgVncm91cBgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgVncm91cBI1CgdtZW1iZXJzGAIgAygLMhsucHJvdG8ucHViLnYxLm1vZGVscy5NZW1iZXJSB21lbWJlcnM=');
@$core.Deprecated('Use addMembersToLocalMucResDescriptor instead')
const AddMembersToLocalMucRes$json = const {
  '1': 'AddMembersToLocalMucRes',
};

/// Descriptor for `AddMembersToLocalMucRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addMembersToLocalMucResDescriptor = $convert.base64Decode('ChdBZGRNZW1iZXJzVG9Mb2NhbE11Y1Jlcw==');
...
const GetGroupRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'roll_token', '3': 7, '4': 1, '5': 9, '10': 'rollToken'},
    const {'1': 'last_update', '3': 8, '4': 1, '5': 3, '10': 'lastUpdate'},
  ],
};

/// Descriptor for `GetGroupRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getGroupResDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getMembersReqDescriptor = $convert.base64Decode('Cg1HZXRNZW1iZXJzUmVxEioKA3VpZBgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgN1aWQSGAoHcG9pbnRlchgCIAEoBVIHcG9pbnRlchIUCgVsaW1pdBgDIAEoBVIFbGltaXQSFAoFcXVlcnkYBCABKAlSBXF1ZXJ5');
