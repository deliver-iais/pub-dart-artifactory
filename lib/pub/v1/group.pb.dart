...
class GroupAdmin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupAdmin', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ...
    ..aOM<$12.Uid>(2, 'group', subBuilder: $12.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $12.Uid get group => $_getN(1);
  @$pb.TagNumber(2)
  set group($12.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGroup() => $_has(1);
  @$pb.TagNumber(2)
  void clearGroup() => clearField(2);
  @$pb.TagNumber(2)
  $12.Uid ensureGroup() => $_ensure(1);
}
...
class ChangeRoleReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChangeRoleReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$12.Uid>(1, 'group', subBuilder: $12.Uid.create)
  ...
  @$pb.TagNumber(1)
  $12.Uid get group => $_getN(0);
  @$pb.TagNumber(1)
  set group($12.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGroup() => $_has(0);
  @$pb.TagNumber(1)
  void clearGroup() => clearField(1);
  @$pb.TagNumber(1)
  $12.Uid ensureGroup() => $_ensure(0);
...
class GetPermissionInGroupReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPermissionInGroupReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$12.Uid>(1, 'group', subBuilder: $12.Uid.create)
    ..e<GetPermissionInGroupReq_AccessField>(2, 'accessField', $pb.PbFieldType.OE, defaultOrMaker: GetPermissionInGroupReq_AccessField.CHANGE_AVATAR, valueOf: GetPermissionInGroupReq_AccessField.valueOf, enumValues: GetPermissionInGroupReq_AccessField.values)
    ..hasRequiredFields = false
  ;

  GetPermissionInGroupReq._() : super();
  factory GetPermissionInGroupReq() => create();
  factory GetPermissionInGroupReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetPermissionInGroupReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetPermissionInGroupReq clone() => GetPermissionInGroupReq()..mergeFromMessage(this);
  GetPermissionInGroupReq copyWith(void Function(GetPermissionInGroupReq) updates) => super.copyWith((message) => updates(message as GetPermissionInGroupReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetPermissionInGroupReq create() => GetPermissionInGroupReq._();
  GetPermissionInGroupReq createEmptyInstance() => create();
  static $pb.PbList<GetPermissionInGroupReq> createRepeated() => $pb.PbList<GetPermissionInGroupReq>();
  @$core.pragma('dart2js:noInline')
  static GetPermissionInGroupReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetPermissionInGroupReq>(create);
  static GetPermissionInGroupReq _defaultInstance;
  ...
  @$pb.TagNumber(2)
  GetPermissionInGroupReq_AccessField get accessField => $_getN(1);
  @$pb.TagNumber(2)
  set accessField(GetPermissionInGroupReq_AccessField v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GetPermissionInGroupRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPermissionInGroupRes', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOS(1, 'token')
    ..hasRequiredFields = false
  ;

  GetPermissionInGroupRes._() : super();
  factory GetPermissionInGroupRes() => create();
  factory GetPermissionInGroupRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetPermissionInGroupRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetPermissionInGroupRes clone() => GetPermissionInGroupRes()..mergeFromMessage(this);
  GetPermissionInGroupRes copyWith(void Function(GetPermissionInGroupRes) updates) => super.copyWith((message) => updates(message as GetPermissionInGroupRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetPermissionInGroupRes create() => GetPermissionInGroupRes._();
  GetPermissionInGroupRes createEmptyInstance() => create();
  static $pb.PbList<GetPermissionInGroupRes> createRepeated() => $pb.PbList<GetPermissionInGroupRes>();
  @$core.pragma('dart2js:noInline')
  static GetPermissionInGroupRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetPermissionInGroupRes>(create);
  static GetPermissionInGroupRes _defaultInstance;
