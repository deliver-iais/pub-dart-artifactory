...
class GroupAdmin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GroupAdmin', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.group'), createEmptyInstance: create)
    ...
    ..aOM<$14.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'group', subBuilder: $14.Uid.create)
    ..hasRequiredFields = false
  ;
...
class ChangeRoleReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeRoleReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.group'), createEmptyInstance: create)
    ...
    ..aOM<$15.Member>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'member', subBuilder: $15.Member.create)
    ..hasRequiredFields = false
  ;
...
class AddMembersReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AddMembersReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$14.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'group', subBuilder: $14.Uid.create)
    ..pc<$15.Member>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'members', $pb.PbFieldType.PM, subBuilder: $15.Member.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AddMembersReq({
    $14.Uid group,
    $core.Iterable<$15.Member> members,
  }) {
    final _result = create();
    if (group != null) {
      _result.group = group;
...
class GetGroupRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetGroupRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.group'), createEmptyInstance: create)
    ...
    ..e<$15.Role>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requesterRole', $pb.PbFieldType.OE, defaultOrMaker: $15.Role.NONE, valueOf: $15.Role.valueOf, enumValues: $15.Role.values)
...
class GetMembersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetMembersRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.group'), createEmptyInstance: create)
    ..pc<$15.Member>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'members', $pb.PbFieldType.PM, subBuilder: $15.Member.create)
...
class GetPermissionReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetPermissionReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$14.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'group', subBuilder: $14.Uid.create)
    ..e<$15.AccessField>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessField', $pb.PbFieldType.OE, defaultOrMaker: $15.AccessField.CHANGE_AVATAR, valueOf: $15.AccessField.valueOf, enumValues: $15.AccessField.values)
    ..hasRequiredFields = false
  ;
