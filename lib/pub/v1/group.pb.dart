...
class Group extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Group', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ...
    ..aOS(3, 'info')
    ..aInt64(4, 'population')
    ..aInt64(5, 'messagingTimeInterval', protoName: 'messagingTimeInterval')
    ..aInt64(6, 'isSendingMessageIsBlocked', protoName: 'isSendingMessageIsBlocked')
  ...
  @$pb.TagNumber(4)
  void clearPopulation() => clearField(4);

  @$pb.TagNumber(5)
  $fixnum.Int64 get messagingTimeInterval => $_getI64(4);
  @$pb.TagNumber(5)
  set messagingTimeInterval($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasMessagingTimeInterval() => $_has(4);
  @$pb.TagNumber(5)
  void clearMessagingTimeInterval() => clearField(5);

  @$pb.TagNumber(6)
  $fixnum.Int64 get isSendingMessageIsBlocked => $_getI64(5);
  @$pb.TagNumber(6)
  set isSendingMessageIsBlocked($fixnum.Int64 v) { $_setInt64(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasIsSendingMessageIsBlocked() => $_has(5);
  @$pb.TagNumber(6)
  void clearIsSendingMessageIsBlocked() => clearField(6);
}
