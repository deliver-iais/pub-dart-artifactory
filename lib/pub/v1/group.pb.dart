...
class GroupAdmin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupAdmin', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$9.Uid>(1, 'admin', subBuilder: $9.Uid.create)
    ..aOM<$9.Uid>(2, 'group', subBuilder: $9.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $9.Uid get admin => $_getN(0);
  @$pb.TagNumber(1)
  set admin($9.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAdmin() => $_has(0);
  @$pb.TagNumber(1)
  void clearAdmin() => clearField(1);
  @$pb.TagNumber(1)
  $9.Uid ensureAdmin() => $_ensure(0);

  @$pb.TagNumber(2)
  $9.Uid get group => $_getN(1);
  @$pb.TagNumber(2)
  set group($9.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGroup() => $_has(1);
  @$pb.TagNumber(2)
  void clearGroup() => clearField(2);
  @$pb.TagNumber(2)
  $9.Uid ensureGroup() => $_ensure(1);
}
...
class ModifyGroupRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ModifyGroupRes', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$10.Error>(1, 'error', subBuilder: $10.Error.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $10.Error get error => $_getN(0);
  @$pb.TagNumber(1)
  set error($10.Error v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasError() => $_has(0);
  @$pb.TagNumber(1)
  void clearError() => clearField(1);
  @$pb.TagNumber(1)
  $10.Error ensureError() => $_ensure(0);
}
...
class KickMembersReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KickMembersReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$9.Uid>(1, 'group', subBuilder: $9.Uid.create)
    ..pc<$9.Uid>(2, 'members', $pb.PbFieldType.PM, subBuilder: $9.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $9.Uid get group => $_getN(0);
  @$pb.TagNumber(1)
  set group($9.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGroup() => $_has(0);
  @$pb.TagNumber(1)
  void clearGroup() => clearField(1);
  @$pb.TagNumber(1)
  $9.Uid ensureGroup() => $_ensure(0);

  @$pb.TagNumber(2)
  $core.List<$9.Uid> get members => $_getList(1);
}
...
class BanMemberReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BanMemberReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$9.Uid>(1, 'group', subBuilder: $9.Uid.create)
    ..aOM<$9.Uid>(2, 'member', subBuilder: $9.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $9.Uid get member => $_getN(1);
  @$pb.TagNumber(2)
  set member($9.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMember() => $_has(1);
  @$pb.TagNumber(2)
  void clearMember() => clearField(2);
  @$pb.TagNumber(2)
  $9.Uid ensureMember() => $_ensure(1);
}
...
class UnbanMemberReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UnbanMemberReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$9.Uid>(1, 'group', subBuilder: $9.Uid.create)
    ..aOM<$9.Uid>(2, 'memberUid', protoName: 'memberUid', subBuilder: $9.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $9.Uid get memberUid => $_getN(1);
  @$pb.TagNumber(2)
  set memberUid($9.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMemberUid() => $_has(1);
  @$pb.TagNumber(2)
  void clearMemberUid() => clearField(2);
  @$pb.TagNumber(2)
  $9.Uid ensureMemberUid() => $_ensure(1);
}
...
class GetMembersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetMembersRes', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..pc<$11.Member>(1, 'members', $pb.PbFieldType.PM, subBuilder: $11.Member.create)
    ..aOB(2, 'finished')
    ..aOM<$10.Error>(3, 'error', subBuilder: $10.Error.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $10.Error get error => $_getN(2);
  @$pb.TagNumber(3)
  set error($10.Error v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasError() => $_has(2);
  @$pb.TagNumber(3)
  void clearError() => clearField(3);
  @$pb.TagNumber(3)
  $10.Error ensureError() => $_ensure(2);
}
