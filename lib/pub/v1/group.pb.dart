...
class HasPermissionReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HasPermissionReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$12.Uid>(1, 'group', subBuilder: $12.Uid.create)
    ..e<HasPermissionReq_AccessField>(2, 'accessField', $pb.PbFieldType.OE, defaultOrMaker: HasPermissionReq_AccessField.CHANGE_AVATAR, valueOf: HasPermissionReq_AccessField.valueOf, enumValues: HasPermissionReq_AccessField.values)
    ..hasRequiredFields = false
  ;

  HasPermissionReq._() : super();
  factory HasPermissionReq() => create();
  factory HasPermissionReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory HasPermissionReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  HasPermissionReq clone() => HasPermissionReq()..mergeFromMessage(this);
  HasPermissionReq copyWith(void Function(HasPermissionReq) updates) => super.copyWith((message) => updates(message as HasPermissionReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static HasPermissionReq create() => HasPermissionReq._();
  HasPermissionReq createEmptyInstance() => create();
  static $pb.PbList<HasPermissionReq> createRepeated() => $pb.PbList<HasPermissionReq>();
  @$core.pragma('dart2js:noInline')
  static HasPermissionReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HasPermissionReq>(create);
  static HasPermissionReq _defaultInstance;
  ...
  @$pb.TagNumber(2)
  HasPermissionReq_AccessField get accessField => $_getN(1);
  @$pb.TagNumber(2)
  set accessField(HasPermissionReq_AccessField v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class HasPermissionRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('HasPermissionRes', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOS(1, 'token')
    ..hasRequiredFields = false
  ;

  HasPermissionRes._() : super();
  factory HasPermissionRes() => create();
  factory HasPermissionRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory HasPermissionRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  HasPermissionRes clone() => HasPermissionRes()..mergeFromMessage(this);
  HasPermissionRes copyWith(void Function(HasPermissionRes) updates) => super.copyWith((message) => updates(message as HasPermissionRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static HasPermissionRes create() => HasPermissionRes._();
  HasPermissionRes createEmptyInstance() => create();
  static $pb.PbList<HasPermissionRes> createRepeated() => $pb.PbList<HasPermissionRes>();
  @$core.pragma('dart2js:noInline')
  static HasPermissionRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HasPermissionRes>(create);
  static HasPermissionRes _defaultInstance;
