...
class GetPermissionReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPermissionReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$12.Uid>(1, 'group', subBuilder: $12.Uid.create)
    ..e<$13.AccessField>(2, 'accessField', $pb.PbFieldType.OE, defaultOrMaker: $13.AccessField.CHANGE_AVATAR, valueOf: $13.AccessField.valueOf, enumValues: $13.AccessField.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $13.AccessField get accessField => $_getN(1);
  @$pb.TagNumber(2)
  set accessField($13.AccessField v) { setField(2, v); }
  @$pb.TagNumber(2)
