...
import 'models/muc.pb.dart' as $12;

import 'models/muc.pbenum.dart' as $12;
...
class GroupAdmin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GroupAdmin', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'admin', subBuilder: $11.Uid.create)
    ..aOM<$11.Uid>(2, 'group', subBuilder: $11.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $11.Uid get admin => $_getN(0);
  @$pb.TagNumber(1)
  set admin($11.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAdmin() => $_has(0);
  @$pb.TagNumber(1)
  void clearAdmin() => clearField(1);
  @$pb.TagNumber(1)
  $11.Uid ensureAdmin() => $_ensure(0);

  @$pb.TagNumber(2)
  $11.Uid get group => $_getN(1);
  @$pb.TagNumber(2)
  set group($11.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGroup() => $_has(1);
  @$pb.TagNumber(2)
  void clearGroup() => clearField(2);
  @$pb.TagNumber(2)
  $11.Uid ensureGroup() => $_ensure(1);
}
...
class ChangeRoleReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChangeRoleReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'group', subBuilder: $11.Uid.create)
    ..aOM<$12.Member>(2, 'member', subBuilder: $12.Member.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $11.Uid get group => $_getN(0);
  @$pb.TagNumber(1)
  set group($11.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasGroup() => $_has(0);
  @$pb.TagNumber(1)
  void clearGroup() => clearField(1);
  @$pb.TagNumber(1)
  $11.Uid ensureGroup() => $_ensure(0);

  @$pb.TagNumber(2)
  $12.Member get member => $_getN(1);
  @$pb.TagNumber(2)
  set member($12.Member v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMember() => $_has(1);
  @$pb.TagNumber(2)
  void clearMember() => clearField(2);
  @$pb.TagNumber(2)
  $12.Member ensureMember() => $_ensure(1);
}
...
class AddMembersReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AddMembersReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'group', subBuilder: $11.Uid.create)
    ..pc<$12.Member>(2, 'members', $pb.PbFieldType.PM, subBuilder: $12.Member.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$12.Member> get members => $_getList(1);
}
...
class KickMembersReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KickMembersReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'group', subBuilder: $11.Uid.create)
    ..pc<$11.Uid>(2, 'members', $pb.PbFieldType.PM, subBuilder: $11.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$11.Uid> get members => $_getList(1);
}
...
class BanMemberReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BanMemberReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'group', subBuilder: $11.Uid.create)
    ..aOM<$11.Uid>(2, 'member', subBuilder: $11.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $11.Uid get member => $_getN(1);
  @$pb.TagNumber(2)
  set member($11.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMember() => $_has(1);
  @$pb.TagNumber(2)
  void clearMember() => clearField(2);
  @$pb.TagNumber(2)
  $11.Uid ensureMember() => $_ensure(1);
}
...
class GetGroupRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetGroupRes', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ...
    ..aInt64(2, 'population')
    ..e<$12.Role>(3, 'requesterRole', $pb.PbFieldType.OE, defaultOrMaker: $12.Role.NONE, valueOf: $12.Role.valueOf, enumValues: $12.Role.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $12.Role get requesterRole => $_getN(2);
  @$pb.TagNumber(3)
  set requesterRole($12.Role v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class GetMembersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetMembersRes', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..pc<$12.Member>(1, 'members', $pb.PbFieldType.PM, subBuilder: $12.Member.create)
    ..aOB(2, 'finished')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$12.Member> get members => $_getList(0);
...
class GetAccessTokenReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetAccessTokenReq', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'group', subBuilder: $11.Uid.create)
    ..e<GetAccessTokenReq_AccessField>(2, 'accessField', $pb.PbFieldType.OE, defaultOrMaker: GetAccessTokenReq_AccessField.CHANGE_AVATAR, valueOf: GetAccessTokenReq_AccessField.valueOf, enumValues: GetAccessTokenReq_AccessField.values)
    ..hasRequiredFields = false
  ;

  GetAccessTokenReq._() : super();
  factory GetAccessTokenReq() => create();
  factory GetAccessTokenReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetAccessTokenReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetAccessTokenReq clone() => GetAccessTokenReq()..mergeFromMessage(this);
  GetAccessTokenReq copyWith(void Function(GetAccessTokenReq) updates) => super.copyWith((message) => updates(message as GetAccessTokenReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAccessTokenReq create() => GetAccessTokenReq._();
  GetAccessTokenReq createEmptyInstance() => create();
  static $pb.PbList<GetAccessTokenReq> createRepeated() => $pb.PbList<GetAccessTokenReq>();
  @$core.pragma('dart2js:noInline')
  static GetAccessTokenReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetAccessTokenReq>(create);
  static GetAccessTokenReq _defaultInstance;
  ...
  @$pb.TagNumber(2)
  GetAccessTokenReq_AccessField get accessField => $_getN(1);
  @$pb.TagNumber(2)
  set accessField(GetAccessTokenReq_AccessField v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GetAccessTokenRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetAccessTokenRes', package: const $pb.PackageName('proto.pub.v1.group'), createEmptyInstance: create)
    ..aInt64(1, 'expireAt')
    ..aOS(2, 'sign')
    ..hasRequiredFields = false
  ;

  GetAccessTokenRes._() : super();
  factory GetAccessTokenRes() => create();
  factory GetAccessTokenRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetAccessTokenRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetAccessTokenRes clone() => GetAccessTokenRes()..mergeFromMessage(this);
  GetAccessTokenRes copyWith(void Function(GetAccessTokenRes) updates) => super.copyWith((message) => updates(message as GetAccessTokenRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetAccessTokenRes create() => GetAccessTokenRes._();
  GetAccessTokenRes createEmptyInstance() => create();
  static $pb.PbList<GetAccessTokenRes> createRepeated() => $pb.PbList<GetAccessTokenRes>();
  @$core.pragma('dart2js:noInline')
  static GetAccessTokenRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetAccessTokenRes>(create);
  static GetAccessTokenRes _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get expireAt => $_getI64(0);
  @$pb.TagNumber(1)
  set expireAt($fixnum.Int64 v) { $_setInt64(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasExpireAt() => $_has(0);
  @$pb.TagNumber(1)
  void clearExpireAt() => clearField(1);
