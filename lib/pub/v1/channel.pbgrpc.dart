...
class ChannelServiceClient extends $grpc.Client {
  ...
  static final _$getPermissionInChannel = $grpc.ClientMethod<
          $2.GetPermissionInChannelReq, $2.GetPermissionInChannelRes>(
      '/proto.pub.v1.channel.ChannelService/GetPermissionInChannel',
      ($2.GetPermissionInChannelReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.GetPermissionInChannelRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.GetPermissionInChannelRes> getPermissionInChannel(
      $2.GetPermissionInChannelReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$getPermissionInChannel, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
}
...
abstract class ChannelServiceBase extends $grpc.Service {
  ...
  ChannelServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.GetPermissionInChannelReq,
            $2.GetPermissionInChannelRes>(
        'GetPermissionInChannel',
        getPermissionInChannel_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.GetPermissionInChannelReq.fromBuffer(value),
        ($2.GetPermissionInChannelRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$2.GetPermissionInChannelRes> getPermissionInChannel_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.GetPermissionInChannelReq> request) async {
    return getPermissionInChannel(call, await request);
  }
  ...
  $async.Future<$2.GetPermissionInChannelRes> getPermissionInChannel(
      $grpc.ServiceCall call, $2.GetPermissionInChannelReq request);
}
