...
class ChannelServiceClient extends $grpc.Client {
  ...
  static final _$revokeToken =
      $grpc.ClientMethod<$2.RevokeTokenReq, $2.RevokeTokenRes>(
          '/proto.pub.v1.channel.ChannelService/RevokeToken',
          ($2.RevokeTokenReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $2.RevokeTokenRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.RevokeTokenRes> revokeToken($2.RevokeTokenReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
...
abstract class ChannelServiceBase extends $grpc.Service {
  ...
  ChannelServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.RevokeTokenReq, $2.RevokeTokenRes>(
        'RevokeToken',
        revokeToken_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.RevokeTokenReq.fromBuffer(value),
        ($2.RevokeTokenRes value) => value.writeToBuffer()));
  ...
  $async.Future<$2.RevokeTokenRes> revokeToken_Pre(
      $grpc.ServiceCall call, $async.Future<$2.RevokeTokenReq> request) async {
  ...
  $async.Future<$2.RevokeTokenRes> revokeToken(
      $grpc.ServiceCall call, $2.RevokeTokenReq request);
