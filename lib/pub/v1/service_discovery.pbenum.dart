...
class Services extends $pb.ProtobufEnum {
  ...
  static const Services STICKER_SERVICES = Services._(7, 'STICKER_SERVICES');
  static const Services BOT_SERVICES = Services._(8, 'BOT_SERVICES');
  static const Services POLL_SERVICES = Services._(9, 'POLL_SERVICES');
  static const Services LIVE_LOCATION_SERVICES = Services._(10, 'LIVE_LOCATION_SERVICES');
