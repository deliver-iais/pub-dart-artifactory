...
const GetWithdrawStatusRes$json = const {
  ...
  '2': const [
    const {'1': 'status', '3': 1, '4': 1, '5': 14, '6': '.proto.pub.v1.models.WithdrawStatus', '10': 'status'},
  ],
};

/// Descriptor for `GetWithdrawStatusRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getWithdrawStatusResDescriptor = $convert.base64Decode('ChRHZXRXaXRoZHJhd1N0YXR1c1JlcxI7CgZzdGF0dXMYASABKA4yIy5wcm90by5wdWIudjEubW9kZWxzLldpdGhkcmF3U3RhdHVzUgZzdGF0dXM=');
...
const GetPaymentStatusRes$json = const {
  ...
  '2': const [
    const {'1': 'status', '3': 1, '4': 1, '5': 14, '6': '.proto.pub.v1.models.PaymentStatus', '10': 'status'},
    const {'1': 'amount', '3': 2, '4': 1, '5': 3, '10': 'amount'},
    const {'1': 'description', '3': 3, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'expire_at', '3': 4, '4': 1, '5': 3, '10': 'expireAt'},
  ],
...
final $typed_data.Uint8List getPaymentStatusResDescriptor = $convert.base64Decode('ChNHZXRQYXltZW50U3RhdHVzUmVzEjoKBnN0YXR1cxgBIAEoDjIiLnByb3RvLnB1Yi52MS5tb2RlbHMuUGF5bWVudFN0YXR1c1IGc3RhdHVzEhYKBmFtb3VudBgCIAEoA1IGYW1vdW50EiAKC2Rlc2NyaXB0aW9uGAMgASgJUgtkZXNjcmlwdGlvbhIbCglleHBpcmVfYXQYBCABKANSCGV4cGlyZUF0');
...
const GetDonateDetailsRes$json = const {
  ...
  '2': const [
    const {'1': 'donate_details_list', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.DonateDetails', '10': 'donateDetailsList'},
  ],
};

/// Descriptor for `GetDonateDetailsRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getDonateDetailsResDescriptor = $convert.base64Decode('ChNHZXREb25hdGVEZXRhaWxzUmVzElIKE2RvbmF0ZV9kZXRhaWxzX2xpc3QYASADKAsyIi5wcm90by5wdWIudjEubW9kZWxzLkRvbmF0ZURldGFpbHNSEWRvbmF0ZURldGFpbHNMaXN0');
