...
final $typed_data.Uint8List payReqDescriptor = $convert.base64Decode('CgZQYXlSZXESHQoKcGF5bWVudF9pZBgCIAEoCVIJcGF5bWVudElk');
...
final $typed_data.Uint8List payResDescriptor = $convert.base64Decode('CgZQYXlSZXMSHQoKcGF5bWVudF9pZBgBIAEoCVIJcGF5bWVudElkEhIKBGd1aWQYAiABKAlSBGd1aWQ=');
@$core.Deprecated('Use payConfirmReqDescriptor instead')
const PayConfirmReq$json = const {
  '1': 'PayConfirmReq',
  '2': const [
    const {'1': 'confirm_sms', '3': 1, '4': 1, '5': 9, '10': 'confirmSms'},
    const {'1': 'payment_id', '3': 2, '4': 1, '5': 9, '10': 'paymentId'},
    const {'1': 'guid', '3': 3, '4': 1, '5': 9, '10': 'guid'},
  ],
};

/// Descriptor for `PayConfirmReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List payConfirmReqDescriptor = $convert.base64Decode('Cg1QYXlDb25maXJtUmVxEh8KC2NvbmZpcm1fc21zGAEgASgJUgpjb25maXJtU21zEh0KCnBheW1lbnRfaWQYAiABKAlSCXBheW1lbnRJZBISCgRndWlkGAMgASgJUgRndWlk');
@$core.Deprecated('Use payConfirmResDescriptor instead')
const PayConfirmRes$json = const {
  '1': 'PayConfirmRes',
  '2': const [
    const {'1': 'transaction', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Transaction', '10': 'transaction'},
  ],
...
/// Descriptor for `PayConfirmRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List payConfirmResDescriptor = $convert.base64Decode('Cg1QYXlDb25maXJtUmVzEkIKC3RyYW5zYWN0aW9uGAEgASgLMiAucHJvdG8ucHViLnYxLm1vZGVscy5UcmFuc2FjdGlvblILdHJhbnNhY3Rpb24=');
...
@$core.Deprecated('Use getPaymentInformationReqDescriptor instead')
const GetPaymentInformationReq$json = const {
  '1': 'GetPaymentInformationReq',
  '2': const [
    const {'1': 'payment_id', '3': 1, '4': 1, '5': 9, '10': 'paymentId'},
  ],
};

/// Descriptor for `GetPaymentInformationReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getPaymentInformationReqDescriptor = $convert.base64Decode('ChhHZXRQYXltZW50SW5mb3JtYXRpb25SZXESHQoKcGF5bWVudF9pZBgBIAEoCVIJcGF5bWVudElk');
@$core.Deprecated('Use getPaymentInformationResDescriptor instead')
const GetPaymentInformationRes$json = const {
  '1': 'GetPaymentInformationRes',
  '2': const [
    const {'1': 'payment_information', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.PaymentInformation', '10': 'paymentInformation'},
  ],
};

/// Descriptor for `GetPaymentInformationRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getPaymentInformationResDescriptor = $convert.base64Decode('ChhHZXRQYXltZW50SW5mb3JtYXRpb25SZXMSWAoTcGF5bWVudF9pbmZvcm1hdGlvbhgBIAEoCzInLnByb3RvLnB1Yi52MS5tb2RlbHMuUGF5bWVudEluZm9ybWF0aW9uUhJwYXltZW50SW5mb3JtYXRpb24=');
