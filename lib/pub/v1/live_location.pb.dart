...
class UpdateLocationReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateLocationReq', package: const $pb.PackageName('proto.pub.v1.live_location'), createEmptyInstance: create)
    ..aOM<$16.Location>(1, 'location', subBuilder: $16.Location.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $16.Location get location => $_getN(0);
  @$pb.TagNumber(1)
  set location($16.Location v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLocation() => $_has(0);
  @$pb.TagNumber(1)
  void clearLocation() => clearField(1);
  @$pb.TagNumber(1)
  $16.Location ensureLocation() => $_ensure(0);
}
