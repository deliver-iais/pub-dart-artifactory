...
@$core.Deprecated('Use editPollExpireTimeReqDescriptor instead')
const EditPollExpireTimeReq$json = const {
  '1': 'EditPollExpireTimeReq',
  '2': const [
    const {'1': 'uuid', '3': 1, '4': 1, '5': 9, '10': 'uuid'},
...
/// Descriptor for `EditPollExpireTimeReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List editPollExpireTimeReqDescriptor = $convert.base64Decode('ChVFZGl0UG9sbEV4cGlyZVRpbWVSZXESEgoEdXVpZBgBIAEoCVIEdXVpZBIfCgtleHBpcmVfdGltZRgCIAEoA1IKZXhwaXJlVGltZQ==');
@$core.Deprecated('Use editPollExpireTimeResDescriptor instead')
const EditPollExpireTimeRes$json = const {
  '1': 'EditPollExpireTimeRes',
  '2': const [
    const {'1': 'poll', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Poll', '10': 'poll'},
  ],
};

/// Descriptor for `EditPollExpireTimeRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List editPollExpireTimeResDescriptor = $convert.base64Decode('ChVFZGl0UG9sbEV4cGlyZVRpbWVSZXMSLQoEcG9sbBgBIAEoCzIZLnByb3RvLnB1Yi52MS5tb2RlbHMuUG9sbFIEcG9sbA==');
