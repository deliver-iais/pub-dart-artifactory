...
const ClientSettings$json = const {
  '1': 'ClientSettings',
  '2': const [
    const {'1': 'show_store', '3': 1, '4': 1, '5': 8, '10': 'showStore'},
  ],
};

/// Descriptor for `ClientSettings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List clientSettingsDescriptor = $convert.base64Decode('Cg5DbGllbnRTZXR0aW5ncxIdCgpzaG93X3N0b3JlGAEgASgIUglzaG93U3RvcmU=');
...
const GetInfoRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'client_settings', '3': 16, '4': 1, '5': 11, '6': '.proto.pub.v1.lb.ClientSettings', '10': 'clientSettings'},
  ],
};

/// Descriptor for `GetInfoRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getInfoResDescriptor = $convert.base64Decode('');
