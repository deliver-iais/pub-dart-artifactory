...
const ClientVersion$json = const {
  ...
  '2': const [
    ...
    const {'1': 'animation', '3': 4, '4': 1, '5': 11, '6': '.proto.pub.v1.models.File', '10': 'animation'},
    const {'1': 'links', '3': 5, '4': 3, '5': 11, '6': '.proto.pub.v1.lb.ClientVersionLink', '10': 'links'},
  ],
};

/// Descriptor for `ClientVersion`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List clientVersionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getInfoResDescriptor = $convert.base64Decode('');
