...
import 'models/uid.pb.dart' as $13;
import 'models/muc.pb.dart' as $14;

import 'channel.pbenum.dart';
import 'models/muc.pbenum.dart' as $14;
...
class ChannelAdmin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChannelAdmin', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$13.Uid>(1, 'admin', subBuilder: $13.Uid.create)
    ..aOM<$13.Uid>(2, 'channel', subBuilder: $13.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $13.Uid get admin => $_getN(0);
  @$pb.TagNumber(1)
  set admin($13.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAdmin() => $_has(0);
  @$pb.TagNumber(1)
  void clearAdmin() => clearField(1);
  @$pb.TagNumber(1)
  $13.Uid ensureAdmin() => $_ensure(0);

  @$pb.TagNumber(2)
  $13.Uid get channel => $_getN(1);
  @$pb.TagNumber(2)
  set channel($13.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasChannel() => $_has(1);
  @$pb.TagNumber(2)
  void clearChannel() => clearField(2);
  @$pb.TagNumber(2)
  $13.Uid ensureChannel() => $_ensure(1);
}
...
class ChangeRoleReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ChangeRoleReq', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$13.Uid>(1, 'channel', subBuilder: $13.Uid.create)
    ..aOM<$14.Member>(2, 'member', subBuilder: $14.Member.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $13.Uid get channel => $_getN(0);
  @$pb.TagNumber(1)
  set channel($13.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasChannel() => $_has(0);
  @$pb.TagNumber(1)
  void clearChannel() => clearField(1);
  @$pb.TagNumber(1)
  $13.Uid ensureChannel() => $_ensure(0);

  @$pb.TagNumber(2)
  $14.Member get member => $_getN(1);
  @$pb.TagNumber(2)
  set member($14.Member v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMember() => $_has(1);
  @$pb.TagNumber(2)
  void clearMember() => clearField(2);
  @$pb.TagNumber(2)
  $14.Member ensureMember() => $_ensure(1);
}
...
class AddMembersReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AddMembersReq', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$13.Uid>(1, 'channel', subBuilder: $13.Uid.create)
    ..pc<$14.Member>(2, 'members', $pb.PbFieldType.PM, subBuilder: $14.Member.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$14.Member> get members => $_getList(1);
}
...
class KickMembersReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('KickMembersReq', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$13.Uid>(1, 'channel', subBuilder: $13.Uid.create)
    ..pc<$13.Uid>(2, 'members', $pb.PbFieldType.PM, subBuilder: $13.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$13.Uid> get members => $_getList(1);
}
...
class BanMemberReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('BanMemberReq', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$13.Uid>(1, 'channel', subBuilder: $13.Uid.create)
    ..aOM<$13.Uid>(2, 'member', subBuilder: $13.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $13.Uid get member => $_getN(1);
  @$pb.TagNumber(2)
  set member($13.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMember() => $_has(1);
  @$pb.TagNumber(2)
  void clearMember() => clearField(2);
  @$pb.TagNumber(2)
  $13.Uid ensureMember() => $_ensure(1);
}
...
class GetChannelRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetChannelRes', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ...
    ..aInt64(2, 'population')
    ..e<$14.Role>(3, 'requesterRole', $pb.PbFieldType.OE, defaultOrMaker: $14.Role.NONE, valueOf: $14.Role.valueOf, enumValues: $14.Role.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $14.Role get requesterRole => $_getN(2);
  @$pb.TagNumber(3)
  set requesterRole($14.Role v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class GetMembersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetMembersRes', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..pc<$14.Member>(1, 'members', $pb.PbFieldType.PM, subBuilder: $14.Member.create)
    ..aOB(2, 'finished')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<$14.Member> get members => $_getList(0);
...
class GetPermissionReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPermissionReq', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$13.Uid>(1, 'channel', subBuilder: $13.Uid.create)
    ..e<$14.AccessField>(2, 'accessField', $pb.PbFieldType.OE, defaultOrMaker: $14.AccessField.CHANGE_AVATAR, valueOf: $14.AccessField.valueOf, enumValues: $14.AccessField.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $14.AccessField get accessField => $_getN(1);
  @$pb.TagNumber(2)
  set accessField($14.AccessField v) { setField(2, v); }
  @$pb.TagNumber(2)
