...
import 'models/muc.pb.dart' as $29;

import 'channel.pbenum.dart';
import 'models/muc.pbenum.dart' as $29;
...
class ChannelAdmin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChannelAdmin', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$18.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'admin', subBuilder: $18.Uid.create)
    ..aOM<$18.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channel', subBuilder: $18.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $18.Uid get admin => $_getN(0);
  @$pb.TagNumber(1)
  set admin($18.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAdmin() => $_has(0);
  @$pb.TagNumber(1)
  void clearAdmin() => clearField(1);
  @$pb.TagNumber(1)
  $18.Uid ensureAdmin() => $_ensure(0);

  @$pb.TagNumber(2)
  $18.Uid get channel => $_getN(1);
  @$pb.TagNumber(2)
  set channel($18.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasChannel() => $_has(1);
  @$pb.TagNumber(2)
  void clearChannel() => clearField(2);
  @$pb.TagNumber(2)
  $18.Uid ensureChannel() => $_ensure(1);
}
...
class ChangeRoleReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeRoleReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$18.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channel', subBuilder: $18.Uid.create)
    ..aOM<$29.Member>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'member', subBuilder: $29.Member.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $18.Uid get channel => $_getN(0);
  @$pb.TagNumber(1)
  set channel($18.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasChannel() => $_has(0);
  @$pb.TagNumber(1)
  void clearChannel() => clearField(1);
  @$pb.TagNumber(1)
  $18.Uid ensureChannel() => $_ensure(0);

  @$pb.TagNumber(2)
  $29.Member get member => $_getN(1);
  @$pb.TagNumber(2)
  set member($29.Member v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMember() => $_has(1);
  @$pb.TagNumber(2)
  void clearMember() => clearField(2);
  @$pb.TagNumber(2)
  $29.Member ensureMember() => $_ensure(1);
}
...
class AddMembersReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AddMembersReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$18.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channel', subBuilder: $18.Uid.create)
    ..pc<$29.Member>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'members', $pb.PbFieldType.PM, subBuilder: $29.Member.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AddMembersReq({
    $18.Uid? channel,
    $core.Iterable<$29.Member>? members,
  }) {
    final _result = create();
    if (channel != null) {
      _result.channel = channel;
  ...
  @$pb.TagNumber(2)
  $core.List<$29.Member> get members => $_getList(1);
}
...
class GetChannelRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetChannelRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.channel'), createEmptyInstance: create)
    ...
    ..e<$29.Role>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requesterRole', $pb.PbFieldType.OE, defaultOrMaker: $29.Role.NONE, valueOf: $29.Role.valueOf, enumValues: $29.Role.values)
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roleToken')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $29.Role get requesterRole => $_getN(2);
  @$pb.TagNumber(3)
  set requesterRole($29.Role v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  $core.String get roleToken => $_getSZ(6);
  @$pb.TagNumber(7)
  set roleToken($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasRoleToken() => $_has(6);
  @$pb.TagNumber(7)
  void clearRoleToken() => clearField(7);
}
...
class GetMembersRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetMembersRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.channel'), createEmptyInstance: create)
    ..pc<$29.Member>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'members', $pb.PbFieldType.PM, subBuilder: $29.Member.create)
  ...
  @$pb.TagNumber(1)
  $core.List<$29.Member> get members => $_getList(0);
