...
class CreateTokenRes extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  void clearJoinToken() => clearField(2);
}

class RevokeTokenReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RevokeTokenReq', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$14.Uid>(1, 'uid', subBuilder: $14.Uid.create)
    ..hasRequiredFields = false
  ;

  RevokeTokenReq._() : super();
  factory RevokeTokenReq() => create();
  factory RevokeTokenReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RevokeTokenReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  RevokeTokenReq clone() => RevokeTokenReq()..mergeFromMessage(this);
  RevokeTokenReq copyWith(void Function(RevokeTokenReq) updates) => super.copyWith((message) => updates(message as RevokeTokenReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RevokeTokenReq create() => RevokeTokenReq._();
  RevokeTokenReq createEmptyInstance() => create();
  static $pb.PbList<RevokeTokenReq> createRepeated() => $pb.PbList<RevokeTokenReq>();
  @$core.pragma('dart2js:noInline')
  static RevokeTokenReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RevokeTokenReq>(create);
...
class RevokeTokenRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RevokeTokenRes', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aInt64(2, 'joinToken')
    ..hasRequiredFields = false
  ;

  RevokeTokenRes._() : super();
  factory RevokeTokenRes() => create();
  factory RevokeTokenRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RevokeTokenRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  RevokeTokenRes clone() => RevokeTokenRes()..mergeFromMessage(this);
  RevokeTokenRes copyWith(void Function(RevokeTokenRes) updates) => super.copyWith((message) => updates(message as RevokeTokenRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RevokeTokenRes create() => RevokeTokenRes._();
  RevokeTokenRes createEmptyInstance() => create();
  static $pb.PbList<RevokeTokenRes> createRepeated() => $pb.PbList<RevokeTokenRes>();
  @$core.pragma('dart2js:noInline')
  static RevokeTokenRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RevokeTokenRes>(create);
  static RevokeTokenRes _defaultInstance;
