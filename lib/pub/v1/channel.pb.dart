...
class GetPermissionInChannelReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPermissionInChannelReq', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOM<$12.Uid>(1, 'channel', subBuilder: $12.Uid.create)
    ..e<GetPermissionInChannelReq_AccessField>(2, 'accessField', $pb.PbFieldType.OE, defaultOrMaker: GetPermissionInChannelReq_AccessField.CHANGE_AVATAR, valueOf: GetPermissionInChannelReq_AccessField.valueOf, enumValues: GetPermissionInChannelReq_AccessField.values)
    ..hasRequiredFields = false
  ;

  GetPermissionInChannelReq._() : super();
  factory GetPermissionInChannelReq() => create();
  factory GetPermissionInChannelReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetPermissionInChannelReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetPermissionInChannelReq clone() => GetPermissionInChannelReq()..mergeFromMessage(this);
  GetPermissionInChannelReq copyWith(void Function(GetPermissionInChannelReq) updates) => super.copyWith((message) => updates(message as GetPermissionInChannelReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetPermissionInChannelReq create() => GetPermissionInChannelReq._();
  GetPermissionInChannelReq createEmptyInstance() => create();
  static $pb.PbList<GetPermissionInChannelReq> createRepeated() => $pb.PbList<GetPermissionInChannelReq>();
  @$core.pragma('dart2js:noInline')
  static GetPermissionInChannelReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetPermissionInChannelReq>(create);
  static GetPermissionInChannelReq _defaultInstance;
  ...
  @$pb.TagNumber(2)
  GetPermissionInChannelReq_AccessField get accessField => $_getN(1);
  @$pb.TagNumber(2)
  set accessField(GetPermissionInChannelReq_AccessField v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GetPermissionInChannelRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPermissionInChannelRes', package: const $pb.PackageName('proto.pub.v1.channel'), createEmptyInstance: create)
    ..aOS(1, 'token')
    ..hasRequiredFields = false
  ;

  GetPermissionInChannelRes._() : super();
  factory GetPermissionInChannelRes() => create();
  factory GetPermissionInChannelRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetPermissionInChannelRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetPermissionInChannelRes clone() => GetPermissionInChannelRes()..mergeFromMessage(this);
  GetPermissionInChannelRes copyWith(void Function(GetPermissionInChannelRes) updates) => super.copyWith((message) => updates(message as GetPermissionInChannelRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetPermissionInChannelRes create() => GetPermissionInChannelRes._();
  GetPermissionInChannelRes createEmptyInstance() => create();
  static $pb.PbList<GetPermissionInChannelRes> createRepeated() => $pb.PbList<GetPermissionInChannelRes>();
  @$core.pragma('dart2js:noInline')
  static GetPermissionInChannelRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetPermissionInChannelRes>(create);
  static GetPermissionInChannelRes _defaultInstance;
