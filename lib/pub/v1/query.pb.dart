...
class SaveLocalMessageReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SaveLocalMessageReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ...
    ..pc<$33.MessageByClient>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messages', $pb.PbFieldType.PM, subBuilder: $33.MessageByClient.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SaveLocalMessageReq({
    ...
    $core.Iterable<$33.MessageByClient>? messages,
  }) {
    final _result = create();
    if (localChatId != null) {
  ...
  @$pb.TagNumber(2)
  $core.List<$33.MessageByClient> get messages => $_getList(1);
}
