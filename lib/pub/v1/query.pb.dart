...
import 'models/room_metadata.pb.dart' as $31;
import 'models/media.pb.dart' as $36;
...
class FetchMessagesRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FetchMessagesRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ..pc<$28.Message>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messages', $pb.PbFieldType.PM, subBuilder: $28.Message.create)
    ..hasRequiredFields = false
  ;

  FetchMessagesRes._() : super();
  factory FetchMessagesRes({
    $core.Iterable<$28.Message>? messages,
  }) {
    final _result = create();
    if (messages != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$28.Message> get messages => $_getList(0);
}
...
class GetAllUserRoomMetaRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetAllUserRoomMetaRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ..pc<$31.RoomMetadata>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roomsMeta', $pb.PbFieldType.PM, subBuilder: $31.RoomMetadata.create)
  ...
  factory GetAllUserRoomMetaRes({
    $core.Iterable<$31.RoomMetadata>? roomsMeta,
    $core.bool? finished,
  }) {
    final _result = create();
    if (roomsMeta != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$31.RoomMetadata> get roomsMeta => $_getList(0);
...
class GetUserRoomMetaRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetUserRoomMetaRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ..aOM<$31.RoomMetadata>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roomMeta', subBuilder: $31.RoomMetadata.create)
    ..hasRequiredFields = false
  ;

  GetUserRoomMetaRes._() : super();
  factory GetUserRoomMetaRes({
    $31.RoomMetadata? roomMeta,
  }) {
    final _result = create();
    if (roomMeta != null) {
  ...
  @$pb.TagNumber(1)
  $31.RoomMetadata get roomMeta => $_getN(0);
  @$pb.TagNumber(1)
  set roomMeta($31.RoomMetadata v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRoomMeta() => $_has(0);
  @$pb.TagNumber(1)
  void clearRoomMeta() => clearField(1);
  @$pb.TagNumber(1)
  $31.RoomMetadata ensureRoomMeta() => $_ensure(0);
}
...
class FetchMediasRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FetchMediasRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ..pc<$36.Media>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'medias', $pb.PbFieldType.PM, subBuilder: $36.Media.create)
    ..hasRequiredFields = false
  ;

  FetchMediasRes._() : super();
  factory FetchMediasRes({
    $core.Iterable<$36.Media>? medias,
  }) {
    final _result = create();
    if (medias != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$36.Media> get medias => $_getList(0);
}
...
class FetchCurrentUserSeenDataRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FetchCurrentUserSeenDataRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ..aOM<$29.Seen>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $29.Seen.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $29.Seen get seen => $_getN(0);
  @$pb.TagNumber(1)
  set seen($29.Seen v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSeen() => $_has(0);
  @$pb.TagNumber(1)
  void clearSeen() => clearField(1);
  @$pb.TagNumber(1)
  $29.Seen ensureSeen() => $_ensure(0);
}
...
class CallInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ...
    ..aOM<$26.CallEvent>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $26.CallEvent.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $26.CallEvent get callEvent => $_getN(2);
  @$pb.TagNumber(3)
  set callEvent($26.CallEvent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCallEvent() => $_has(2);
  @$pb.TagNumber(3)
  void clearCallEvent() => clearField(3);
  @$pb.TagNumber(3)
  $26.CallEvent ensureCallEvent() => $_ensure(2);
}
