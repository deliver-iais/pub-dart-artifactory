...
class SubscribeOnActivityReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SubscribeOnActivityReq', package: const $pb.PackageName('proto.pub.v1.query'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'uid', subBuilder: $11.Uid.create)
    ..hasRequiredFields = false
  ;

  SubscribeOnActivityReq._() : super();
  factory SubscribeOnActivityReq() => create();
  factory SubscribeOnActivityReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SubscribeOnActivityReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  SubscribeOnActivityReq clone() => SubscribeOnActivityReq()..mergeFromMessage(this);
  SubscribeOnActivityReq copyWith(void Function(SubscribeOnActivityReq) updates) => super.copyWith((message) => updates(message as SubscribeOnActivityReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SubscribeOnActivityReq create() => SubscribeOnActivityReq._();
  SubscribeOnActivityReq createEmptyInstance() => create();
  static $pb.PbList<SubscribeOnActivityReq> createRepeated() => $pb.PbList<SubscribeOnActivityReq>();
  @$core.pragma('dart2js:noInline')
  static SubscribeOnActivityReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SubscribeOnActivityReq>(create);
  static SubscribeOnActivityReq _defaultInstance;
...
class SubscribeOnActivityRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SubscribeOnActivityRes', package: const $pb.PackageName('proto.pub.v1.query'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  SubscribeOnActivityRes._() : super();
  factory SubscribeOnActivityRes() => create();
  factory SubscribeOnActivityRes.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SubscribeOnActivityRes.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  SubscribeOnActivityRes clone() => SubscribeOnActivityRes()..mergeFromMessage(this);
  SubscribeOnActivityRes copyWith(void Function(SubscribeOnActivityRes) updates) => super.copyWith((message) => updates(message as SubscribeOnActivityRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SubscribeOnActivityRes create() => SubscribeOnActivityRes._();
  SubscribeOnActivityRes createEmptyInstance() => create();
  static $pb.PbList<SubscribeOnActivityRes> createRepeated() => $pb.PbList<SubscribeOnActivityRes>();
  @$core.pragma('dart2js:noInline')
  static SubscribeOnActivityRes getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SubscribeOnActivityRes>(create);
  static SubscribeOnActivityRes _defaultInstance;
}
