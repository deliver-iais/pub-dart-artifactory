...
class FetchMediasReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FetchMediasReq', package: const $pb.PackageName('proto.pub.v1.query'), createEmptyInstance: create)
    ...
    ..e<FetchMediasReq_MediaType>(4, 'mediaType', $pb.PbFieldType.OE, defaultOrMaker: FetchMediasReq_MediaType.MULTI_MEDIA, valueOf: FetchMediasReq_MediaType.valueOf, enumValues: FetchMediasReq_MediaType.values)
