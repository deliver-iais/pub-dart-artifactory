...
class GetAnnouncementRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetAnnouncementRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ..pc<$42.Announcement>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'announcement', $pb.PbFieldType.PM, subBuilder: $42.Announcement.create)
    ..hasRequiredFields = false
  ;

  GetAnnouncementRes._() : super();
  factory GetAnnouncementRes({
    $core.Iterable<$42.Announcement>? announcement,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.List<$42.Announcement> get announcement => $_getList(0);
}
