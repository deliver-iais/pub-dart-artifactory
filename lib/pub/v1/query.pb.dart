...
class IdIsAvailableRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('IdIsAvailableRes', package: const $pb.PackageName('proto.pub.v1.query'), createEmptyInstance: create)
    ..e<IdIsAvailableRes_Status>(1, 'status', $pb.PbFieldType.OE, defaultOrMaker: IdIsAvailableRes_Status.AVAILABLE, valueOf: IdIsAvailableRes_Status.valueOf, enumValues: IdIsAvailableRes_Status.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  IdIsAvailableRes_Status get status => $_getN(0);
  @$pb.TagNumber(1)
  set status(IdIsAvailableRes_Status v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SetIdRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SetIdRes', package: const $pb.PackageName('proto.pub.v1.query'), createEmptyInstance: create)
    ..e<SetIdRes_Status>(1, 'status', $pb.PbFieldType.OE, defaultOrMaker: SetIdRes_Status.OK, valueOf: SetIdRes_Status.valueOf, enumValues: SetIdRes_Status.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  SetIdRes_Status get status => $_getN(0);
  @$pb.TagNumber(1)
  set status(SetIdRes_Status v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearStatus() => clearField(1);
