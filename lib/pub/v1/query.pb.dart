...
class ForwardMessagesReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ForwardMessagesReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ..aOM<$17.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fromRoom', subBuilder: $17.Uid.create)
    ..aOM<$17.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'toRoom', subBuilder: $17.Uid.create)
  ...
  @$pb.TagNumber(1)
  $17.Uid get fromRoom => $_getN(0);
  @$pb.TagNumber(1)
  set fromRoom($17.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFromRoom() => $_has(0);
  @$pb.TagNumber(1)
  void clearFromRoom() => clearField(1);
  @$pb.TagNumber(1)
  $17.Uid ensureFromRoom() => $_ensure(0);

  @$pb.TagNumber(2)
  $17.Uid get toRoom => $_getN(1);
  @$pb.TagNumber(2)
  set toRoom($17.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasToRoom() => $_has(1);
  @$pb.TagNumber(2)
  void clearToRoom() => clearField(2);
  @$pb.TagNumber(2)
  $17.Uid ensureToRoom() => $_ensure(1);
