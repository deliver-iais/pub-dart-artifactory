...
class SaveLocalMessageRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SaveLocalMessageRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.query'), createEmptyInstance: create)
    ...
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messagesSize')
    ..hasRequiredFields = false
  ;
  ...
  factory SaveLocalMessageRes({
    ...
    if (messagesSize != null) {
      _result.messagesSize = messagesSize;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $fixnum.Int64 get messagesSize => $_getI64(1);
  @$pb.TagNumber(2)
  set messagesSize($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessagesSize() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessagesSize() => clearField(2);
}
