...
const NewerVersionInformation$json = const {
  ...
  '2': const [
    const {'1': 'newer_version', '3': 1, '4': 1, '5': 9, '10': 'newerVersion'},
    const {'1': 'newer_version_description', '3': 2, '4': 1, '5': 9, '10': 'newerVersionDescription'},
  ],
};

/// Descriptor for `NewerVersionInformation`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List newerVersionInformationDescriptor = $convert.base64Decode('ChdOZXdlclZlcnNpb25JbmZvcm1hdGlvbhIjCg1uZXdlcl92ZXJzaW9uGAEgASgJUgxuZXdlclZlcnNpb24SOgoZbmV3ZXJfdmVyc2lvbl9kZXNjcmlwdGlvbhgCIAEoCVIXbmV3ZXJWZXJzaW9uRGVzY3JpcHRpb24=');
