...
@$core.Deprecated('Use getQrCodeTokenReqDescriptor instead')
const GetQrCodeTokenReq$json = const {
  '1': 'GetQrCodeTokenReq',
  '2': const [
    const {'1': 'platform', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Platform', '10': 'platform'},
    const {'1': 'clientSecretKey', '3': 2, '4': 1, '5': 9, '10': 'clientSecretKey'},
  ],
};

/// Descriptor for `GetQrCodeTokenReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getQrCodeTokenReqDescriptor = $convert.base64Decode('ChFHZXRRckNvZGVUb2tlblJlcRI5CghwbGF0Zm9ybRgBIAEoCzIdLnByb3RvLnB1Yi52MS5tb2RlbHMuUGxhdGZvcm1SCHBsYXRmb3JtEigKD2NsaWVudFNlY3JldEtleRgCIAEoCVIPY2xpZW50U2VjcmV0S2V5');
@$core.Deprecated('Use getQrCodeTokenResDescriptor instead')
const GetQrCodeTokenRes$json = const {
  '1': 'GetQrCodeTokenRes',
  '2': const [
...
/// Descriptor for `GetQrCodeTokenRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getQrCodeTokenResDescriptor = $convert.base64Decode('ChFHZXRRckNvZGVUb2tlblJlcxIUCgV0b2tlbhgBIAEoCVIFdG9rZW4SHwoLdmFsaWRfdW50aWwYAiABKANSCnZhbGlkVW50aWw=');
...
final $typed_data.Uint8List checkQrCodeIsVerifiedAndLoginReqDescriptor = $convert.base64Decode('CiBDaGVja1FyQ29kZUlzVmVyaWZpZWRBbmRMb2dpblJlcRIUCgV0b2tlbhgBIAEoCVIFdG9rZW4SKAoPY2xpZW50U2VjcmV0S2V5GAIgASgJUg9jbGllbnRTZWNyZXRLZXkSOQoIcGxhdGZvcm0YAyABKAsyHS5wcm90by5wdWIudjEubW9kZWxzLlBsYXRmb3JtUghwbGF0Zm9ybQ==');
