...
const AccessTokenRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'newer_version', '3': 6, '4': 1, '5': 9, '10': 'newerVersion'},
    const {'1': 'newer_version_description', '3': 7, '4': 1, '5': 9, '10': 'newerVersionDescription'},
  ],
...
final $typed_data.Uint8List accessTokenResDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List verifyEmailAddressReqDescriptor = $convert.base64Decode('ChVWZXJpZnlFbWFpbEFkZHJlc3NSZXESEgoEaGFzaBgBIAEoCVIEaGFzaA==');
...
final $typed_data.Uint8List verifyEmailAddressResDescriptor = $convert.base64Decode('ChVWZXJpZnlFbWFpbEFkZHJlc3NSZXM=');
...
final $typed_data.Uint8List sendErasePasswordEmailReqDescriptor = $convert.base64Decode('ChlTZW5kRXJhc2VQYXNzd29yZEVtYWlsUmVxEkMKDHBob25lX251bWJlchgBIAEoCzIgLnByb3RvLnB1Yi52MS5tb2RlbHMuUGhvbmVOdW1iZXJSC3Bob25lTnVtYmVy');
...
final $typed_data.Uint8List sendErasePasswordEmailResDescriptor = $convert.base64Decode('ChlTZW5kRXJhc2VQYXNzd29yZEVtYWlsUmVz');
...
final $typed_data.Uint8List erasePasswordReqDescriptor = $convert.base64Decode('ChBFcmFzZVBhc3N3b3JkUmVxEhIKBGhhc2gYASABKAlSBGhhc2g=');
...
final $typed_data.Uint8List erasePasswordResDescriptor = $convert.base64Decode('ChBFcmFzZVBhc3N3b3JkUmVz');
