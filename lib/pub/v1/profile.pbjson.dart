...
@$core.Deprecated('Use getWebViewIdentifyTokenReqDescriptor instead')
const GetWebViewIdentifyTokenReq$json = const {
  '1': 'GetWebViewIdentifyTokenReq',
};

/// Descriptor for `GetWebViewIdentifyTokenReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getWebViewIdentifyTokenReqDescriptor = $convert.base64Decode('ChpHZXRXZWJWaWV3SWRlbnRpZnlUb2tlblJlcQ==');
@$core.Deprecated('Use getWebViewIdentifyTokenResDescriptor instead')
const GetWebViewIdentifyTokenRes$json = const {
  '1': 'GetWebViewIdentifyTokenRes',
  '2': const [
    const {'1': 'identifyToken', '3': 1, '4': 1, '5': 9, '10': 'identifyToken'},
  ],
};

/// Descriptor for `GetWebViewIdentifyTokenRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getWebViewIdentifyTokenResDescriptor = $convert.base64Decode('ChpHZXRXZWJWaWV3SWRlbnRpZnlUb2tlblJlcxIkCg1pZGVudGlmeVRva2VuGAEgASgJUg1pZGVudGlmeVRva2Vu');
