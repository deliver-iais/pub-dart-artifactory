...
const SaveUserProfileReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'deprecated_password_hash', '3': 1, '4': 1, '5': 9, '10': 'deprecatedPasswordHash'},
    const {'1': 'deprecated_email', '3': 5, '4': 1, '5': 9, '10': 'deprecatedEmail'},
  ],
};

/// Descriptor for `SaveUserProfileReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List saveUserProfileReqDescriptor = $convert.base64Decode('');
