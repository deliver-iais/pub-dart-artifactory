...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$14.MessageDeliveryAck>(9, 'messageDeliveryAck', subBuilder: $14.MessageDeliveryAck.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  $14.MessageDeliveryAck get messageDeliveryAck => $_getN(7);
  @$pb.TagNumber(9)
  set messageDeliveryAck($14.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(7);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $14.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(7);
}
