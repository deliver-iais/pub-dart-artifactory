...
import 'models/activity.pb.dart' as $25;
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$23.Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $23.Message.create)
    ..aOM<$24.Seen>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $24.Seen.create)
    ..aOM<$25.Activity>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $25.Activity.create)
    ..aOM<$17.LiveLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'liveLocationStatusChanged', subBuilder: $17.LiveLocation.create)
    ..aOM<Pong>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pong', subBuilder: Pong.create)
    ..aOM<$23.MessageDeliveryAck>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageDeliveryAck', subBuilder: $23.MessageDeliveryAck.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ServerPacket({
    ...
    $17.LiveLocation liveLocationStatusChanged,
    Pong pong,
    $23.MessageDeliveryAck messageDeliveryAck,
  }) {
    final _result = create();
    if (error != null) {
      _result.error = error;
  ...
  @$pb.TagNumber(2)
  $23.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($23.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $23.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $24.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($24.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $24.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $25.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($25.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $25.Activity ensureActivity() => $_ensure(3);

  @$pb.TagNumber(7)
  $17.LiveLocation get liveLocationStatusChanged => $_getN(4);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($17.LiveLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(4);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $17.LiveLocation ensureLiveLocationStatusChanged() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $23.MessageDeliveryAck get messageDeliveryAck => $_getN(6);
  @$pb.TagNumber(9)
  set messageDeliveryAck($23.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(6);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $23.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(6);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$23.MessageByClient>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $23.MessageByClient.create)
    ..aOM<$24.SeenByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $24.SeenByClient.create)
    ..aOM<$25.ActivityByClient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $25.ActivityByClient.create)
  ...
  factory ClientPacket({
    $core.String id,
    $23.MessageByClient message,
    $24.SeenByClient seen,
    $25.ActivityByClient activity,
    Ping ping,
  }) {
    final _result = create();
    if (id != null) {
  ...
  @$pb.TagNumber(2)
  $23.MessageByClient get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($23.MessageByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $23.MessageByClient ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $24.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($24.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $24.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $25.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($25.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $25.ActivityByClient ensureActivity() => $_ensure(3);
