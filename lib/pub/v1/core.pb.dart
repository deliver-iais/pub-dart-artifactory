...
import 'models/activity.pb.dart' as $23;
import 'models/event.pb.dart' as $24;
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$23.Activity>(4, 'activity', subBuilder: $23.Activity.create)
    ..aOM<$24.PollStatusChanged>(6, 'pollStatusChanged', subBuilder: $24.PollStatusChanged.create)
    ..aOM<$24.LiveLocationStatusChanged>(7, 'liveLocationStatusChanged', subBuilder: $24.LiveLocationStatusChanged.create)
  ...
  @$pb.TagNumber(4)
  $23.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($23.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $23.Activity ensureActivity() => $_ensure(3);

  @$pb.TagNumber(6)
  $24.PollStatusChanged get pollStatusChanged => $_getN(4);
  @$pb.TagNumber(6)
  set pollStatusChanged($24.PollStatusChanged v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPollStatusChanged() => $_has(4);
  @$pb.TagNumber(6)
  void clearPollStatusChanged() => clearField(6);
  @$pb.TagNumber(6)
  $24.PollStatusChanged ensurePollStatusChanged() => $_ensure(4);

  @$pb.TagNumber(7)
  $24.LiveLocationStatusChanged get liveLocationStatusChanged => $_getN(5);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($24.LiveLocationStatusChanged v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(5);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $24.LiveLocationStatusChanged ensureLiveLocationStatusChanged() => $_ensure(5);
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$23.ActivityByClient>(4, 'activity', subBuilder: $23.ActivityByClient.create)
  ...
  @$pb.TagNumber(4)
  $23.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($23.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $23.ActivityByClient ensureActivity() => $_ensure(3);
