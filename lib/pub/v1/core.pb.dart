...
import 'models/message.pb.dart' as $15;
import 'models/event.pb.dart' as $16;
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$15.Message>(2, 'message', subBuilder: $15.Message.create)
    ..aOM<$16.Seen>(3, 'seen', subBuilder: $16.Seen.create)
    ..aOM<$16.Activity>(4, 'activity', subBuilder: $16.Activity.create)
    ..aOM<$16.PollStatusChanged>(6, 'pollStatusChanged', subBuilder: $16.PollStatusChanged.create)
    ..aOM<$16.LiveLocationStatusChanged>(7, 'liveLocationStatusChanged', subBuilder: $16.LiveLocationStatusChanged.create)
    ..aOM<Pong>(8, 'pong', subBuilder: Pong.create)
    ..aOM<$15.MessageDeliveryAck>(9, 'messageDeliveryAck', subBuilder: $15.MessageDeliveryAck.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $15.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($15.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $15.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $16.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($16.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $16.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $16.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($16.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $16.Activity ensureActivity() => $_ensure(3);

  @$pb.TagNumber(6)
  $16.PollStatusChanged get pollStatusChanged => $_getN(4);
  @$pb.TagNumber(6)
  set pollStatusChanged($16.PollStatusChanged v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPollStatusChanged() => $_has(4);
  @$pb.TagNumber(6)
  void clearPollStatusChanged() => clearField(6);
  @$pb.TagNumber(6)
  $16.PollStatusChanged ensurePollStatusChanged() => $_ensure(4);

  @$pb.TagNumber(7)
  $16.LiveLocationStatusChanged get liveLocationStatusChanged => $_getN(5);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($16.LiveLocationStatusChanged v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(5);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $16.LiveLocationStatusChanged ensureLiveLocationStatusChanged() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $15.MessageDeliveryAck get messageDeliveryAck => $_getN(7);
  @$pb.TagNumber(9)
  set messageDeliveryAck($15.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(7);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $15.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(7);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..aOS(1, 'id')
    ..aOM<$15.MessageByClient>(2, 'message', subBuilder: $15.MessageByClient.create)
    ..aOM<$16.SeenByClient>(3, 'seen', subBuilder: $16.SeenByClient.create)
    ..aOM<$16.ActivityByClient>(4, 'activity', subBuilder: $16.ActivityByClient.create)
  ...
  @$pb.TagNumber(2)
  $15.MessageByClient get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($15.MessageByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $15.MessageByClient ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $16.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($16.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $16.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $16.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($16.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $16.ActivityByClient ensureActivity() => $_ensure(3);
