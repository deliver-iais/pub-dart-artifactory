...
import 'models/message.pb.dart' as $13;
import 'models/error.pb.dart' as $10;
import 'models/event.pb.dart' as $14;
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 6, 7])
    ..aOM<$13.Message>(1, 'message', subBuilder: $13.Message.create)
    ..aOM<$10.Error>(2, 'error', subBuilder: $10.Error.create)
    ..aOM<$14.Seen>(3, 'seen', subBuilder: $14.Seen.create)
    ..aOM<$14.Activity>(4, 'activity', subBuilder: $14.Activity.create)
    ..aOM<$14.PollStatusChanged>(6, 'pollStatusChanged', subBuilder: $14.PollStatusChanged.create)
    ..aOM<$14.LiveLocationStatusChanged>(7, 'liveLocationStatusChanged', subBuilder: $14.LiveLocationStatusChanged.create)
  ...
  @$pb.TagNumber(1)
  $13.Message get message => $_getN(0);
  @$pb.TagNumber(1)
  set message($13.Message v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMessage() => $_has(0);
  @$pb.TagNumber(1)
  void clearMessage() => clearField(1);
  @$pb.TagNumber(1)
  $13.Message ensureMessage() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $14.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($14.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $14.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $14.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($14.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $14.Activity ensureActivity() => $_ensure(3);

  @$pb.TagNumber(6)
  $14.PollStatusChanged get pollStatusChanged => $_getN(4);
  @$pb.TagNumber(6)
  set pollStatusChanged($14.PollStatusChanged v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPollStatusChanged() => $_has(4);
  @$pb.TagNumber(6)
  void clearPollStatusChanged() => clearField(6);
  @$pb.TagNumber(6)
  $14.PollStatusChanged ensurePollStatusChanged() => $_ensure(4);

  @$pb.TagNumber(7)
  $14.LiveLocationStatusChanged get liveLocationStatusChanged => $_getN(5);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($14.LiveLocationStatusChanged v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(5);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $14.LiveLocationStatusChanged ensureLiveLocationStatusChanged() => $_ensure(5);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$13.MessageByClient>(1, 'message', subBuilder: $13.MessageByClient.create)
    ..aOM<$14.SeenByClient>(2, 'seen', subBuilder: $14.SeenByClient.create)
    ..aOM<$14.ActivityByClient>(3, 'activity', subBuilder: $14.ActivityByClient.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $13.MessageByClient get message => $_getN(0);
  @$pb.TagNumber(1)
  set message($13.MessageByClient v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMessage() => $_has(0);
  @$pb.TagNumber(1)
  void clearMessage() => clearField(1);
  @$pb.TagNumber(1)
  $13.MessageByClient ensureMessage() => $_ensure(0);

  @$pb.TagNumber(2)
  $14.SeenByClient get seen => $_getN(1);
  @$pb.TagNumber(2)
  set seen($14.SeenByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSeen() => $_has(1);
  @$pb.TagNumber(2)
  void clearSeen() => clearField(2);
  @$pb.TagNumber(2)
  $14.SeenByClient ensureSeen() => $_ensure(1);

  @$pb.TagNumber(3)
  $14.ActivityByClient get activity => $_getN(2);
  @$pb.TagNumber(3)
  set activity($14.ActivityByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasActivity() => $_has(2);
  @$pb.TagNumber(3)
  void clearActivity() => clearField(3);
  @$pb.TagNumber(3)
  $14.ActivityByClient ensureActivity() => $_ensure(2);
}
