...
class Pong extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pong', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$33.MessageDeliveryAck>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastMessageDeliveryAck', subBuilder: $33.MessageDeliveryAck.create)
  ...
  @$pb.TagNumber(4)
  $33.MessageDeliveryAck get lastMessageDeliveryAck => $_getN(3);
  @$pb.TagNumber(4)
  set lastMessageDeliveryAck($33.MessageDeliveryAck v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastMessageDeliveryAck() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastMessageDeliveryAck() => clearField(4);
  @$pb.TagNumber(4)
  $33.MessageDeliveryAck ensureLastMessageDeliveryAck() => $_ensure(3);
...
class RoomPresenceTypeChanged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomPresenceTypeChanged', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..e<$37.PresenceType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'presenceType', $pb.PbFieldType.OE, defaultOrMaker: $37.PresenceType.ACTIVE, valueOf: $37.PresenceType.valueOf, enumValues: $37.PresenceType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $37.PresenceType get presenceType => $_getN(1);
  @$pb.TagNumber(2)
  set presenceType($37.PresenceType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$33.Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $33.Message.create)
    ..aOM<$35.Seen>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $35.Seen.create)
    ..aOM<$36.Activity>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $36.Activity.create)
    ...
    ..aOM<$24.LiveLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'liveLocationStatusChanged', subBuilder: $24.LiveLocation.create)
    ..aOM<Pong>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pong', subBuilder: Pong.create)
    ..aOM<$33.MessageDeliveryAck>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageDeliveryAck', subBuilder: $33.MessageDeliveryAck.create)
    ..aOM<$30.CallOffer>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $30.CallOffer.create)
    ..aOM<$30.CallAnswer>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $30.CallAnswer.create)
    ...
    ..aOM<$30.CallEventV2>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $30.CallEventV2.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ServerPacket({
    ...
    $24.LiveLocation? liveLocationStatusChanged,
    Pong? pong,
    $33.MessageDeliveryAck? messageDeliveryAck,
    $30.CallOffer? callOffer,
    $30.CallAnswer? callAnswer,
  ...
  @$pb.TagNumber(2)
  $33.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($33.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $33.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $35.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($35.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $35.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $36.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($36.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $36.Activity ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $24.LiveLocation get liveLocationStatusChanged => $_getN(6);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($24.LiveLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(6);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $24.LiveLocation ensureLiveLocationStatusChanged() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $33.MessageDeliveryAck get messageDeliveryAck => $_getN(8);
  @$pb.TagNumber(9)
  set messageDeliveryAck($33.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(8);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $33.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(8);

  @$pb.TagNumber(10)
  $30.CallOffer get callOffer => $_getN(9);
  @$pb.TagNumber(10)
  set callOffer($30.CallOffer v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCallOffer() => $_has(9);
  @$pb.TagNumber(10)
  void clearCallOffer() => clearField(10);
  @$pb.TagNumber(10)
  $30.CallOffer ensureCallOffer() => $_ensure(9);

  @$pb.TagNumber(11)
  $30.CallAnswer get callAnswer => $_getN(10);
  @$pb.TagNumber(11)
  set callAnswer($30.CallAnswer v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCallAnswer() => $_has(10);
  @$pb.TagNumber(11)
  void clearCallAnswer() => clearField(11);
  @$pb.TagNumber(11)
  $30.CallAnswer ensureCallAnswer() => $_ensure(10);
  ...
  @$pb.TagNumber(13)
  $30.CallEventV2 get callEvent => $_getN(12);
  @$pb.TagNumber(13)
  set callEvent($30.CallEventV2 v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasCallEvent() => $_has(12);
  @$pb.TagNumber(13)
  void clearCallEvent() => clearField(13);
  @$pb.TagNumber(13)
  $30.CallEventV2 ensureCallEvent() => $_ensure(12);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ClientPacket_Type> _ClientPacket_TypeByTag = {
    ...
    9 : ClientPacket_Type.localChatMessage,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$35.SeenByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $35.SeenByClient.create)
    ..aOM<$36.ActivityByClient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $36.ActivityByClient.create)
    ..aOM<Ping>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ping', subBuilder: Ping.create)
    ..aOM<$30.CallOfferByClient>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $30.CallOfferByClient.create)
    ..aOM<$30.CallAnswerByClient>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $30.CallAnswerByClient.create)
    ..aOM<$30.CallEventV2ByClient>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $30.CallEventV2ByClient.create)
    ..aOM<$33.LocalChatMessage>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localChatMessage', subBuilder: $33.LocalChatMessage.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ClientPacket({
    ...
    $35.SeenByClient? seen,
    $36.ActivityByClient? activity,
    Ping? ping,
    $30.CallOfferByClient? callOffer,
    $30.CallAnswerByClient? callAnswer,
    $30.CallEventV2ByClient? callEvent,
    $33.LocalChatMessage? localChatMessage,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
    ...
    if (localChatMessage != null) {
      _result.localChatMessage = localChatMessage;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(3)
  $35.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($35.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $35.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $36.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($36.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $36.ActivityByClient ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $30.CallOfferByClient get callOffer => $_getN(5);
  @$pb.TagNumber(6)
  set callOffer($30.CallOfferByClient v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCallOffer() => $_has(5);
  @$pb.TagNumber(6)
  void clearCallOffer() => clearField(6);
  @$pb.TagNumber(6)
  $30.CallOfferByClient ensureCallOffer() => $_ensure(5);

  @$pb.TagNumber(7)
  $30.CallAnswerByClient get callAnswer => $_getN(6);
  @$pb.TagNumber(7)
  set callAnswer($30.CallAnswerByClient v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCallAnswer() => $_has(6);
  @$pb.TagNumber(7)
  void clearCallAnswer() => clearField(7);
  @$pb.TagNumber(7)
  $30.CallAnswerByClient ensureCallAnswer() => $_ensure(6);

  @$pb.TagNumber(8)
  $30.CallEventV2ByClient get callEvent => $_getN(7);
  @$pb.TagNumber(8)
  set callEvent($30.CallEventV2ByClient v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCallEvent() => $_has(7);
  @$pb.TagNumber(8)
  void clearCallEvent() => clearField(8);
  @$pb.TagNumber(8)
  $30.CallEventV2ByClient ensureCallEvent() => $_ensure(7);

  @$pb.TagNumber(9)
  $33.LocalChatMessage get localChatMessage => $_getN(8);
  @$pb.TagNumber(9)
  set localChatMessage($33.LocalChatMessage v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasLocalChatMessage() => $_has(8);
  @$pb.TagNumber(9)
  void clearLocalChatMessage() => clearField(9);
  @$pb.TagNumber(9)
  $33.LocalChatMessage ensureLocalChatMessage() => $_ensure(8);
}
