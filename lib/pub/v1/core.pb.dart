...
class Pong extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pong', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$31.MessageDeliveryAck>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastMessageDeliveryAck', subBuilder: $31.MessageDeliveryAck.create)
  ...
  @$pb.TagNumber(4)
  $31.MessageDeliveryAck get lastMessageDeliveryAck => $_getN(3);
  @$pb.TagNumber(4)
  set lastMessageDeliveryAck($31.MessageDeliveryAck v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastMessageDeliveryAck() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastMessageDeliveryAck() => clearField(4);
  @$pb.TagNumber(4)
  $31.MessageDeliveryAck ensureLastMessageDeliveryAck() => $_ensure(3);
...
class RoomPresenceTypeChanged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomPresenceTypeChanged', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..e<$34.PresenceType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'presenceType', $pb.PbFieldType.OE, defaultOrMaker: $34.PresenceType.ACTIVE, valueOf: $34.PresenceType.valueOf, enumValues: $34.PresenceType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $34.PresenceType get presenceType => $_getN(1);
  @$pb.TagNumber(2)
  set presenceType($34.PresenceType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$31.Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $31.Message.create)
    ..aOM<$32.Seen>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $32.Seen.create)
    ..aOM<$33.Activity>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $33.Activity.create)
    ...
    ..aOM<$22.LiveLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'liveLocationStatusChanged', subBuilder: $22.LiveLocation.create)
    ..aOM<Pong>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pong', subBuilder: Pong.create)
    ..aOM<$31.MessageDeliveryAck>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageDeliveryAck', subBuilder: $31.MessageDeliveryAck.create)
    ..aOM<$28.CallOffer>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $28.CallOffer.create)
    ..aOM<$28.CallAnswer>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $28.CallAnswer.create)
    ...
    ..aOM<$28.CallEventV2>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $28.CallEventV2.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ServerPacket({
    ...
    $22.LiveLocation? liveLocationStatusChanged,
    Pong? pong,
    $31.MessageDeliveryAck? messageDeliveryAck,
    $28.CallOffer? callOffer,
    $28.CallAnswer? callAnswer,
    ExpletivePacket? expletivePacket,
    $28.CallEventV2? callEvent,
  }) {
    final _result = create();
    if (error != null) {
      _result.error = error;
  ...
  @$pb.TagNumber(2)
  $31.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($31.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $31.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $32.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($32.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $32.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $33.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($33.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $33.Activity ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $22.LiveLocation get liveLocationStatusChanged => $_getN(6);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($22.LiveLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(6);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $22.LiveLocation ensureLiveLocationStatusChanged() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $31.MessageDeliveryAck get messageDeliveryAck => $_getN(8);
  @$pb.TagNumber(9)
  set messageDeliveryAck($31.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(8);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $31.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(8);

  @$pb.TagNumber(10)
  $28.CallOffer get callOffer => $_getN(9);
  @$pb.TagNumber(10)
  set callOffer($28.CallOffer v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCallOffer() => $_has(9);
  @$pb.TagNumber(10)
  void clearCallOffer() => clearField(10);
  @$pb.TagNumber(10)
  $28.CallOffer ensureCallOffer() => $_ensure(9);

  @$pb.TagNumber(11)
  $28.CallAnswer get callAnswer => $_getN(10);
  @$pb.TagNumber(11)
  set callAnswer($28.CallAnswer v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCallAnswer() => $_has(10);
  @$pb.TagNumber(11)
  void clearCallAnswer() => clearField(11);
  @$pb.TagNumber(11)
  $28.CallAnswer ensureCallAnswer() => $_ensure(10);
  ...
  @$pb.TagNumber(13)
  $28.CallEventV2 get callEvent => $_getN(12);
  @$pb.TagNumber(13)
  set callEvent($28.CallEventV2 v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasCallEvent() => $_has(12);
  @$pb.TagNumber(13)
  void clearCallEvent() => clearField(13);
  @$pb.TagNumber(13)
  $28.CallEventV2 ensureCallEvent() => $_ensure(12);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$32.SeenByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $32.SeenByClient.create)
    ..aOM<$33.ActivityByClient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $33.ActivityByClient.create)
    ..aOM<Ping>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ping', subBuilder: Ping.create)
    ..aOM<$28.CallOfferByClient>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $28.CallOfferByClient.create)
    ..aOM<$28.CallAnswerByClient>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $28.CallAnswerByClient.create)
    ..aOM<$28.CallEventV2ByClient>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $28.CallEventV2ByClient.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ClientPacket({
    ...
    $32.SeenByClient? seen,
    $33.ActivityByClient? activity,
    Ping? ping,
    $28.CallOfferByClient? callOffer,
    $28.CallAnswerByClient? callAnswer,
    $28.CallEventV2ByClient? callEvent,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
  ...
  @$pb.TagNumber(3)
  $32.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($32.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $32.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $33.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($33.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $33.ActivityByClient ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $28.CallOfferByClient get callOffer => $_getN(5);
  @$pb.TagNumber(6)
  set callOffer($28.CallOfferByClient v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCallOffer() => $_has(5);
  @$pb.TagNumber(6)
  void clearCallOffer() => clearField(6);
  @$pb.TagNumber(6)
  $28.CallOfferByClient ensureCallOffer() => $_ensure(5);

  @$pb.TagNumber(7)
  $28.CallAnswerByClient get callAnswer => $_getN(6);
  @$pb.TagNumber(7)
  set callAnswer($28.CallAnswerByClient v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCallAnswer() => $_has(6);
  @$pb.TagNumber(7)
  void clearCallAnswer() => clearField(7);
  @$pb.TagNumber(7)
  $28.CallAnswerByClient ensureCallAnswer() => $_ensure(6);

  @$pb.TagNumber(8)
  $28.CallEventV2ByClient get callEvent => $_getN(7);
  @$pb.TagNumber(8)
  set callEvent($28.CallEventV2ByClient v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCallEvent() => $_has(7);
  @$pb.TagNumber(8)
  void clearCallEvent() => clearField(8);
  @$pb.TagNumber(8)
  $28.CallEventV2ByClient ensureCallEvent() => $_ensure(7);
}
