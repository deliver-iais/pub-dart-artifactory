...
import 'models/seen.pb.dart' as $33;
import 'models/activity.pb.dart' as $34;
import 'models/location.pb.dart' as $23;
import 'models/call.pb.dart' as $29;

import 'core.pbenum.dart';
import 'models/room_metadata.pbenum.dart' as $35;
...
class Pong extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pong', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$32.MessageDeliveryAck>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastMessageDeliveryAck', subBuilder: $32.MessageDeliveryAck.create)
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastRoomMetadataUpdateTime')
    ..hasRequiredFields = false
  ;
  ...
  factory Pong({
    ...
    $32.MessageDeliveryAck? lastMessageDeliveryAck,
    $fixnum.Int64? lastRoomMetadataUpdateTime,
  }) {
    final _result = create();
    if (packetId != null) {
    ...
    if (lastRoomMetadataUpdateTime != null) {
      _result.lastRoomMetadataUpdateTime = lastRoomMetadataUpdateTime;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(4)
  $32.MessageDeliveryAck get lastMessageDeliveryAck => $_getN(3);
  @$pb.TagNumber(4)
  set lastMessageDeliveryAck($32.MessageDeliveryAck v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastMessageDeliveryAck() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastMessageDeliveryAck() => clearField(4);
  @$pb.TagNumber(4)
  $32.MessageDeliveryAck ensureLastMessageDeliveryAck() => $_ensure(3);

  @$pb.TagNumber(5)
  $fixnum.Int64 get lastRoomMetadataUpdateTime => $_getI64(4);
  @$pb.TagNumber(5)
  set lastRoomMetadataUpdateTime($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasLastRoomMetadataUpdateTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearLastRoomMetadataUpdateTime() => clearField(5);
}
...
class RoomPresenceTypeChanged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomPresenceTypeChanged', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..e<$35.PresenceType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'presenceType', $pb.PbFieldType.OE, defaultOrMaker: $35.PresenceType.ACTIVE, valueOf: $35.PresenceType.valueOf, enumValues: $35.PresenceType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $35.PresenceType get presenceType => $_getN(1);
  @$pb.TagNumber(2)
  set presenceType($35.PresenceType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ServerPacket extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ServerPacket_Type> _ServerPacket_TypeByTag = {
    ...
    13 : ServerPacket_Type.callEvent,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13])
    ..aOM<ErrorOnPacket>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: ErrorOnPacket.create)
    ..aOM<$32.Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $32.Message.create)
    ..aOM<$33.Seen>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $33.Seen.create)
    ..aOM<$34.Activity>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $34.Activity.create)
    ...
    ..aOM<$23.LiveLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'liveLocationStatusChanged', subBuilder: $23.LiveLocation.create)
    ..aOM<Pong>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pong', subBuilder: Pong.create)
    ..aOM<$32.MessageDeliveryAck>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageDeliveryAck', subBuilder: $32.MessageDeliveryAck.create)
    ..aOM<$29.CallOffer>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $29.CallOffer.create)
    ..aOM<$29.CallAnswer>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $29.CallAnswer.create)
    ...
    ..aOM<$29.CallEventV2>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $29.CallEventV2.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ServerPacket({
    ...
    $23.LiveLocation? liveLocationStatusChanged,
    Pong? pong,
    $32.MessageDeliveryAck? messageDeliveryAck,
    $29.CallOffer? callOffer,
    $29.CallAnswer? callAnswer,
    ExpletivePacket? expletivePacket,
    $29.CallEventV2? callEvent,
  }) {
    final _result = create();
    if (error != null) {
      _result.error = error;
  ...
  @$pb.TagNumber(2)
  $32.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($32.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $32.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $33.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($33.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $33.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $34.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($34.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $34.Activity ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $23.LiveLocation get liveLocationStatusChanged => $_getN(6);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($23.LiveLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(6);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $23.LiveLocation ensureLiveLocationStatusChanged() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $32.MessageDeliveryAck get messageDeliveryAck => $_getN(8);
  @$pb.TagNumber(9)
  set messageDeliveryAck($32.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(8);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $32.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(8);

  @$pb.TagNumber(10)
  $29.CallOffer get callOffer => $_getN(9);
  @$pb.TagNumber(10)
  set callOffer($29.CallOffer v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCallOffer() => $_has(9);
  @$pb.TagNumber(10)
  void clearCallOffer() => clearField(10);
  @$pb.TagNumber(10)
  $29.CallOffer ensureCallOffer() => $_ensure(9);

  @$pb.TagNumber(11)
  $29.CallAnswer get callAnswer => $_getN(10);
  @$pb.TagNumber(11)
  set callAnswer($29.CallAnswer v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCallAnswer() => $_has(10);
  @$pb.TagNumber(11)
  void clearCallAnswer() => clearField(11);
  @$pb.TagNumber(11)
  $29.CallAnswer ensureCallAnswer() => $_ensure(10);
  ...
  @$pb.TagNumber(13)
  $29.CallEventV2 get callEvent => $_getN(12);
  @$pb.TagNumber(13)
  set callEvent($29.CallEventV2 v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasCallEvent() => $_has(12);
  @$pb.TagNumber(13)
  void clearCallEvent() => clearField(13);
  @$pb.TagNumber(13)
  $29.CallEventV2 ensureCallEvent() => $_ensure(12);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$32.MessageByClient>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $32.MessageByClient.create)
    ..aOM<$33.SeenByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $33.SeenByClient.create)
    ..aOM<$34.ActivityByClient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $34.ActivityByClient.create)
    ..aOM<Ping>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ping', subBuilder: Ping.create)
    ..aOM<$29.CallOfferByClient>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $29.CallOfferByClient.create)
    ..aOM<$29.CallAnswerByClient>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $29.CallAnswerByClient.create)
    ..aOM<$29.CallEventV2ByClient>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $29.CallEventV2ByClient.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ClientPacket({
    $core.String? id,
    $32.MessageByClient? message,
    $33.SeenByClient? seen,
    $34.ActivityByClient? activity,
    Ping? ping,
    $29.CallOfferByClient? callOffer,
    $29.CallAnswerByClient? callAnswer,
    $29.CallEventV2ByClient? callEvent,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
  ...
  @$pb.TagNumber(2)
  $32.MessageByClient get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($32.MessageByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $32.MessageByClient ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $33.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($33.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $33.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $34.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($34.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $34.ActivityByClient ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $29.CallOfferByClient get callOffer => $_getN(5);
  @$pb.TagNumber(6)
  set callOffer($29.CallOfferByClient v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCallOffer() => $_has(5);
  @$pb.TagNumber(6)
  void clearCallOffer() => clearField(6);
  @$pb.TagNumber(6)
  $29.CallOfferByClient ensureCallOffer() => $_ensure(5);

  @$pb.TagNumber(7)
  $29.CallAnswerByClient get callAnswer => $_getN(6);
  @$pb.TagNumber(7)
  set callAnswer($29.CallAnswerByClient v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCallAnswer() => $_has(6);
  @$pb.TagNumber(7)
  void clearCallAnswer() => clearField(7);
  @$pb.TagNumber(7)
  $29.CallAnswerByClient ensureCallAnswer() => $_ensure(6);

  @$pb.TagNumber(8)
  $29.CallEventV2ByClient get callEvent => $_getN(7);
  @$pb.TagNumber(8)
  set callEvent($29.CallEventV2ByClient v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCallEvent() => $_has(7);
  @$pb.TagNumber(8)
  void clearCallEvent() => clearField(8);
  @$pb.TagNumber(8)
  $29.CallEventV2ByClient ensureCallEvent() => $_ensure(7);
}
