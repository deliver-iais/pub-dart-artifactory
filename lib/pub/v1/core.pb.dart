...
import 'models/message.pb.dart' as $28;
import 'models/seen.pb.dart' as $29;
import 'models/activity.pb.dart' as $30;
import 'models/location.pb.dart' as $20;
import 'models/call.pb.dart' as $26;

import 'core.pbenum.dart';
import 'models/room_metadata.pbenum.dart' as $31;
...
class RoomPresenceTypeChanged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomPresenceTypeChanged', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..e<$31.PresenceType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'presenceType', $pb.PbFieldType.OE, defaultOrMaker: $31.PresenceType.ACTIVE, valueOf: $31.PresenceType.valueOf, enumValues: $31.PresenceType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $31.PresenceType get presenceType => $_getN(1);
  @$pb.TagNumber(2)
  set presenceType($31.PresenceType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$28.Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $28.Message.create)
    ..aOM<$29.Seen>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $29.Seen.create)
    ..aOM<$30.Activity>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $30.Activity.create)
    ...
    ..aOM<$28.MessageDeliveryAck>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageDeliveryAck', subBuilder: $28.MessageDeliveryAck.create)
  ...
  factory ServerPacket({
    ...
    Pong? pong,
    $28.MessageDeliveryAck? messageDeliveryAck,
  ...
  @$pb.TagNumber(2)
  $28.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($28.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $28.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $29.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($29.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $29.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $30.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($30.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $30.Activity ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(9)
  $28.MessageDeliveryAck get messageDeliveryAck => $_getN(8);
  @$pb.TagNumber(9)
  set messageDeliveryAck($28.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(8);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $28.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(8);
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$28.MessageByClient>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $28.MessageByClient.create)
    ..aOM<$29.SeenByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $29.SeenByClient.create)
    ..aOM<$30.ActivityByClient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $30.ActivityByClient.create)
  ...
  factory ClientPacket({
    $core.String? id,
    $28.MessageByClient? message,
    $29.SeenByClient? seen,
    $30.ActivityByClient? activity,
    Ping? ping,
  ...
  @$pb.TagNumber(2)
  $28.MessageByClient get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($28.MessageByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $28.MessageByClient ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $29.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($29.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $29.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $30.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($30.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $30.ActivityByClient ensureActivity() => $_ensure(3);
