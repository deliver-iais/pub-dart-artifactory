...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 6, 7])
    ..aOM<$14.Message>(1, 'message', subBuilder: $14.Message.create)
    ..aOM<$11.Error>(2, 'error', subBuilder: $11.Error.create)
  ...
  @$pb.TagNumber(1)
  set message($14.Message v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $11.Error get error => $_getN(1);
  @$pb.TagNumber(2)
  set error($11.Error v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasError() => $_has(1);
  @$pb.TagNumber(2)
  void clearError() => clearField(2);
  @$pb.TagNumber(2)
  $11.Error ensureError() => $_ensure(1);
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$14.MessageByClient>(1, 'message', subBuilder: $14.MessageByClient.create)
    ..aOM<$15.SeenByClient>(2, 'seen', subBuilder: $15.SeenByClient.create)
    ..aOM<$15.ActivityByClient>(3, 'activity', subBuilder: $15.ActivityByClient.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $14.MessageByClient get message => $_getN(0);
  @$pb.TagNumber(1)
  set message($14.MessageByClient v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMessage() => $_has(0);
  @$pb.TagNumber(1)
  void clearMessage() => clearField(1);
  @$pb.TagNumber(1)
  $14.MessageByClient ensureMessage() => $_ensure(0);

  @$pb.TagNumber(2)
  $15.SeenByClient get seen => $_getN(1);
  @$pb.TagNumber(2)
  set seen($15.SeenByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSeen() => $_has(1);
  @$pb.TagNumber(2)
  void clearSeen() => clearField(2);
  @$pb.TagNumber(2)
  $15.SeenByClient ensureSeen() => $_ensure(1);

  @$pb.TagNumber(3)
  $15.ActivityByClient get activity => $_getN(2);
  @$pb.TagNumber(3)
  set activity($15.ActivityByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasActivity() => $_has(2);
  @$pb.TagNumber(3)
  void clearActivity() => clearField(3);
  @$pb.TagNumber(3)
  $15.ActivityByClient ensureActivity() => $_ensure(2);
}
