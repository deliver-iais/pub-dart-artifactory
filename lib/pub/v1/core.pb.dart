...
class RoomPresenceTypeChanged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomPresenceTypeChanged', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..e<$29.PresenceType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'presenceType', $pb.PbFieldType.OE, defaultOrMaker: $29.PresenceType.ACTIVE, valueOf: $29.PresenceType.valueOf, enumValues: $29.PresenceType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $29.PresenceType get presenceType => $_getN(1);
  @$pb.TagNumber(2)
  set presenceType($29.PresenceType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$26.Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $26.Message.create)
    ..aOM<$27.Seen>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $27.Seen.create)
    ..aOM<$28.Activity>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $28.Activity.create)
    ...
    ..aOM<$26.MessageDeliveryAck>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageDeliveryAck', subBuilder: $26.MessageDeliveryAck.create)
  ...
  factory ServerPacket({
    ...
    Pong? pong,
    $26.MessageDeliveryAck? messageDeliveryAck,
  ...
  @$pb.TagNumber(2)
  $26.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($26.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $26.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $27.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($27.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $27.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $28.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($28.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $28.Activity ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $18.LiveLocation get liveLocationStatusChanged => $_getN(6);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $18.LiveLocation ensureLiveLocationStatusChanged() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $26.MessageDeliveryAck get messageDeliveryAck => $_getN(8);
  @$pb.TagNumber(9)
  set messageDeliveryAck($26.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(8);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $26.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(8);

  @$pb.TagNumber(10)
  $24.CallOffer get callOffer => $_getN(9);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(10)
  $24.CallOffer ensureCallOffer() => $_ensure(9);

  @$pb.TagNumber(11)
  $24.CallAnswer get callAnswer => $_getN(10);
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(11)
  $24.CallAnswer ensureCallAnswer() => $_ensure(10);
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$27.SeenByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $27.SeenByClient.create)
    ..aOM<$28.ActivityByClient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $28.ActivityByClient.create)
  ...
  factory ClientPacket({
    ...
    $27.SeenByClient? seen,
    $28.ActivityByClient? activity,
    Ping? ping,
  ...
  @$pb.TagNumber(3)
  $27.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($27.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $27.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $28.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($28.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $28.ActivityByClient ensureActivity() => $_ensure(3);
