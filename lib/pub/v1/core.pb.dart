...
import 'models/message.pb.dart' as $22;
import 'models/seen.pb.dart' as $23;
import 'models/activity.pb.dart' as $24;
import 'models/event.pb.dart' as $25;
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$22.Message>(2, 'message', subBuilder: $22.Message.create)
    ..aOM<$23.Seen>(3, 'seen', subBuilder: $23.Seen.create)
    ..aOM<$24.Activity>(4, 'activity', subBuilder: $24.Activity.create)
    ..aOM<$25.LiveLocationStatusChanged>(7, 'liveLocationStatusChanged', subBuilder: $25.LiveLocationStatusChanged.create)
    ..aOM<Pong>(8, 'pong', subBuilder: Pong.create)
    ..aOM<$22.MessageDeliveryAck>(9, 'messageDeliveryAck', subBuilder: $22.MessageDeliveryAck.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $22.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($22.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $22.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $23.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($23.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $23.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $24.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($24.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $24.Activity ensureActivity() => $_ensure(3);

  @$pb.TagNumber(7)
  $25.LiveLocationStatusChanged get liveLocationStatusChanged => $_getN(4);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($25.LiveLocationStatusChanged v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(4);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $25.LiveLocationStatusChanged ensureLiveLocationStatusChanged() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $22.MessageDeliveryAck get messageDeliveryAck => $_getN(6);
  @$pb.TagNumber(9)
  set messageDeliveryAck($22.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(6);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $22.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(6);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..aOS(1, 'id')
    ..aOM<$22.MessageByClient>(2, 'message', subBuilder: $22.MessageByClient.create)
    ..aOM<$23.SeenByClient>(3, 'seen', subBuilder: $23.SeenByClient.create)
    ..aOM<$24.ActivityByClient>(4, 'activity', subBuilder: $24.ActivityByClient.create)
  ...
  @$pb.TagNumber(2)
  $22.MessageByClient get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($22.MessageByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $22.MessageByClient ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $23.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($23.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $23.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $24.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($24.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $24.ActivityByClient ensureActivity() => $_ensure(3);
