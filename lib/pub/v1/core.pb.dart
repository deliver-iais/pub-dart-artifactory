...
import 'models/activity.pb.dart' as $31;
import 'models/location.pb.dart' as $20;
import 'models/call.pb.dart' as $26;

import 'core.pbenum.dart';
import 'models/room_metadata.pbenum.dart' as $32;
...
class Ping extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Ping', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shouldTriggerActiveUser')
    ..hasRequiredFields = false
  ;
  ...
  factory Ping({
    ...
    $core.bool? shouldTriggerActiveUser,
  }) {
    ...
    if (shouldTriggerActiveUser != null) {
      _result.shouldTriggerActiveUser = shouldTriggerActiveUser;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(3)
  $core.bool get shouldTriggerActiveUser => $_getBF(2);
  @$pb.TagNumber(3)
  set shouldTriggerActiveUser($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasShouldTriggerActiveUser() => $_has(2);
  @$pb.TagNumber(3)
  void clearShouldTriggerActiveUser() => clearField(3);
}
...
class RoomPresenceTypeChanged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomPresenceTypeChanged', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..e<$32.PresenceType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'presenceType', $pb.PbFieldType.OE, defaultOrMaker: $32.PresenceType.ACTIVE, valueOf: $32.PresenceType.valueOf, enumValues: $32.PresenceType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $32.PresenceType get presenceType => $_getN(1);
  @$pb.TagNumber(2)
  set presenceType($32.PresenceType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$29.Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $29.Message.create)
    ..aOM<$30.Seen>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $30.Seen.create)
    ..aOM<$31.Activity>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $31.Activity.create)
    ...
    ..aOM<$20.LiveLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'liveLocationStatusChanged', subBuilder: $20.LiveLocation.create)
    ..aOM<Pong>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pong', subBuilder: Pong.create)
    ..aOM<$29.MessageDeliveryAck>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageDeliveryAck', subBuilder: $29.MessageDeliveryAck.create)
    ..aOM<$26.CallOffer>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $26.CallOffer.create)
    ..aOM<$26.CallAnswer>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $26.CallAnswer.create)
  ...
  factory ServerPacket({
    ...
    $20.LiveLocation? liveLocationStatusChanged,
    Pong? pong,
    $29.MessageDeliveryAck? messageDeliveryAck,
    $26.CallOffer? callOffer,
    $26.CallAnswer? callAnswer,
  ...
  @$pb.TagNumber(2)
  $29.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($29.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $29.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $30.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($30.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $30.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $31.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($31.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $31.Activity ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $20.LiveLocation get liveLocationStatusChanged => $_getN(6);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($20.LiveLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(6);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $20.LiveLocation ensureLiveLocationStatusChanged() => $_ensure(6);
  ...
  @$pb.TagNumber(9)
  $29.MessageDeliveryAck get messageDeliveryAck => $_getN(8);
  @$pb.TagNumber(9)
  set messageDeliveryAck($29.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(8);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $29.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(8);

  @$pb.TagNumber(10)
  $26.CallOffer get callOffer => $_getN(9);
  @$pb.TagNumber(10)
  set callOffer($26.CallOffer v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasCallOffer() => $_has(9);
  @$pb.TagNumber(10)
  void clearCallOffer() => clearField(10);
  @$pb.TagNumber(10)
  $26.CallOffer ensureCallOffer() => $_ensure(9);

  @$pb.TagNumber(11)
  $26.CallAnswer get callAnswer => $_getN(10);
  @$pb.TagNumber(11)
  set callAnswer($26.CallAnswer v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCallAnswer() => $_has(10);
  @$pb.TagNumber(11)
  void clearCallAnswer() => clearField(11);
  @$pb.TagNumber(11)
  $26.CallAnswer ensureCallAnswer() => $_ensure(10);
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$30.SeenByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seen', subBuilder: $30.SeenByClient.create)
    ..aOM<$31.ActivityByClient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $31.ActivityByClient.create)
    ..aOM<Ping>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ping', subBuilder: Ping.create)
    ..aOM<$26.CallOfferByClient>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callOffer', subBuilder: $26.CallOfferByClient.create)
    ..aOM<$26.CallAnswerByClient>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callAnswer', subBuilder: $26.CallAnswerByClient.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ClientPacket({
    ...
    $30.SeenByClient? seen,
    $31.ActivityByClient? activity,
    Ping? ping,
    $26.CallOfferByClient? callOffer,
    $26.CallAnswerByClient? callAnswer,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
  ...
  @$pb.TagNumber(3)
  $30.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($30.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $30.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $31.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($31.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $31.ActivityByClient ensureActivity() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $26.CallOfferByClient get callOffer => $_getN(5);
  @$pb.TagNumber(6)
  set callOffer($26.CallOfferByClient v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasCallOffer() => $_has(5);
  @$pb.TagNumber(6)
  void clearCallOffer() => clearField(6);
  @$pb.TagNumber(6)
  $26.CallOfferByClient ensureCallOffer() => $_ensure(5);

  @$pb.TagNumber(7)
  $26.CallAnswerByClient get callAnswer => $_getN(6);
  @$pb.TagNumber(7)
  set callAnswer($26.CallAnswerByClient v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasCallAnswer() => $_has(6);
  @$pb.TagNumber(7)
  void clearCallAnswer() => clearField(7);
  @$pb.TagNumber(7)
  $26.CallAnswerByClient ensureCallAnswer() => $_ensure(6);
}
