...
class Pong extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pong', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$30.MessageDeliveryAck>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastMessageDeliveryAck', subBuilder: $30.MessageDeliveryAck.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $30.MessageDeliveryAck get lastMessageDeliveryAck => $_getN(3);
  @$pb.TagNumber(4)
  set lastMessageDeliveryAck($30.MessageDeliveryAck v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLastMessageDeliveryAck() => $_has(3);
  @$pb.TagNumber(4)
  void clearLastMessageDeliveryAck() => clearField(4);
  @$pb.TagNumber(4)
  $30.MessageDeliveryAck ensureLastMessageDeliveryAck() => $_ensure(3);
}
