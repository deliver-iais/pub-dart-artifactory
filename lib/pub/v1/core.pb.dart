...
class EstablishServerSideStreamReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('EstablishServerSideStreamReq', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
  ...
  EstablishServerSideStreamReq copyWith(void Function(EstablishServerSideStreamReq) updates) => super.copyWith((message) => updates(message as EstablishServerSideStreamReq));
...
class SendClientPacketRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SendClientPacketRes', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  SendClientPacketRes copyWith(void Function(SendClientPacketRes) updates) => super.copyWith((message) => updates(message as SendClientPacketRes));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$23.Message>(2, 'message', subBuilder: $23.Message.create)
    ..aOM<$24.Seen>(3, 'seen', subBuilder: $24.Seen.create)
    ..aOM<$25.Activity>(4, 'activity', subBuilder: $25.Activity.create)
    ..aOM<$17.LiveLocation>(7, 'liveLocationStatusChanged', subBuilder: $17.LiveLocation.create)
    ..aOM<Pong>(8, 'pong', subBuilder: Pong.create)
    ..aOM<$23.MessageDeliveryAck>(9, 'messageDeliveryAck', subBuilder: $23.MessageDeliveryAck.create)
    ..hasRequiredFields = false
  ;
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..aOS(1, 'id')
    ..aOM<$23.MessageByClient>(2, 'message', subBuilder: $23.MessageByClient.create)
    ..aOM<$24.SeenByClient>(3, 'seen', subBuilder: $24.SeenByClient.create)
    ..aOM<$25.ActivityByClient>(4, 'activity', subBuilder: $25.ActivityByClient.create)
