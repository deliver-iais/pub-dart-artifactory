...
import 'models/message.pb.dart' as $16;
import 'models/event.pb.dart' as $17;
...
class ServerPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ServerPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ...
    ..aOM<$16.Message>(2, 'message', subBuilder: $16.Message.create)
    ..aOM<$17.Seen>(3, 'seen', subBuilder: $17.Seen.create)
    ..aOM<$17.Activity>(4, 'activity', subBuilder: $17.Activity.create)
    ..aOM<$17.PollStatusChanged>(6, 'pollStatusChanged', subBuilder: $17.PollStatusChanged.create)
    ..aOM<$17.LiveLocationStatusChanged>(7, 'liveLocationStatusChanged', subBuilder: $17.LiveLocationStatusChanged.create)
    ..aOM<Pong>(8, 'pong', subBuilder: Pong.create)
    ..aOM<$16.MessageDeliveryAck>(9, 'messageDeliveryAck', subBuilder: $16.MessageDeliveryAck.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $16.Message get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($16.Message v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $16.Message ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $17.Seen get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($17.Seen v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $17.Seen ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $17.Activity get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($17.Activity v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $17.Activity ensureActivity() => $_ensure(3);

  @$pb.TagNumber(6)
  $17.PollStatusChanged get pollStatusChanged => $_getN(4);
  @$pb.TagNumber(6)
  set pollStatusChanged($17.PollStatusChanged v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPollStatusChanged() => $_has(4);
  @$pb.TagNumber(6)
  void clearPollStatusChanged() => clearField(6);
  @$pb.TagNumber(6)
  $17.PollStatusChanged ensurePollStatusChanged() => $_ensure(4);

  @$pb.TagNumber(7)
  $17.LiveLocationStatusChanged get liveLocationStatusChanged => $_getN(5);
  @$pb.TagNumber(7)
  set liveLocationStatusChanged($17.LiveLocationStatusChanged v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLiveLocationStatusChanged() => $_has(5);
  @$pb.TagNumber(7)
  void clearLiveLocationStatusChanged() => clearField(7);
  @$pb.TagNumber(7)
  $17.LiveLocationStatusChanged ensureLiveLocationStatusChanged() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $16.MessageDeliveryAck get messageDeliveryAck => $_getN(7);
  @$pb.TagNumber(9)
  set messageDeliveryAck($16.MessageDeliveryAck v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMessageDeliveryAck() => $_has(7);
  @$pb.TagNumber(9)
  void clearMessageDeliveryAck() => clearField(9);
  @$pb.TagNumber(9)
  $16.MessageDeliveryAck ensureMessageDeliveryAck() => $_ensure(7);
}
...
class ClientPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ClientPacket', package: const $pb.PackageName('proto.pub.v1.core'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..aOS(1, 'id')
    ..aOM<$16.MessageByClient>(2, 'message', subBuilder: $16.MessageByClient.create)
    ..aOM<$17.SeenByClient>(3, 'seen', subBuilder: $17.SeenByClient.create)
    ..aOM<$17.ActivityByClient>(4, 'activity', subBuilder: $17.ActivityByClient.create)
  ...
  @$pb.TagNumber(2)
  $16.MessageByClient get message => $_getN(1);
  @$pb.TagNumber(2)
  set message($16.MessageByClient v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessage() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessage() => clearField(2);
  @$pb.TagNumber(2)
  $16.MessageByClient ensureMessage() => $_ensure(1);

  @$pb.TagNumber(3)
  $17.SeenByClient get seen => $_getN(2);
  @$pb.TagNumber(3)
  set seen($17.SeenByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSeen() => $_has(2);
  @$pb.TagNumber(3)
  void clearSeen() => clearField(3);
  @$pb.TagNumber(3)
  $17.SeenByClient ensureSeen() => $_ensure(2);

  @$pb.TagNumber(4)
  $17.ActivityByClient get activity => $_getN(3);
  @$pb.TagNumber(4)
  set activity($17.ActivityByClient v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasActivity() => $_has(3);
  @$pb.TagNumber(4)
  void clearActivity() => clearField(4);
  @$pb.TagNumber(4)
  $17.ActivityByClient ensureActivity() => $_ensure(3);
