...
const GetShowCaseReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'last_time_modified', '3': 4, '4': 1, '5': 3, '10': 'lastTimeModified'},
  ],
};

/// Descriptor for `GetShowCaseReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getShowCaseReqDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use getShowCaseResDescriptor instead')
const GetShowCaseRes$json = const {
  '1': 'GetShowCaseRes',
  '2': const [
    const {'1': 'showcase', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.Showcase', '10': 'showcase'},
    const {'1': 'finished', '3': 2, '4': 1, '5': 8, '10': 'finished'},
    const {'1': 'last_time_modified', '3': 3, '4': 1, '5': 3, '10': 'lastTimeModified'},
  ],
};

/// Descriptor for `GetShowCaseRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getShowCaseResDescriptor = $convert.base64Decode('Cg5HZXRTaG93Q2FzZVJlcxI5CghzaG93Y2FzZRgBIAMoCzIdLnByb3RvLnB1Yi52MS5tb2RlbHMuU2hvd2Nhc2VSCHNob3djYXNlEhoKCGZpbmlzaGVkGAIgASgIUghmaW5pc2hlZBIsChJsYXN0X3RpbWVfbW9kaWZpZWQYAyABKANSEGxhc3RUaW1lTW9kaWZpZWQ=');
@$core.Deprecated('Use getAnnouncementReqDescriptor instead')
const GetAnnouncementReq$json = const {
  '1': 'GetAnnouncementReq',
  '2': const [
    const {'1': 'user_preference', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.service_discovery.UserPreference', '10': 'userPreference'},
    const {'1': 'last_time_modified', '3': 2, '4': 1, '5': 3, '10': 'lastTimeModified'},
  ],
};

/// Descriptor for `GetAnnouncementReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAnnouncementReqDescriptor = $convert.base64Decode('ChJHZXRBbm5vdW5jZW1lbnRSZXESVwoPdXNlcl9wcmVmZXJlbmNlGAEgASgLMi4ucHJvdG8ucHViLnYxLnNlcnZpY2VfZGlzY292ZXJ5LlVzZXJQcmVmZXJlbmNlUg51c2VyUHJlZmVyZW5jZRIsChJsYXN0X3RpbWVfbW9kaWZpZWQYAiABKANSEGxhc3RUaW1lTW9kaWZpZWQ=');
...
final $typed_data.Uint8List getAnnouncementResDescriptor = $convert.base64Decode('ChJHZXRBbm5vdW5jZW1lbnRSZXMSRQoMYW5ub3VuY2VtZW50GAEgAygLMiEucHJvdG8ucHViLnYxLm1vZGVscy5Bbm5vdW5jZW1lbnRSDGFubm91bmNlbWVudBIsChJsYXN0X3RpbWVfbW9kaWZpZWQYAiABKANSEGxhc3RUaW1lTW9kaWZpZWQ=');
