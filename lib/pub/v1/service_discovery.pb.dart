...
class GetServiceInfoReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetServiceInfoReq', package: const $pb.PackageName('proto.pub.v1.service_discovery'), createEmptyInstance: create)
    ...
    ..aOM<$17.Location>(4, 'location', subBuilder: $17.Location.create)
    ..aOM<$25.PhoneNumber>(5, 'phoneNumber', subBuilder: $25.PhoneNumber.create)
    ..aOS(6, 'region')
  ...
  @$pb.TagNumber(5)
  set phoneNumber($25.PhoneNumber v) { setField(5, v); }
  @$pb.TagNumber(5)
