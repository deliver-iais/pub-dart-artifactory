...
class RoomMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastCurrentUserSentMessagePacketId')
  ...
  factory RoomMetadata({
    ...
    $fixnum.Int64? lastCurrentUserSentMessagePacketId,
  }) {
    ...
    if (lastCurrentUserSentMessagePacketId != null) {
      _result.lastCurrentUserSentMessagePacketId = lastCurrentUserSentMessagePacketId;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(8)
  $fixnum.Int64 get lastCurrentUserSentMessagePacketId => $_getI64(7);
  @$pb.TagNumber(8)
  set lastCurrentUserSentMessagePacketId($fixnum.Int64 v) { $_setInt64(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasLastCurrentUserSentMessagePacketId() => $_has(7);
  @$pb.TagNumber(8)
  void clearLastCurrentUserSentMessagePacketId() => clearField(8);
}
