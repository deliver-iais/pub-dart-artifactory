...
class RoomMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RoomMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$34.MuteSettings>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'muteSettings', subBuilder: $34.MuteSettings.create)
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastLocalId')
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    $34.MuteSettings? muteSettings,
    $fixnum.Int64? lastLocalId,
  }) {
    ...
    if (muteSettings != null) {
      _result.muteSettings = muteSettings;
    }
    if (lastLocalId != null) {
      _result.lastLocalId = lastLocalId;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(9)
  $34.MuteSettings get muteSettings => $_getN(8);
  @$pb.TagNumber(9)
  set muteSettings($34.MuteSettings v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasMuteSettings() => $_has(8);
  @$pb.TagNumber(9)
  void clearMuteSettings() => clearField(9);
  @$pb.TagNumber(9)
  $34.MuteSettings ensureMuteSettings() => $_ensure(8);

  @$pb.TagNumber(10)
  $fixnum.Int64 get lastLocalId => $_getI64(9);
  @$pb.TagNumber(10)
  set lastLocalId($fixnum.Int64 v) { $_setInt64(9, v); }
  @$pb.TagNumber(10)
  $core.bool hasLastLocalId() => $_has(9);
  @$pb.TagNumber(10)
  void clearLastLocalId() => clearField(10);
}
...
class ActivatedInRoom extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ActivatedInRoom', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$20.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'by', subBuilder: $20.Uid.create)
  ...
  @$pb.TagNumber(1)
  $20.Uid get by => $_getN(0);
  @$pb.TagNumber(1)
  set by($20.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBy() => $_has(0);
  @$pb.TagNumber(1)
  void clearBy() => clearField(1);
  @$pb.TagNumber(1)
  $20.Uid ensureBy() => $_ensure(0);
