...
final $typed_data.Uint8List paymentDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List requiredPaymentIdentityInfoDescriptor = $convert.base64Decode('ChtSZXF1aXJlZFBheW1lbnRJZGVudGl0eUluZm8SLgoTaXNfYWRkcmVzc19yZXF1aXJlZBgBIAEoCFIRaXNBZGRyZXNzUmVxdWlyZWQSMQoVaXNfcG9zdF9jb2RlX3JlcXVpcmVkGAIgASgIUhJpc1Bvc3RDb2RlUmVxdWlyZWQ=');
@$core.Deprecated('Use paymentInformationDescriptor instead')
const PaymentInformation$json = const {
  '1': 'PaymentInformation',
  '2': const [
    const {'1': 'guid', '3': 1, '4': 1, '5': 9, '10': 'guid'},
    const {'1': 'payment', '3': 2, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Payment', '10': 'payment'},
    const {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.proto.pub.v1.models.PaymentStatus', '10': 'status'},
    const {'1': 'transaction', '3': 4, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Transaction', '10': 'transaction'},
    const {'1': 'payment_identity_info', '3': 5, '4': 1, '5': 11, '6': '.proto.pub.v1.models.PaymentIdentityInfo', '10': 'paymentIdentityInfo'},
  ],
};

/// Descriptor for `PaymentInformation`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List paymentInformationDescriptor = $convert.base64Decode('');
