...
@$core.Deprecated('Use paymentProviderTypeDescriptor instead')
const PaymentProviderType$json = const {
...
/// Descriptor for `PaymentProviderType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List paymentProviderTypeDescriptor = $convert.base64Decode('ChNQYXltZW50UHJvdmlkZXJUeXBlEgsKB01PTkVBU1kQAA==');
...
const Payment$json = const {
  ...
  '2': const [
    ...
    const {'1': 'payment_provider', '3': 8, '4': 3, '5': 11, '6': '.proto.pub.v1.models.PaymentProvider', '10': 'paymentProvider'},
...
final $typed_data.Uint8List paymentDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use paymentProviderDescriptor instead')
const PaymentProvider$json = const {
  '1': 'PaymentProvider',
  '2': const [
    const {'1': 'payment_provider_type', '3': 1, '4': 1, '5': 14, '6': '.proto.pub.v1.models.PaymentProviderType', '10': 'paymentProviderType'},
    const {'1': 'required_payment_identity_info', '3': 2, '4': 1, '5': 11, '6': '.proto.pub.v1.models.RequiredPaymentIdentityInfo', '10': 'requiredPaymentIdentityInfo'},
  ],
};

/// Descriptor for `PaymentProvider`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List paymentProviderDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List withdrawDescriptor = $convert.base64Decode('');
