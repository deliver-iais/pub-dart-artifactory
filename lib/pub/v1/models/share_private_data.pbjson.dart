...
const SharePrivateDataFileTypeFilter$json = const {
  ...
  '2': const [
    const {'1': 'meme_type_filter', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.MemeType', '10': 'memeTypeFilter'},
  ],
};

/// Descriptor for `SharePrivateDataFileTypeFilter`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sharePrivateDataFileTypeFilterDescriptor = $convert.base64Decode('Ch5TaGFyZVByaXZhdGVEYXRhRmlsZVR5cGVGaWx0ZXISRwoQbWVtZV90eXBlX2ZpbHRlchgBIAMoCzIdLnByb3RvLnB1Yi52MS5tb2RlbHMuTWVtZVR5cGVSDm1lbWVUeXBlRmlsdGVy');
