...
const CallEventEnd$json = const {
  ...
  '2': const [
    ...
    const {'1': 'is_caller', '3': 2, '4': 1, '5': 8, '10': 'isCaller'},
  ],
};

/// Descriptor for `CallEventEnd`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callEventEndDescriptor = $convert.base64Decode('CgxDYWxsRXZlbnRFbmQSIwoNY2FsbF9kdXJhdGlvbhgBIAEoA1IMY2FsbER1cmF0aW9uEhsKCWlzX2NhbGxlchgCIAEoCFIIaXNDYWxsZXI=');
@$core.Deprecated('Use callEventDeclineDescriptor instead')
const CallEventDecline$json = const {
  '1': 'CallEventDecline',
  '2': const [
    const {'1': 'is_caller', '3': 1, '4': 1, '5': 8, '10': 'isCaller'},
  ],
};

/// Descriptor for `CallEventDecline`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callEventDeclineDescriptor = $convert.base64Decode('ChBDYWxsRXZlbnREZWNsaW5lEhsKCWlzX2NhbGxlchgBIAEoCFIIaXNDYWxsZXI=');
...
final $typed_data.Uint8List callEventBusyDescriptor = $convert.base64Decode('Cg1DYWxsRXZlbnRCdXN5EhsKCWlzX2NhbGxlchgBIAEoCFIIaXNDYWxsZXI=');
