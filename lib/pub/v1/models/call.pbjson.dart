...
final $typed_data.Uint8List callStatusDescriptor = $convert.base64Decode('CgpDYWxsU3RhdHVzEgsKB0NSRUFURUQQABIOCgpJU19SSU5HSU5HEAESDAoIREVDTElORUQQAhIICgRCVVNZEAMSCQoFRU5ERUQQBA==');
@$core.Deprecated('Use callEventDescriptor instead')
const CallEvent$json = const {
  '1': 'CallEvent',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'new_status', '3': 2, '4': 1, '5': 14, '6': '.proto.pub.v1.models.CallStatus', '10': 'newStatus'},
  ],
};

/// Descriptor for `CallEvent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callEventDescriptor = $convert.base64Decode('CglDYWxsRXZlbnQSDgoCaWQYASABKAlSAmlkEj4KCm5ld19zdGF0dXMYAiABKA4yHy5wcm90by5wdWIudjEubW9kZWxzLkNhbGxTdGF0dXNSCW5ld1N0YXR1cw==');
