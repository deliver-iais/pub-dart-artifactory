...
const CallEventOffer$json = const {
  ...
  '2': const [
    ...
    const {'1': 'isStartingWithVideo', '3': 3, '4': 1, '5': 8, '10': 'isStartingWithVideo'},
  ],
};

/// Descriptor for `CallEventOffer`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callEventOfferDescriptor = $convert.base64Decode('Cg5DYWxsRXZlbnRPZmZlchISCgRib2R5GAEgASgJUgRib2R5Eh4KCmNhbmRpZGF0ZXMYAiABKAlSCmNhbmRpZGF0ZXMSMAoTaXNTdGFydGluZ1dpdGhWaWRlbxgDIAEoCFITaXNTdGFydGluZ1dpdGhWaWRlbw==');
...
final $typed_data.Uint8List callEventRingingDescriptor = $convert.base64Decode('ChBDYWxsRXZlbnRSaW5naW5n');
...
final $typed_data.Uint8List callEventV2ByClientDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List callEventV2Descriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List callLogDescriptor = $convert.base64Decode('');
