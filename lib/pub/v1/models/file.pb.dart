...
class File extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('File', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(9, 'smallThumbnail', $pb.PbFieldType.OY)
  ...
  @$pb.TagNumber(9)
  $core.List<$core.int> get smallThumbnail => $_getN(8);
  @$pb.TagNumber(9)
  set smallThumbnail($core.List<$core.int> v) { $_setBytes(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasSmallThumbnail() => $_has(8);
  @$pb.TagNumber(9)
  void clearSmallThumbnail() => clearField(9);
}
