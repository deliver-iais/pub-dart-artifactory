...
const MessageMarkup$json = const {
  ...
  '2': const [
    ...
    const {'1': 'remove_reply_keyboard_markup', '3': 3, '4': 1, '5': 8, '10': 'removeReplyKeyboardMarkup'},
  ],
};

/// Descriptor for `MessageMarkup`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List messageMarkupDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List inlineKeyboardButtonCallbackDescriptor = $convert.base64Decode('ChxJbmxpbmVLZXlib2FyZEJ1dHRvbkNhbGxiYWNrEhIKBGRhdGEYASABKAlSBGRhdGE=');
...
final $typed_data.Uint8List replyKeyboardMarkupDescriptor = $convert.base64Decode('');
