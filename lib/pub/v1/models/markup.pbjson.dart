...
const InlineKeyboardButtonCallback$json = const {
  ...
  '2': const [
    ...
    const {'1': 'is_pin_code_needed', '3': 2, '4': 1, '5': 8, '10': 'isPinCodeNeeded'},
    const {'1': 'pin_code_length', '3': 3, '4': 1, '5': 5, '10': 'pinCodeLength'},
  ],
};

/// Descriptor for `InlineKeyboardButtonCallback`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List inlineKeyboardButtonCallbackDescriptor = $convert.base64Decode('ChxJbmxpbmVLZXlib2FyZEJ1dHRvbkNhbGxiYWNrEhIKBGRhdGEYASABKAlSBGRhdGESKwoSaXNfcGluX2NvZGVfbmVlZGVkGAIgASgIUg9pc1BpbkNvZGVOZWVkZWQSJgoPcGluX2NvZGVfbGVuZ3RoGAMgASgFUg1waW5Db2RlTGVuZ3Ro');
