...
class Payment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Payment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$18.Uid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuer', subBuilder: $18.Uid.create)
    ..aOM<$18.Uid>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payer', subBuilder: $18.Uid.create)
    ...
    ..pc<PaymentProvider>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentProvider', $pb.PbFieldType.PM, subBuilder: PaymentProvider.create)
  ...
  factory Payment({
    ...
    $core.Iterable<PaymentProvider>? paymentProvider,
    ...
    if (paymentProvider != null) {
      _result.paymentProvider.addAll(paymentProvider);
    }
    if (createAt != null) {
  ...
  @$pb.TagNumber(3)
  $18.Uid get issuer => $_getN(2);
  @$pb.TagNumber(3)
  set issuer($18.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasIssuer() => $_has(2);
  @$pb.TagNumber(3)
  void clearIssuer() => clearField(3);
  @$pb.TagNumber(3)
  $18.Uid ensureIssuer() => $_ensure(2);

  @$pb.TagNumber(4)
  $18.Uid get payer => $_getN(3);
  @$pb.TagNumber(4)
  set payer($18.Uid v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasPayer() => $_has(3);
  @$pb.TagNumber(4)
  void clearPayer() => clearField(4);
  @$pb.TagNumber(4)
  $18.Uid ensurePayer() => $_ensure(3);
  ...
  @$pb.TagNumber(8)
  $core.List<PaymentProvider> get paymentProvider => $_getList(7);
...
class PaymentProvider extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentProvider', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..e<PaymentProviderType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentProviderType', $pb.PbFieldType.OE, defaultOrMaker: PaymentProviderType.MONEASY, valueOf: PaymentProviderType.valueOf, enumValues: PaymentProviderType.values)
    ..aOM<RequiredPaymentIdentityInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requiredPaymentIdentityInfo', subBuilder: RequiredPaymentIdentityInfo.create)
    ..hasRequiredFields = false
  ;

  PaymentProvider._() : super();
  factory PaymentProvider({
    ...
    if (paymentProviderType != null) {
      _result.paymentProviderType = paymentProviderType;
    }
  ...
  factory PaymentProvider.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PaymentProvider.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PaymentProvider clone() => PaymentProvider()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PaymentProvider copyWith(void Function(PaymentProvider) updates) => super.copyWith((message) => updates(message as PaymentProvider)) as PaymentProvider; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PaymentProvider create() => PaymentProvider._();
  PaymentProvider createEmptyInstance() => create();
  static $pb.PbList<PaymentProvider> createRepeated() => $pb.PbList<PaymentProvider>();
  @$core.pragma('dart2js:noInline')
  static PaymentProvider getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PaymentProvider>(create);
  static PaymentProvider? _defaultInstance;

  @$pb.TagNumber(1)
  PaymentProviderType get paymentProviderType => $_getN(0);
  @$pb.TagNumber(1)
  set paymentProviderType(PaymentProviderType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasPaymentProviderType() => $_has(0);
  @$pb.TagNumber(1)
  void clearPaymentProviderType() => clearField(1);

  @$pb.TagNumber(2)
  RequiredPaymentIdentityInfo get requiredPaymentIdentityInfo => $_getN(1);
  @$pb.TagNumber(2)
  set requiredPaymentIdentityInfo(RequiredPaymentIdentityInfo v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasRequiredPaymentIdentityInfo() => $_has(1);
  @$pb.TagNumber(2)
  void clearRequiredPaymentIdentityInfo() => clearField(2);
  @$pb.TagNumber(2)
  RequiredPaymentIdentityInfo ensureRequiredPaymentIdentityInfo() => $_ensure(1);
}
...
class Transaction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Transaction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$18.Uid>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source', subBuilder: $18.Uid.create)
    ..aOM<$18.Uid>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destination', subBuilder: $18.Uid.create)
  ...
  @$pb.TagNumber(6)
  $18.Uid get source => $_getN(5);
  @$pb.TagNumber(6)
  set source($18.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasSource() => $_has(5);
  @$pb.TagNumber(6)
  void clearSource() => clearField(6);
  @$pb.TagNumber(6)
  $18.Uid ensureSource() => $_ensure(5);

  @$pb.TagNumber(7)
  $18.Uid get destination => $_getN(6);
  @$pb.TagNumber(7)
  set destination($18.Uid v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasDestination() => $_has(6);
  @$pb.TagNumber(7)
  void clearDestination() => clearField(7);
  @$pb.TagNumber(7)
  $18.Uid ensureDestination() => $_ensure(6);
...
class Withdraw extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Withdraw', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amountWithoutTariff')
  ...
  factory Withdraw({
    ...
    $fixnum.Int64? amountWithoutTariff,
  ...
  @$pb.TagNumber(8)
  $fixnum.Int64 get amountWithoutTariff => $_getI64(7);
  @$pb.TagNumber(8)
  set amountWithoutTariff($fixnum.Int64 v) { $_setInt64(7, v); }
  @$pb.TagNumber(8)
