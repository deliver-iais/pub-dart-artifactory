...
class PaymentInformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentInformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..e<PaymentStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: PaymentStatus.PAYMENT_INITIALIZED, valueOf: PaymentStatus.valueOf, enumValues: PaymentStatus.values)
    ..aOM<Transaction>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transaction', subBuilder: Transaction.create)
    ..aOM<PaymentIdentityInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentIdentityInfo', subBuilder: PaymentIdentityInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set status(PaymentStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  Transaction get transaction => $_getN(3);
  @$pb.TagNumber(4)
  set transaction(Transaction v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasTransaction() => $_has(3);
  @$pb.TagNumber(4)
  void clearTransaction() => clearField(4);
  @$pb.TagNumber(4)
  Transaction ensureTransaction() => $_ensure(3);

  @$pb.TagNumber(5)
  PaymentIdentityInfo get paymentIdentityInfo => $_getN(4);
  @$pb.TagNumber(5)
  set paymentIdentityInfo(PaymentIdentityInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasPaymentIdentityInfo() => $_has(4);
  @$pb.TagNumber(5)
  void clearPaymentIdentityInfo() => clearField(5);
  @$pb.TagNumber(5)
  PaymentIdentityInfo ensurePaymentIdentityInfo() => $_ensure(4);
}
