...
const MessageManipulationPersistentEvent_Action$json = const {
  ...
  '2': const [
    const {'1': 'EDITED', '2': 0},
    const {'1': 'DELETED', '2': 1},
    const {'1': 'OTHER_DELETED', '2': 2},
  ],
};

/// Descriptor for `MessageManipulationPersistentEvent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List messageManipulationPersistentEventDescriptor = $convert.base64Decode('');
