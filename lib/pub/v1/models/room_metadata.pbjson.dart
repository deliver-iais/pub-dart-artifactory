...
const RoomMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mute_settings', '3': 9, '4': 1, '5': 11, '6': '.proto.pub.v1.models.MuteSettings', '10': 'muteSettings'},
    const {'1': 'last_local_id', '3': 10, '4': 1, '5': 3, '10': 'lastLocalId'},
  ],
};

/// Descriptor for `RoomMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List roomMetadataDescriptor = $convert.base64Decode('');
