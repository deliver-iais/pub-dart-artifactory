...
const RoomMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'last_current_user_sent_message_packet_id', '3': 8, '4': 1, '5': 3, '10': 'lastCurrentUserSentMessagePacketId'},
...
final $typed_data.Uint8List roomMetadataDescriptor = $convert.base64Decode('');
