...
class Seen extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Seen', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'from', subBuilder: $11.Uid.create)
    ..aOM<$11.Uid>(2, 'to', subBuilder: $11.Uid.create)
    ..aInt64(3, 'id')
  ...
  @$pb.TagNumber(1)
  $11.Uid get from => $_getN(0);
  @$pb.TagNumber(1)
  set from($11.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFrom() => $_has(0);
  @$pb.TagNumber(1)
  void clearFrom() => clearField(1);
  @$pb.TagNumber(1)
  $11.Uid ensureFrom() => $_ensure(0);

  @$pb.TagNumber(2)
  $11.Uid get to => $_getN(1);
  @$pb.TagNumber(2)
  set to($11.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
