...
class Seen extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Seen', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$10.Uid>(1, 'from', subBuilder: $10.Uid.create)
    ..aOM<$10.Uid>(2, 'to', subBuilder: $10.Uid.create)
    ..aInt64(3, 'id')
  ...
  @$pb.TagNumber(1)
  $10.Uid get from => $_getN(0);
  @$pb.TagNumber(1)
  set from($10.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasFrom() => $_has(0);
  @$pb.TagNumber(1)
  void clearFrom() => clearField(1);
  @$pb.TagNumber(1)
  $10.Uid ensureFrom() => $_ensure(0);

  @$pb.TagNumber(2)
  $10.Uid get to => $_getN(1);
  @$pb.TagNumber(2)
  set to($10.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
