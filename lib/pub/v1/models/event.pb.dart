...
class LiveLocationStatusChanged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LiveLocationStatusChanged', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOS(1, 'uuid')
    ..aOM<$16.LiveLocationStatus>(3, 'updatedLiveLocation', subBuilder: $16.LiveLocationStatus.create)
  ...
  @$pb.TagNumber(3)
  $16.LiveLocationStatus get updatedLiveLocation => $_getN(1);
  @$pb.TagNumber(3)
  set updatedLiveLocation($16.LiveLocationStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUpdatedLiveLocation() => $_has(1);
  @$pb.TagNumber(3)
  void clearUpdatedLiveLocation() => clearField(3);
  @$pb.TagNumber(3)
  $16.LiveLocationStatus ensureUpdatedLiveLocation() => $_ensure(1);
}
