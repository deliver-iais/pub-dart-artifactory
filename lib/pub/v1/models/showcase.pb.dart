...
class BotCallback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BotCallback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPinCodeNeeded')
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinCodeLength', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.bool get isPinCodeNeeded => $_getBF(2);
  @$pb.TagNumber(3)
  set isPinCodeNeeded($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasIsPinCodeNeeded() => $_has(2);
  @$pb.TagNumber(3)
  void clearIsPinCodeNeeded() => clearField(3);

  @$pb.TagNumber(4)
  $core.int get pinCodeLength => $_getIZ(3);
  @$pb.TagNumber(4)
  set pinCodeLength($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasPinCodeLength() => $_has(3);
  @$pb.TagNumber(4)
  void clearPinCodeLength() => clearField(4);
}
