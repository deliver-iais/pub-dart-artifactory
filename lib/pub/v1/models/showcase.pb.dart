...
import 'pin_code_settings.pb.dart' as $21;
...
class BannerCase extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BannerCase', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$17.File>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bannerImg', subBuilder: $17.File.create)
    ..aOM<$19.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uid', subBuilder: $19.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $17.File get bannerImg => $_getN(0);
  @$pb.TagNumber(1)
  set bannerImg($17.File v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBannerImg() => $_has(0);
  @$pb.TagNumber(1)
  void clearBannerImg() => clearField(1);
  @$pb.TagNumber(1)
  $17.File ensureBannerImg() => $_ensure(0);

  @$pb.TagNumber(2)
  $19.Uid get uid => $_getN(1);
  @$pb.TagNumber(2)
  set uid($19.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUid() => $_has(1);
  @$pb.TagNumber(2)
  void clearUid() => clearField(2);
  @$pb.TagNumber(2)
  $19.Uid ensureUid() => $_ensure(1);
}
...
class UrlCase extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UrlCase', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$17.File>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'img', subBuilder: $17.File.create)
  ...
  @$pb.TagNumber(3)
  $17.File get img => $_getN(2);
  @$pb.TagNumber(3)
  set img($17.File v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasImg() => $_has(2);
  @$pb.TagNumber(3)
  void clearImg() => clearField(3);
  @$pb.TagNumber(3)
  $17.File ensureImg() => $_ensure(2);
...
class BotCallback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BotCallback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$21.PinCodeSettings>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinCodeSettings', subBuilder: $21.PinCodeSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  factory BotCallback({
    $19.Uid? bot,
    $core.String? data,
    $21.PinCodeSettings? pinCodeSettings,
  }) {
    final _result = create();
    if (bot != null) {
      _result.bot = bot;
  ...
  @$pb.TagNumber(3)
  $21.PinCodeSettings get pinCodeSettings => $_getN(2);
  @$pb.TagNumber(3)
  set pinCodeSettings($21.PinCodeSettings v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPinCodeSettings() => $_has(2);
  @$pb.TagNumber(3)
  void clearPinCodeSettings() => clearField(3);
  @$pb.TagNumber(3)
  $21.PinCodeSettings ensurePinCodeSettings() => $_ensure(2);
}
