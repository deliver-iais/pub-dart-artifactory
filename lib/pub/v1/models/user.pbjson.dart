...
const UserAsContact$json = const {
  ...
  '2': const [
    ...
    const {'1': 'real_first_name', '3': 7, '4': 1, '5': 9, '10': 'realFirstName'},
    const {'1': 'real_last_name', '3': 8, '4': 1, '5': 9, '10': 'realLastName'},
  ],
};

/// Descriptor for `UserAsContact`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userAsContactDescriptor = $convert.base64Decode('');
