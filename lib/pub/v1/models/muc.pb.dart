...
class Ban extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Ban', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'banned', subBuilder: $11.Uid.create)
    ..aOM<$11.Uid>(2, 'banner', subBuilder: $11.Uid.create)
    ..aOM<$11.Uid>(3, 'bannedFrom', protoName: 'bannedFrom', subBuilder: $11.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $11.Uid get banned => $_getN(0);
  @$pb.TagNumber(1)
  set banned($11.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBanned() => $_has(0);
  @$pb.TagNumber(1)
  void clearBanned() => clearField(1);
  @$pb.TagNumber(1)
  $11.Uid ensureBanned() => $_ensure(0);

  @$pb.TagNumber(2)
  $11.Uid get banner => $_getN(1);
  @$pb.TagNumber(2)
  set banner($11.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBanner() => $_has(1);
  @$pb.TagNumber(2)
  void clearBanner() => clearField(2);
  @$pb.TagNumber(2)
  $11.Uid ensureBanner() => $_ensure(1);

  @$pb.TagNumber(3)
  $11.Uid get bannedFrom => $_getN(2);
  @$pb.TagNumber(3)
  set bannedFrom($11.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBannedFrom() => $_has(2);
  @$pb.TagNumber(3)
  void clearBannedFrom() => clearField(3);
  @$pb.TagNumber(3)
  $11.Uid ensureBannedFrom() => $_ensure(2);
}
