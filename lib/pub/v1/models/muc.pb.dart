...
class Ban extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Ban', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$18.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'banned', subBuilder: $18.Uid.create)
    ..aOM<$18.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'banner', subBuilder: $18.Uid.create)
    ..aOM<$18.Uid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bannedFrom', subBuilder: $18.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $18.Uid get banned => $_getN(0);
  @$pb.TagNumber(1)
  set banned($18.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBanned() => $_has(0);
  @$pb.TagNumber(1)
  void clearBanned() => clearField(1);
  @$pb.TagNumber(1)
  $18.Uid ensureBanned() => $_ensure(0);

  @$pb.TagNumber(2)
  $18.Uid get banner => $_getN(1);
  @$pb.TagNumber(2)
  set banner($18.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBanner() => $_has(1);
  @$pb.TagNumber(2)
  void clearBanner() => clearField(2);
  @$pb.TagNumber(2)
  $18.Uid ensureBanner() => $_ensure(1);

  @$pb.TagNumber(3)
  $18.Uid get bannedFrom => $_getN(2);
  @$pb.TagNumber(3)
  set bannedFrom($18.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBannedFrom() => $_has(2);
  @$pb.TagNumber(3)
  void clearBannedFrom() => clearField(3);
  @$pb.TagNumber(3)
  $18.Uid ensureBannedFrom() => $_ensure(2);
}
