...
@$core.Deprecated('Use accessFieldDescriptor instead')
const AccessField$json = const {
  '1': 'AccessField',
  '2': const [
...
/// Descriptor for `AccessField`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List accessFieldDescriptor = $convert.base64Decode('CgtBY2Nlc3NGaWVsZBIRCg1DSEFOR0VfQVZBVEFSEAA=');
