...
const MessageBrief_MessageTypes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'SHARE_PRIVATE_DATA_REQUEST', '2': 12},
    const {'1': 'SHARE_PRIVATE_DATA_ACCEPTANCE', '2': 13},
    const {'1': 'CALL_END', '2': 14},
    const {'1': 'CALL_BUSY', '2': 15},
    const {'1': 'CALL_DECLINED', '2': 16},
    const {'1': 'TABLE', '2': 17},
    const {'1': 'PE_AS_NEW_CONTACT_ADDED', '2': 18},
    const {'1': 'PE_BS_BOT_NOT_RESPONDING', '2': 19},
    const {'1': 'PE_MS_KICK_USER', '2': 20},
    const {'1': 'PE_MS_ADD_USER', '2': 21},
    const {'1': 'PE_MS_PIN_MESSAGE', '2': 22},
    const {'1': 'PE_MS_NAME_CHANGED', '2': 23},
    const {'1': 'PE_MS_AVATAR_CHANGED', '2': 24},
    const {'1': 'PE_MS_MUC_CREATED', '2': 25},
    const {'1': 'PE_MS_LEAVE_USER', '2': 26},
    const {'1': 'PE_MS_JOINED_USER', '2': 27},
    const {'1': 'PE_MS_DELETED', '2': 28},
    const {'1': 'PDT_PHONE_NUMBER', '2': 29},
    const {'1': 'PDT_USERNAME', '2': 30},
    const {'1': 'PDT_EMAIL', '2': 31},
    const {'1': 'PDT_NAME', '2': 32},
  ],
};

/// Descriptor for `MessageBrief`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List messageBriefDescriptor = $convert.base64Decode('');
