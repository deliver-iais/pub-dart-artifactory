...
const Announcement$json = const {
  ...
  '2': const [
    ...
    const {'1': 'forced_to_show', '3': 5, '4': 1, '5': 8, '10': 'forcedToShow'},
    const {'1': 'is_advertisement', '3': 6, '4': 1, '5': 8, '10': 'isAdvertisement'},
  ],
};

/// Descriptor for `Announcement`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List announcementDescriptor = $convert.base64Decode('');
...
const AnnouncementDetailsViewConfiguration$json = const {
  ...
  '2': const [
    ...
    const {'1': 'clickable_since', '3': 3, '4': 1, '5': 3, '10': 'clickableSince'},
    const {'1': 'clickable_until', '3': 4, '4': 1, '5': 3, '10': 'clickableUntil'},
  ],
};

/// Descriptor for `AnnouncementDetailsViewConfiguration`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List announcementDetailsViewConfigurationDescriptor = $convert.base64Decode('');
