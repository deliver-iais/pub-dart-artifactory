...
import 'categories.pbenum.dart' as $7;
...
class Uid extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Uid', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..e<$7.Categories>(1, 'category', $pb.PbFieldType.OE, defaultOrMaker: $7.Categories.User, valueOf: $7.Categories.valueOf, enumValues: $7.Categories.values)
    ..aOS(2, 'node')
  ...
  @$pb.TagNumber(1)
  $7.Categories get category => $_getN(0);
  @$pb.TagNumber(1)
  set category($7.Categories v) { setField(1, v); }
  @$pb.TagNumber(1)
