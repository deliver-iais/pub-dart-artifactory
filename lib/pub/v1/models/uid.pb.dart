...
import 'categories.pbenum.dart' as $10;
...
class Uid extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Uid', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..e<$10.Categories>(1, 'category', $pb.PbFieldType.OE, defaultOrMaker: $10.Categories.USER, valueOf: $10.Categories.valueOf, enumValues: $10.Categories.values)
    ..aOS(2, 'node')
  ...
  @$pb.TagNumber(1)
  $10.Categories get category => $_getN(0);
  @$pb.TagNumber(1)
  set category($10.Categories v) { setField(1, v); }
  @$pb.TagNumber(1)
