...
import 'categories.pbenum.dart' as $11;
...
class Uid extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Uid', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..e<$11.Categories>(1, 'category', $pb.PbFieldType.OE, defaultOrMaker: $11.Categories.USER, valueOf: $11.Categories.valueOf, enumValues: $11.Categories.values)
    ..aOS(2, 'node')
  ...
  @$pb.TagNumber(1)
  $11.Categories get category => $_getN(0);
  @$pb.TagNumber(1)
  set category($11.Categories v) { setField(1, v); }
  @$pb.TagNumber(1)
