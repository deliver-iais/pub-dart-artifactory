...
import 'categories.pbenum.dart' as $18;
...
class Uid extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Uid', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..e<$18.Categories>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: $18.Categories.USER, valueOf: $18.Categories.valueOf, enumValues: $18.Categories.values)
  ...
  @$pb.TagNumber(1)
  $18.Categories get category => $_getN(0);
  @$pb.TagNumber(1)
  set category($18.Categories v) { setField(1, v); }
  @$pb.TagNumber(1)
