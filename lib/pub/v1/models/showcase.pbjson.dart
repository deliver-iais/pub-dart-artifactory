...
const BannerCase$json = const {
  '1': 'BannerCase',
  '2': const [
    const {'1': 'img', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.File', '10': 'img'},
...
final $typed_data.Uint8List bannerCaseDescriptor = $convert.base64Decode('CgpCYW5uZXJDYXNlEisKA2ltZxgBIAEoCzIZLnByb3RvLnB1Yi52MS5tb2RlbHMuRmlsZVIDaW1nEioKA3VpZBgCIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgN1aWQSIAoLZGVzY3JpcHRpb24YAyABKAlSC2Rlc2NyaXB0aW9u');
...
const UrlCase$json = const {
  ...
  '2': const [
    ...
    const {'1': 'bot_webview', '3': 6, '4': 1, '5': 11, '6': '.proto.pub.v1.models.BotWebview', '9': 0, '10': 'botWebview'},
  ],
  '8': const [
    const {'1': 'type'},
  ],
...
final $typed_data.Uint8List urlCaseDescriptor = $convert.base64Decode('');
...
const BotCallback$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pin_code_settings', '3': 3, '4': 1, '5': 11, '6': '.proto.pub.v1.models.PinCodeSettings', '10': 'pinCodeSettings'},
  ],
};

/// Descriptor for `BotCallback`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List botCallbackDescriptor = $convert.base64Decode('CgtCb3RDYWxsYmFjaxIqCgNib3QYASABKAsyGC5wcm90by5wdWIudjEubW9kZWxzLlVpZFIDYm90EhIKBGRhdGEYAiABKAlSBGRhdGESUAoRcGluX2NvZGVfc2V0dGluZ3MYAyABKAsyJC5wcm90by5wdWIudjEubW9kZWxzLlBpbkNvZGVTZXR0aW5nc1IPcGluQ29kZVNldHRpbmdz');
@$core.Deprecated('Use botWebviewDescriptor instead')
const BotWebview$json = const {
  '1': 'BotWebview',
  '2': const [
    const {'1': 'bot', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'bot'},
  ],
...
/// Descriptor for `BotWebview`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List botWebviewDescriptor = $convert.base64Decode('CgpCb3RXZWJ2aWV3EioKA2JvdBgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgNib3Q=');
