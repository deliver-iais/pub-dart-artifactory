...
const GroupedRooms$json = const {
  '1': 'GroupedRooms',
  '2': const [
    const {'1': 'rooms_list', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.RoomCase', '10': 'roomsList'},
  ],
};

/// Descriptor for `GroupedRooms`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List groupedRoomsDescriptor = $convert.base64Decode('CgxHcm91cGVkUm9vbXMSPAoKcm9vbXNfbGlzdBgBIAMoCzIdLnByb3RvLnB1Yi52MS5tb2RlbHMuUm9vbUNhc2VSCXJvb21zTGlzdA==');
@$core.Deprecated('Use groupedBannersDescriptor instead')
const GroupedBanners$json = const {
  '1': 'GroupedBanners',
  '2': const [
    const {'1': 'banners_list', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.BannerCase', '10': 'bannersList'},
  ],
};

/// Descriptor for `GroupedBanners`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List groupedBannersDescriptor = $convert.base64Decode('Cg5Hcm91cGVkQmFubmVycxJCCgxiYW5uZXJzX2xpc3QYASADKAsyHy5wcm90by5wdWIudjEubW9kZWxzLkJhbm5lckNhc2VSC2Jhbm5lcnNMaXN0');
@$core.Deprecated('Use groupedUrlsDescriptor instead')
const GroupedUrls$json = const {
  '1': 'GroupedUrls',
  '2': const [
    const {'1': 'urls_list', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.UrlCase', '10': 'urlsList'},
  ],
};

/// Descriptor for `GroupedUrls`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List groupedUrlsDescriptor = $convert.base64Decode('CgtHcm91cGVkVXJscxI5Cgl1cmxzX2xpc3QYASADKAsyHC5wcm90by5wdWIudjEubW9kZWxzLlVybENhc2VSCHVybHNMaXN0');
...
const UrlCase$json = const {
  '1': 'UrlCase',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.File', '10': 'name'},
    const {'1': 'description', '3': 2, '4': 1, '5': 11, '6': '.proto.pub.v1.models.File', '10': 'description'},
...
final $typed_data.Uint8List urlCaseDescriptor = $convert.base64Decode('CgdVcmxDYXNlEi0KBG5hbWUYASABKAsyGS5wcm90by5wdWIudjEubW9kZWxzLkZpbGVSBG5hbWUSOwoLZGVzY3JpcHRpb24YAiABKAsyGS5wcm90by5wdWIudjEubW9kZWxzLkZpbGVSC2Rlc2NyaXB0aW9uEisKA2ltZxgDIAEoCzIZLnByb3RvLnB1Yi52MS5tb2RlbHMuRmlsZVIDaW1nEhAKA3VybBgEIAEoCVIDdXJs');
