...
class AnnouncementDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnouncementDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$16.File>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backgroundImage', subBuilder: $16.File.create)
    ..aOM<$16.File>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'animation', subBuilder: $16.File.create)
  ...
  @$pb.TagNumber(5)
  $16.File get backgroundImage => $_getN(4);
  @$pb.TagNumber(5)
  set backgroundImage($16.File v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBackgroundImage() => $_has(4);
  @$pb.TagNumber(5)
  void clearBackgroundImage() => clearField(5);
  @$pb.TagNumber(5)
  $16.File ensureBackgroundImage() => $_ensure(4);

  @$pb.TagNumber(6)
  $16.File get animation => $_getN(5);
  @$pb.TagNumber(6)
  set animation($16.File v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAnimation() => $_has(5);
  @$pb.TagNumber(6)
  void clearAnimation() => clearField(6);
  @$pb.TagNumber(6)
  $16.File ensureAnimation() => $_ensure(5);
