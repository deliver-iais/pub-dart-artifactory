...
class Announcement extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Announcement', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'forcedToShow')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isAdvertisement')
  ...
  factory Announcement({
    ...
    if (forcedToShow != null) {
      _result.forcedToShow = forcedToShow;
    }
  ...
  @$pb.TagNumber(5)
  $core.bool get forcedToShow => $_getBF(4);
  @$pb.TagNumber(5)
  set forcedToShow($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasForcedToShow() => $_has(4);
  @$pb.TagNumber(5)
  void clearForcedToShow() => clearField(5);

  @$pb.TagNumber(6)
  $core.bool get isAdvertisement => $_getBF(5);
  @$pb.TagNumber(6)
  set isAdvertisement($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasIsAdvertisement() => $_has(5);
  @$pb.TagNumber(6)
  void clearIsAdvertisement() => clearField(6);
}
...
class AnnouncementDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnouncementDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$17.File>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backgroundImage', subBuilder: $17.File.create)
    ..aOM<$17.File>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'animation', subBuilder: $17.File.create)
  ...
  @$pb.TagNumber(5)
  $17.File get backgroundImage => $_getN(4);
  @$pb.TagNumber(5)
  set backgroundImage($17.File v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasBackgroundImage() => $_has(4);
  @$pb.TagNumber(5)
  void clearBackgroundImage() => clearField(5);
  @$pb.TagNumber(5)
  $17.File ensureBackgroundImage() => $_ensure(4);

  @$pb.TagNumber(6)
  $17.File get animation => $_getN(5);
  @$pb.TagNumber(6)
  set animation($17.File v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAnimation() => $_has(5);
  @$pb.TagNumber(6)
  void clearAnimation() => clearField(6);
  @$pb.TagNumber(6)
  $17.File ensureAnimation() => $_ensure(5);
...
class AnnouncementDetailsViewConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnouncementDetailsViewConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clickableSince')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clickableUntil')
    ..hasRequiredFields = false
  ;
  ...
  factory AnnouncementDetailsViewConfiguration({
    ...
    $fixnum.Int64? clickableSince,
    $fixnum.Int64? clickableUntil,
  }) {
    final _result = create();
    ...
    if (clickableSince != null) {
      _result.clickableSince = clickableSince;
    }
    if (clickableUntil != null) {
      _result.clickableUntil = clickableUntil;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(3)
  $fixnum.Int64 get clickableSince => $_getI64(2);
  @$pb.TagNumber(3)
  set clickableSince($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasClickableSince() => $_has(2);
  @$pb.TagNumber(3)
  void clearClickableSince() => clearField(3);

  @$pb.TagNumber(4)
  $fixnum.Int64 get clickableUntil => $_getI64(3);
  @$pb.TagNumber(4)
  set clickableUntil($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasClickableUntil() => $_has(3);
  @$pb.TagNumber(4)
  void clearClickableUntil() => clearField(4);
}
