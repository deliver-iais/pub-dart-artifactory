...
class Media extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Media', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aInt64(1, 'createdOn')
    ..aOM<$12.Uid>(2, 'createdBy', subBuilder: $12.Uid.create)
    ..aInt64(3, 'messageId')
    ..aOM<$14.File>(4, 'file', subBuilder: $14.File.create)
    ..aOS(5, 'link')
    ..aOB(6, 'encrypted')
  ...
  @$pb.TagNumber(2)
  $12.Uid get createdBy => $_getN(1);
  @$pb.TagNumber(2)
  set createdBy($12.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCreatedBy() => $_has(1);
  @$pb.TagNumber(2)
  void clearCreatedBy() => clearField(2);
  @$pb.TagNumber(2)
  $12.Uid ensureCreatedBy() => $_ensure(1);
  ...
  @$pb.TagNumber(4)
  $14.File get file => $_getN(3);
  @$pb.TagNumber(4)
  set file($14.File v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasFile() => $_has(3);
  @$pb.TagNumber(4)
  void clearFile() => clearField(4);
  @$pb.TagNumber(4)
  $14.File ensureFile() => $_ensure(3);
