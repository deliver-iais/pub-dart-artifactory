...
class Contact extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Contact', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$25.PhoneNumber>(3, 'phoneNumber', protoName: 'phoneNumber', subBuilder: $25.PhoneNumber.create)
    ..aOS(4, 'firstName')
    ..aOS(5, 'lastName')
  ...
  @$pb.TagNumber(3)
  $25.PhoneNumber get phoneNumber => $_getN(2);
  @$pb.TagNumber(3)
  set phoneNumber($25.PhoneNumber v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPhoneNumber() => $_has(2);
  @$pb.TagNumber(3)
  void clearPhoneNumber() => clearField(3);
  @$pb.TagNumber(3)
  $25.PhoneNumber ensurePhoneNumber() => $_ensure(2);
