...
class Contact extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Contact', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOS(1, 'uuid')
    ..aOM<$13.Uid>(2, 'owner', subBuilder: $13.Uid.create)
    ..aOM<$18.PhoneNumber>(3, 'phoneNumber', protoName: 'phoneNumber', subBuilder: $18.PhoneNumber.create)
    ..aOS(4, 'firstName')
    ..aOS(5, 'lastName')
  ...
  @$pb.TagNumber(2)
  $13.Uid get owner => $_getN(1);
  @$pb.TagNumber(2)
  set owner($13.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOwner() => $_has(1);
  @$pb.TagNumber(2)
  void clearOwner() => clearField(2);
  @$pb.TagNumber(2)
  $13.Uid ensureOwner() => $_ensure(1);

  @$pb.TagNumber(3)
  $18.PhoneNumber get phoneNumber => $_getN(2);
  @$pb.TagNumber(3)
  set phoneNumber($18.PhoneNumber v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasPhoneNumber() => $_has(2);
  @$pb.TagNumber(3)
  void clearPhoneNumber() => clearField(3);
  @$pb.TagNumber(3)
  $18.PhoneNumber ensurePhoneNumber() => $_ensure(2);
