...
class UserAsContact extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserAsContact', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$17.PhoneNumber>(2, 'phoneNumber', protoName: 'phoneNumber', subBuilder: $17.PhoneNumber.create)
    ..aOS(3, 'firstName')
    ..aOS(4, 'lastName')
    ..aOS(5, 'description')
    ..aOS(6, 'email')
  ...
  @$pb.TagNumber(2)
  $17.PhoneNumber get phoneNumber => $_getN(1);
  @$pb.TagNumber(2)
  set phoneNumber($17.PhoneNumber v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPhoneNumber() => $_has(1);
  @$pb.TagNumber(2)
  void clearPhoneNumber() => clearField(2);
  @$pb.TagNumber(2)
  $17.PhoneNumber ensurePhoneNumber() => $_ensure(1);
...
class UserPrivateData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserPrivateData', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$12.Uid>(1, 'uid', subBuilder: $12.Uid.create)
    ..aOM<$17.PhoneNumber>(2, 'phoneNumber', subBuilder: $17.PhoneNumber.create)
    ..aOS(3, 'passwordHash')
    ..aOS(4, 'firstName')
    ..aOS(5, 'lastName')
    ..aOS(6, 'description')
