...
class UserAsContact extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserAsContact', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$37.PhoneNumber>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber', subBuilder: $37.PhoneNumber.create)
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'realFirstName')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'realLastName')
  ...
  factory UserAsContact({
    ...
    $core.String? email,
    $core.String? realFirstName,
    $core.String? realLastName,
  }) {
    ...
    if (realFirstName != null) {
      _result.realFirstName = realFirstName;
    }
    if (realLastName != null) {
      _result.realLastName = realLastName;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $37.PhoneNumber get phoneNumber => $_getN(1);
  @$pb.TagNumber(2)
  set phoneNumber($37.PhoneNumber v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPhoneNumber() => $_has(1);
  @$pb.TagNumber(2)
  void clearPhoneNumber() => clearField(2);
  @$pb.TagNumber(2)
  $37.PhoneNumber ensurePhoneNumber() => $_ensure(1);
  ...
  @$pb.TagNumber(7)
  $core.String get realFirstName => $_getSZ(6);
  @$pb.TagNumber(7)
  set realFirstName($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasRealFirstName() => $_has(6);
  @$pb.TagNumber(7)
  void clearRealFirstName() => clearField(7);

  @$pb.TagNumber(8)
  $core.String get realLastName => $_getSZ(7);
  @$pb.TagNumber(8)
  set realLastName($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasRealLastName() => $_has(7);
  @$pb.TagNumber(8)
  void clearRealLastName() => clearField(8);
}
...
class UserPrivateData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserPrivateData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPasswordProtected')
  ...
  factory UserPrivateData({
    ...
    if (isPasswordProtected != null) {
      _result.isPasswordProtected = isPasswordProtected;
    }
  ...
  @$pb.TagNumber(8)
  $core.bool get isPasswordProtected => $_getBF(7);
  @$pb.TagNumber(8)
  set isPasswordProtected($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(8)
  $core.bool hasIsPasswordProtected() => $_has(7);
  @$pb.TagNumber(8)
  void clearIsPasswordProtected() => clearField(8);
