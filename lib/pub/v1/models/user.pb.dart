...
class UserAsContact extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserAsContact', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$9.Uid>(1, 'node', subBuilder: $9.Uid.create)
    ..aOM<$16.PhoneNumber>(2, 'phoneNumber', protoName: 'phoneNumber', subBuilder: $16.PhoneNumber.create)
    ..aOS(3, 'username')
    ..aOS(4, 'firstName')
    ..aOS(5, 'lastName')
    ..aOS(6, 'description')
  ...
  @$pb.TagNumber(1)
  $9.Uid get node => $_getN(0);
  @$pb.TagNumber(1)
  set node($9.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasNode() => $_has(0);
  @$pb.TagNumber(1)
  void clearNode() => clearField(1);
  @$pb.TagNumber(1)
  $9.Uid ensureNode() => $_ensure(0);

  @$pb.TagNumber(2)
  $16.PhoneNumber get phoneNumber => $_getN(1);
  @$pb.TagNumber(2)
  set phoneNumber($16.PhoneNumber v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPhoneNumber() => $_has(1);
  @$pb.TagNumber(2)
  void clearPhoneNumber() => clearField(2);
  @$pb.TagNumber(2)
  $16.PhoneNumber ensurePhoneNumber() => $_ensure(1);
...
class UserPrivateData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UserPrivateData', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$9.Uid>(1, 'node', subBuilder: $9.Uid.create)
    ..aOM<$16.PhoneNumber>(2, 'phoneNumber', subBuilder: $16.PhoneNumber.create)
    ..aOS(3, 'username')
    ..aOS(4, 'passwordHash')
    ..aOS(5, 'firstName')
    ..aOS(6, 'lastName')
