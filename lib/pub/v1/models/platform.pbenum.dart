...
class Applications extends $pb.ProtobufEnum {
  ...
  static const Applications mokeb = Applications._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'mokeb');
...
class Sources extends $pb.ProtobufEnum {
  static const Sources DIRECT = Sources._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DIRECT');
  static const Sources CAFE_BAZAAR = Sources._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CAFE_BAZAAR');
  static const Sources MYKET = Sources._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MYKET');
  static const Sources SIB_APP = Sources._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SIB_APP');
  static const Sources GOOGLE_PLAY = Sources._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GOOGLE_PLAY');

  static const $core.List<Sources> values = <Sources> [
    DIRECT,
    CAFE_BAZAAR,
    MYKET,
    SIB_APP,
  ...
  static final $core.Map<$core.int, Sources> _byValue = $pb.ProtobufEnum.initByValue(values);
  static Sources? valueOf($core.int value) => _byValue[value];

  const Sources._($core.int v, $core.String n) : super(v, n);
}
