...
class CallEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$14.Uid>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'member', subBuilder: $14.Uid.create)
  ...
  @$pb.TagNumber(6)
  $14.Uid get member => $_getN(5);
  @$pb.TagNumber(6)
  set member($14.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasMember() => $_has(5);
  @$pb.TagNumber(6)
  void clearMember() => clearField(6);
  @$pb.TagNumber(6)
  $14.Uid ensureMember() => $_ensure(5);
}
