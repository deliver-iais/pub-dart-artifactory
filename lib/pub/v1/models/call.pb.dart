...
class CallEventRinging extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallEventRinging', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fromAnswerSide', protoName: 'fromAnswerSide')
    ..hasRequiredFields = false
  ;

  CallEventRinging._() : super();
  factory CallEventRinging({
    $core.bool? fromAnswerSide,
  }) {
    final _result = create();
    if (fromAnswerSide != null) {
      _result.fromAnswerSide = fromAnswerSide;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(1)
  $core.bool get fromAnswerSide => $_getBF(0);
  @$pb.TagNumber(1)
  set fromAnswerSide($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasFromAnswerSide() => $_has(0);
  @$pb.TagNumber(1)
  void clearFromAnswerSide() => clearField(1);
}
...
class CallEventEnd extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallEventEnd', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isCaller')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.bool get isCaller => $_getBF(1);
  @$pb.TagNumber(2)
  set isCaller($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasIsCaller() => $_has(1);
  @$pb.TagNumber(2)
  void clearIsCaller() => clearField(2);
}
...
class CallEventDecline extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallEventDecline', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isCaller')
    ..hasRequiredFields = false
  ;

  CallEventDecline._() : super();
  factory CallEventDecline({
    $core.bool? isCaller,
  }) {
    final _result = create();
    if (isCaller != null) {
  ...
  @$pb.TagNumber(1)
  $core.bool get isCaller => $_getBF(0);
  @$pb.TagNumber(1)
  set isCaller($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasIsCaller() => $_has(0);
  @$pb.TagNumber(1)
  void clearIsCaller() => clearField(1);
}
...
class CallEventV2ByClient extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallEventV2ByClient', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$20.Uid>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'to', subBuilder: $20.Uid.create)
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isVideo', protoName: 'isVideo')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $20.Uid get to => $_getN(7);
  @$pb.TagNumber(8)
  set to($20.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasTo() => $_has(7);
  @$pb.TagNumber(8)
  void clearTo() => clearField(8);
  @$pb.TagNumber(8)
  $20.Uid ensureTo() => $_ensure(7);

  @$pb.TagNumber(9)
  $core.bool get isVideo => $_getBF(8);
  @$pb.TagNumber(9)
  set isVideo($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasIsVideo() => $_has(8);
  @$pb.TagNumber(9)
  void clearIsVideo() => clearField(9);
}
...
class CallEventV2 extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallEventV2', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOM<$20.Uid>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'to', subBuilder: $20.Uid.create)
    ..aOM<$20.Uid>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'from', subBuilder: $20.Uid.create)
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'time')
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isVideo', protoName: 'isVideo')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  $20.Uid get from => $_getN(8);
  @$pb.TagNumber(9)
  set from($20.Uid v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasFrom() => $_has(8);
  @$pb.TagNumber(9)
  void clearFrom() => clearField(9);
  @$pb.TagNumber(9)
  $20.Uid ensureFrom() => $_ensure(8);

  @$pb.TagNumber(10)
  $fixnum.Int64 get time => $_getI64(9);
  @$pb.TagNumber(10)
  set time($fixnum.Int64 v) { $_setInt64(9, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  $core.bool get isVideo => $_getBF(10);
  @$pb.TagNumber(11)
  set isVideo($core.bool v) { $_setBool(10, v); }
  @$pb.TagNumber(11)
  $core.bool hasIsVideo() => $_has(10);
  @$pb.TagNumber(11)
  void clearIsVideo() => clearField(11);
}
...
class CallLog extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, CallLog_Type> _CallLog_TypeByTag = {
    4 : CallLog_Type.end,
    5 : CallLog_Type.decline,
    6 : CallLog_Type.busy,
    0 : CallLog_Type.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6])
    ..aOM<CallEventEnd>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'end', subBuilder: CallEventEnd.create)
    ..aOM<CallEventDecline>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'decline', subBuilder: CallEventDecline.create)
    ..aOM<CallEventBusy>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'busy', subBuilder: CallEventBusy.create)
    ...
    ..aOM<$20.Uid>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'to', subBuilder: $20.Uid.create)
    ..aOM<$20.Uid>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'from', subBuilder: $20.Uid.create)
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isVideo', protoName: 'isVideo')
    ..hasRequiredFields = false
  ;
  ...
  factory CallLog.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CallLog.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CallLog copyWith(void Function(CallLog) updates) => super.copyWith((message) => updates(message as CallLog)) as CallLog; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  CallLog_Type whichType() => _CallLog_TypeByTag[$_whichOneof(0)]!;
  void clearType() => clearField($_whichOneof(0));

  @$pb.TagNumber(4)
  CallEventEnd get end => $_getN(0);
  @$pb.TagNumber(4)
  set end(CallEventEnd v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  void clearEnd() => clearField(4);
  @$pb.TagNumber(4)
  CallEventEnd ensureEnd() => $_ensure(0);

  @$pb.TagNumber(5)
  CallEventDecline get decline => $_getN(1);
  @$pb.TagNumber(5)
  set decline(CallEventDecline v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDecline() => $_has(1);
  @$pb.TagNumber(5)
  void clearDecline() => clearField(5);
  @$pb.TagNumber(5)
  CallEventDecline ensureDecline() => $_ensure(1);

  @$pb.TagNumber(6)
  CallEventBusy get busy => $_getN(2);
  @$pb.TagNumber(6)
  set busy(CallEventBusy v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  void clearBusy() => clearField(6);
  @$pb.TagNumber(6)
  CallEventBusy ensureBusy() => $_ensure(2);
  ...
  void clearFrom() => clearField(9);
  @$pb.TagNumber(9)
  $20.Uid ensureFrom() => $_ensure(5);

  @$pb.TagNumber(10)
  $core.bool get isVideo => $_getBF(6);
  @$pb.TagNumber(10)
  set isVideo($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(10)
  $core.bool hasIsVideo() => $_has(6);
  @$pb.TagNumber(10)
  void clearIsVideo() => clearField(10);
}
