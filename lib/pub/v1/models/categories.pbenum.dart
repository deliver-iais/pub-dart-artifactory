...
class Categories extends $pb.ProtobufEnum {
  ...
  static const Categories CHANNEL = Categories._(3, 'CHANNEL');
  static const Categories BOT = Categories._(4, 'BOT');
  static const Categories STORE = Categories._(5, 'STORE');
