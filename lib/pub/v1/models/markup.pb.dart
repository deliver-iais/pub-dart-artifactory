...
class InlineKeyboardButtonCallback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineKeyboardButtonCallback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$22.PinCodeSettings>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinCodeSettings', subBuilder: $22.PinCodeSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $22.PinCodeSettings get pinCodeSettings => $_getN(1);
  @$pb.TagNumber(2)
  set pinCodeSettings($22.PinCodeSettings v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasPinCodeSettings() => $_has(1);
  @$pb.TagNumber(2)
  void clearPinCodeSettings() => clearField(2);
  @$pb.TagNumber(2)
  $22.PinCodeSettings ensurePinCodeSettings() => $_ensure(1);
}
