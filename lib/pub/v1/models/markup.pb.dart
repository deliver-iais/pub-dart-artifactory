...
class MessageMarkup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageMarkup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'removeReplyKeyboardMarkup')
  ...
  @$pb.TagNumber(5)
  $core.bool get removeReplyKeyboardMarkup => $_getBF(4);
  @$pb.TagNumber(5)
  set removeReplyKeyboardMarkup($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasRemoveReplyKeyboardMarkup() => $_has(4);
  @$pb.TagNumber(5)
  void clearRemoveReplyKeyboardMarkup() => clearField(5);
}
...
class InlineKeyboardButtonCallback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineKeyboardButtonCallback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPinCodeNeeded')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinCodeLength', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  factory InlineKeyboardButtonCallback({
    $core.String? data,
    $core.bool? isPinCodeNeeded,
    $core.int? pinCodeLength,
  }) {
    final _result = create();
    if (data != null) {
      _result.data = data;
    }
    if (isPinCodeNeeded != null) {
      _result.isPinCodeNeeded = isPinCodeNeeded;
    }
    if (pinCodeLength != null) {
      _result.pinCodeLength = pinCodeLength;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $core.bool get isPinCodeNeeded => $_getBF(1);
  @$pb.TagNumber(2)
  set isPinCodeNeeded($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasIsPinCodeNeeded() => $_has(1);
  @$pb.TagNumber(2)
  void clearIsPinCodeNeeded() => clearField(2);

  @$pb.TagNumber(3)
  $core.int get pinCodeLength => $_getIZ(2);
  @$pb.TagNumber(3)
  set pinCodeLength($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasPinCodeLength() => $_has(2);
  @$pb.TagNumber(3)
  void clearPinCodeLength() => clearField(3);
}
