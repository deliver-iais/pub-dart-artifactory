...
final $typed_data.Uint8List localNetworkFileDescriptor = $convert.base64Decode('ChBMb2NhbE5ldHdvcmtGaWxlEhIKBHV1aWQYASABKAlSBHV1aWQSEgoEbmFtZRgCIAEoCVIEbmFtZRISCgRkYXRhGAMgAygDUgRkYXRhEhYKBmZpbmlzaBgEIAEoCFIGZmluaXNoEhQKBWluZGV4GAUgASgDUgVpbmRleA==');
...
@$core.Deprecated('Use localFileAckDescriptor instead')
const LocalFileAck$json = const {
  '1': 'LocalFileAck',
  '2': const [
    const {'1': 'uuid', '3': 1, '4': 1, '5': 9, '10': 'uuid'},
...
/// Descriptor for `LocalFileAck`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localFileAckDescriptor = $convert.base64Decode('CgxMb2NhbEZpbGVBY2sSEgoEdXVpZBgBIAEoCVIEdXVpZBIUCgVpbmRleBgCIAEoA1IFaW5kZXg=');
