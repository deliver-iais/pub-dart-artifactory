...
const LocalNetworkFile$json = const {
  ...
  '2': const [
    ...
    const {'1': 'isResend', '3': 6, '4': 1, '5': 8, '10': 'isResend'},
  ],
};

/// Descriptor for `LocalNetworkFile`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localNetworkFileDescriptor = $convert.base64Decode('ChBMb2NhbE5ldHdvcmtGaWxlEhIKBHV1aWQYASABKAlSBHV1aWQSEgoEbmFtZRgCIAEoCVIEbmFtZRISCgRkYXRhGAMgAygDUgRkYXRhEhYKBmZpbmlzaBgEIAEoCFIGZmluaXNoEhQKBWluZGV4GAUgASgDUgVpbmRleBIaCghpc1Jlc2VuZBgGIAEoCFIIaXNSZXNlbmQ=');
...
@$core.Deprecated('Use resendFileRequestDescriptor instead')
const ResendFileRequest$json = const {
  '1': 'ResendFileRequest',
  '2': const [
    const {'1': 'uuid', '3': 1, '4': 1, '5': 9, '10': 'uuid'},
    const {'1': 'name', '3': 2, '4': 1, '5': 9, '10': 'name'},
...
/// Descriptor for `ResendFileRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resendFileRequestDescriptor = $convert.base64Decode('ChFSZXNlbmRGaWxlUmVxdWVzdBISCgR1dWlkGAEgASgJUgR1dWlkEhIKBG5hbWUYAiABKAlSBG5hbWU=');
