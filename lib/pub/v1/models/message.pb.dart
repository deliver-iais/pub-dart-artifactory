...
class MessageDeliveryAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageDeliveryAck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ackOnLocalMessage')
    ..hasRequiredFields = false
  ;
  ...
  factory MessageDeliveryAck({
    ...
    if (ackOnLocalMessage != null) {
      _result.ackOnLocalMessage = ackOnLocalMessage;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(6)
  $core.bool get ackOnLocalMessage => $_getBF(5);
  @$pb.TagNumber(6)
  set ackOnLocalMessage($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  $core.bool hasAckOnLocalMessage() => $_has(5);
  @$pb.TagNumber(6)
  void clearAckOnLocalMessage() => clearField(6);
}
...
class MessageBrief extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageBrief', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isLocalMessage')
    ..hasRequiredFields = false
  ;
  ...
  factory MessageBrief({
    ...
    if (isLocalMessage != null) {
      _result.isLocalMessage = isLocalMessage;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(9)
  $core.bool get isLocalMessage => $_getBF(8);
  @$pb.TagNumber(9)
  set isLocalMessage($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(9)
  $core.bool hasIsLocalMessage() => $_has(8);
  @$pb.TagNumber(9)
  void clearIsLocalMessage() => clearField(9);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Message', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOB(37, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isLocalMessage')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(37)
  $core.bool get isLocalMessage => $_getBF(35);
  @$pb.TagNumber(37)
  set isLocalMessage($core.bool v) { $_setBool(35, v); }
  @$pb.TagNumber(37)
  $core.bool hasIsLocalMessage() => $_has(35);
  @$pb.TagNumber(37)
  void clearIsLocalMessage() => clearField(37);
}
...
class MessageByClient extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageByClient', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$27.Table>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table', subBuilder: $27.Table.create)
    ..aOM<$20.Uid>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generatedBy', subBuilder: $20.Uid.create)
    ..aOB(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isLocalMessage', protoName: 'isLocalMessage')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(34)
  $core.bool get isLocalMessage => $_getBF(23);
  @$pb.TagNumber(34)
  set isLocalMessage($core.bool v) { $_setBool(23, v); }
  @$pb.TagNumber(34)
  $core.bool hasIsLocalMessage() => $_has(23);
  @$pb.TagNumber(34)
  void clearIsLocalMessage() => clearField(34);
}

class LocalNetworkEmptyMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocalNetworkEmptyMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$20.Uid>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'to', subBuilder: $20.Uid.create)
    ..hasRequiredFields = false
  ;

  LocalNetworkEmptyMessage._() : super();
  factory LocalNetworkEmptyMessage({
    $20.Uid? to,
  }) {
    final _result = create();
    if (to != null) {
  ...
  factory LocalNetworkEmptyMessage.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LocalNetworkEmptyMessage.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  LocalNetworkEmptyMessage clone() => LocalNetworkEmptyMessage()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocalNetworkEmptyMessage copyWith(void Function(LocalNetworkEmptyMessage) updates) => super.copyWith((message) => updates(message as LocalNetworkEmptyMessage)) as LocalNetworkEmptyMessage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static LocalNetworkEmptyMessage create() => LocalNetworkEmptyMessage._();
  LocalNetworkEmptyMessage createEmptyInstance() => create();
  static $pb.PbList<LocalNetworkEmptyMessage> createRepeated() => $pb.PbList<LocalNetworkEmptyMessage>();
  @$core.pragma('dart2js:noInline')
  static LocalNetworkEmptyMessage getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LocalNetworkEmptyMessage>(create);
  static LocalNetworkEmptyMessage? _defaultInstance;
...
enum LocalChatMessage_Packet {
  messageByClient, 
  callEvent, 
  localNetworkEmptyMessage, 
  notSet
}

class LocalChatMessage extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, LocalChatMessage_Packet> _LocalChatMessage_PacketByTag = {
    3 : LocalChatMessage_Packet.messageByClient,
    4 : LocalChatMessage_Packet.callEvent,
    6 : LocalChatMessage_Packet.localNetworkEmptyMessage,
    0 : LocalChatMessage_Packet.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocalChatMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<MessageByClient>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageByClient', protoName: 'messageByClient', subBuilder: MessageByClient.create)
    ..aOM<$30.CallEventV2>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', protoName: 'callEvent', subBuilder: $30.CallEventV2.create)
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localNetworkId', protoName: 'localNetworkId')
    ..aOM<LocalNetworkEmptyMessage>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localNetworkEmptyMessage', protoName: 'localNetworkEmptyMessage', subBuilder: LocalNetworkEmptyMessage.create)
    ..hasRequiredFields = false
  ;
  ...
  factory LocalChatMessage({
    ...
    $fixnum.Int64? localNetworkId,
    LocalNetworkEmptyMessage? localNetworkEmptyMessage,
  }) {
    final _result = create();
    if (from != null) {
      _result.from = from;
    ...
    if (localNetworkId != null) {
      _result.localNetworkId = localNetworkId;
    }
    if (localNetworkEmptyMessage != null) {
      _result.localNetworkEmptyMessage = localNetworkEmptyMessage;
    }
    return _result;
  }
  ...
  LocalChatMessage_Packet whichPacket() => _LocalChatMessage_PacketByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  MessageByClient get messageByClient => $_getN(2);
  @$pb.TagNumber(3)
  set messageByClient(MessageByClient v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasMessageByClient() => $_has(2);
  @$pb.TagNumber(3)
  void clearMessageByClient() => clearField(3);
  @$pb.TagNumber(3)
  MessageByClient ensureMessageByClient() => $_ensure(2);

  @$pb.TagNumber(4)
  $30.CallEventV2 get callEvent => $_getN(3);
  @$pb.TagNumber(4)
  set callEvent($30.CallEventV2 v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasCallEvent() => $_has(3);
  @$pb.TagNumber(4)
  void clearCallEvent() => clearField(4);
  @$pb.TagNumber(4)
  $30.CallEventV2 ensureCallEvent() => $_ensure(3);

  @$pb.TagNumber(5)
  $fixnum.Int64 get localNetworkId => $_getI64(4);
  @$pb.TagNumber(5)
  set localNetworkId($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasLocalNetworkId() => $_has(4);
  @$pb.TagNumber(5)
  void clearLocalNetworkId() => clearField(5);

  @$pb.TagNumber(6)
  LocalNetworkEmptyMessage get localNetworkEmptyMessage => $_getN(5);
  @$pb.TagNumber(6)
  set localNetworkEmptyMessage(LocalNetworkEmptyMessage v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLocalNetworkEmptyMessage() => $_has(5);
  @$pb.TagNumber(6)
  void clearLocalNetworkEmptyMessage() => clearField(6);
  @$pb.TagNumber(6)
  LocalNetworkEmptyMessage ensureLocalNetworkEmptyMessage() => $_ensure(5);
}
