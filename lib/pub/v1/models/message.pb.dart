...
class MessageBrief extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageBrief', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$15.File>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thumbnailReference', subBuilder: $15.File.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $15.File get thumbnailReference => $_getN(6);
  @$pb.TagNumber(7)
  set thumbnailReference($15.File v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasThumbnailReference() => $_has(6);
  @$pb.TagNumber(7)
  void clearThumbnailReference() => clearField(7);
  @$pb.TagNumber(7)
  $15.File ensureThumbnailReference() => $_ensure(6);
}
