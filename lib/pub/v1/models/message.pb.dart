...
class MessageDeliveryAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MessageDeliveryAck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$15.Uid>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'from', subBuilder: $15.Uid.create)
    ..aOM<$15.Uid>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'to', subBuilder: $15.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $15.Uid get from => $_getN(3);
  @$pb.TagNumber(4)
  set from($15.Uid v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasFrom() => $_has(3);
  @$pb.TagNumber(4)
  void clearFrom() => clearField(4);
  @$pb.TagNumber(4)
  $15.Uid ensureFrom() => $_ensure(3);

  @$pb.TagNumber(5)
  $15.Uid get to => $_getN(4);
  @$pb.TagNumber(5)
  set to($15.Uid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTo() => $_has(4);
  @$pb.TagNumber(5)
  void clearTo() => clearField(5);
  @$pb.TagNumber(5)
  $15.Uid ensureTo() => $_ensure(4);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Message', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$15.Uid>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'from', subBuilder: $15.Uid.create)
    ..aOM<$15.Uid>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'to', subBuilder: $15.Uid.create)
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replyToId')
    ..aOM<$15.Uid>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'forwardFrom', subBuilder: $15.Uid.create)
    ...
    ..aOM<$15.Uid>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specialTarget', subBuilder: $15.Uid.create)
    ...
    ..aOM<$15.Uid>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'senderOfRepliedMessage', subBuilder: $15.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  $15.Uid get from => $_getN(3);
  @$pb.TagNumber(5)
  set from($15.Uid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFrom() => $_has(3);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  $15.Uid get forwardFrom => $_getN(6);
  @$pb.TagNumber(8)
  set forwardFrom($15.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasForwardFrom() => $_has(6);
  @$pb.TagNumber(8)
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $15.Uid ensureForwardFrom() => $_ensure(6);
  ...
  @$pb.TagNumber(25)
  $15.Uid get specialTarget => $_getN(23);
  @$pb.TagNumber(25)
  set specialTarget($15.Uid v) { setField(25, v); }
  @$pb.TagNumber(25)
  $core.bool hasSpecialTarget() => $_has(23);
  @$pb.TagNumber(25)
  void clearSpecialTarget() => clearField(25);
  @$pb.TagNumber(25)
  $15.Uid ensureSpecialTarget() => $_ensure(23);
  ...
  @$pb.TagNumber(30)
  $15.Uid get senderOfRepliedMessage => $_getN(28);
  @$pb.TagNumber(30)
  set senderOfRepliedMessage($15.Uid v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasSenderOfRepliedMessage() => $_has(28);
  @$pb.TagNumber(30)
  void clearSenderOfRepliedMessage() => clearField(30);
  @$pb.TagNumber(30)
  $15.Uid ensureSenderOfRepliedMessage() => $_ensure(28);
}
...
class MessageByClient extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $15.Uid get forwardFrom => $_getN(3);
  @$pb.TagNumber(8)
  set forwardFrom($15.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $15.Uid ensureForwardFrom() => $_ensure(3);
  ...
  @$pb.TagNumber(30)
  $15.Uid get senderOfRepliedMessage => $_getN(20);
  @$pb.TagNumber(30)
  set senderOfRepliedMessage($15.Uid v) { setField(30, v); }
  @$pb.TagNumber(30)
  ...
  void clearSenderOfRepliedMessage() => clearField(30);
  @$pb.TagNumber(30)
  $15.Uid ensureSenderOfRepliedMessage() => $_ensure(20);
}
...
class MessageByBot extends $pb.GeneratedMessage {
  ...
  void clearFrom() => clearField(5);
  @$pb.TagNumber(5)
  $15.Uid ensureFrom() => $_ensure(1);

  @$pb.TagNumber(6)
  $15.Uid get to => $_getN(2);
  @$pb.TagNumber(6)
  set to($15.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  $15.Uid get forwardFrom => $_getN(4);
  @$pb.TagNumber(8)
  set forwardFrom($15.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $15.Uid ensureForwardFrom() => $_ensure(4);
  ...
  @$pb.TagNumber(20)
  $21.Buttons get buttons => $_getN(11);
  @$pb.TagNumber(20)
  set buttons($21.Buttons v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  void clearButtons() => clearField(20);
  @$pb.TagNumber(20)
  $21.Buttons ensureButtons() => $_ensure(11);
  ...
  @$pb.TagNumber(26)
  $23.SharePrivateDataRequest get sharePrivateDataRequest => $_getN(14);
  @$pb.TagNumber(26)
  set sharePrivateDataRequest($23.SharePrivateDataRequest v) { setField(26, v); }
  @$pb.TagNumber(26)
  ...
  void clearSharePrivateDataRequest() => clearField(26);
  @$pb.TagNumber(26)
  $23.SharePrivateDataRequest ensureSharePrivateDataRequest() => $_ensure(14);

  @$pb.TagNumber(28)
  $fixnum.Int64 get thread => $_getI64(15);
  @$pb.TagNumber(28)
  set thread($fixnum.Int64 v) { $_setInt64(15, v); }
  @$pb.TagNumber(28)
  $core.bool hasThread() => $_has(15);
  @$pb.TagNumber(28)
  void clearThread() => clearField(28);

  @$pb.TagNumber(29)
  $core.bool get shouldBeQuiet => $_getBF(16);
  @$pb.TagNumber(29)
  set shouldBeQuiet($core.bool v) { $_setBool(16, v); }
  @$pb.TagNumber(29)
  $core.bool hasShouldBeQuiet() => $_has(16);
  @$pb.TagNumber(29)
  void clearShouldBeQuiet() => clearField(29);

  @$pb.TagNumber(30)
  $15.Uid get senderOfRepliedMessage => $_getN(17);
  @$pb.TagNumber(30)
  set senderOfRepliedMessage($15.Uid v) { setField(30, v); }
  @$pb.TagNumber(30)
  $core.bool hasSenderOfRepliedMessage() => $_has(17);
  @$pb.TagNumber(30)
  void clearSenderOfRepliedMessage() => clearField(30);
  @$pb.TagNumber(30)
  $15.Uid ensureSenderOfRepliedMessage() => $_ensure(17);
}
