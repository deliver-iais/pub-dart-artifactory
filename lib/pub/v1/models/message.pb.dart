...
class MucSpecificPersistentEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MucSpecificPersistentEvent', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$13.Uid>(1, 'issuer', subBuilder: $13.Uid.create)
    ...
    ..aOM<$13.Uid>(3, 'assignee', subBuilder: $13.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $13.Uid get issuer => $_getN(0);
  @$pb.TagNumber(1)
  set issuer($13.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIssuer() => $_has(0);
  @$pb.TagNumber(1)
  void clearIssuer() => clearField(1);
  @$pb.TagNumber(1)
  $13.Uid ensureIssuer() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $13.Uid get assignee => $_getN(2);
  @$pb.TagNumber(3)
  set assignee($13.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAssignee() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssignee() => clearField(3);
  @$pb.TagNumber(3)
  $13.Uid ensureAssignee() => $_ensure(2);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Message', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$15.File>(12, 'file', subBuilder: $15.File.create)
    ..aOM<$15.File>(13, 'sticker', subBuilder: $15.File.create)
  ...
  @$pb.TagNumber(13)
  $15.File ensureSticker() => $_ensure(11);
...
class MessageByClient extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(22)
  FormResult get formResult => $_getN(14);
  @$pb.TagNumber(22)
  set formResult(FormResult v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  void clearFormResult() => clearField(22);
  @$pb.TagNumber(22)
  FormResult ensureFormResult() => $_ensure(14);
}
...
class MessageByBot extends $pb.GeneratedMessage {
  ...
  void clearLocation() => clearField(14);
  @$pb.TagNumber(14)
  Location ensureLocation() => $_ensure(9);

  @$pb.TagNumber(15)
  LiveLocation get liveLocation => $_getN(10);
  @$pb.TagNumber(15)
  set liveLocation(LiveLocation v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  void clearLiveLocation() => clearField(15);
  @$pb.TagNumber(15)
  LiveLocation ensureLiveLocation() => $_ensure(10);

  @$pb.TagNumber(16)
  Poll get poll => $_getN(11);
  @$pb.TagNumber(16)
  set poll(Poll v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  void clearPoll() => clearField(16);
  @$pb.TagNumber(16)
  Poll ensurePoll() => $_ensure(11);

  @$pb.TagNumber(18)
  Form get form => $_getN(12);
  @$pb.TagNumber(18)
  set form(Form v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  void clearForm() => clearField(18);
  @$pb.TagNumber(18)
  Form ensureForm() => $_ensure(12);

  @$pb.TagNumber(20)
  Buttons get buttons => $_getN(13);
  @$pb.TagNumber(20)
  set buttons(Buttons v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  void clearButtons() => clearField(20);
  @$pb.TagNumber(20)
  Buttons ensureButtons() => $_ensure(13);
