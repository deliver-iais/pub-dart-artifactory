...
class PersistentEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PersistentEvent', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$9.Uid>(1, 'issuer', subBuilder: $9.Uid.create)
    ...
    ..aOM<$9.Uid>(3, 'assignee', subBuilder: $9.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $9.Uid get issuer => $_getN(0);
  @$pb.TagNumber(1)
  set issuer($9.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIssuer() => $_has(0);
  @$pb.TagNumber(1)
  void clearIssuer() => clearField(1);
  @$pb.TagNumber(1)
  $9.Uid ensureIssuer() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $9.Uid get assignee => $_getN(2);
  @$pb.TagNumber(3)
  set assignee($9.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAssignee() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssignee() => clearField(3);
  @$pb.TagNumber(3)
  $9.Uid ensureAssignee() => $_ensure(2);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Message', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aInt64(2, 'id')
    ..aInt64(4, 'time')
    ..aOM<$9.Uid>(5, 'from', subBuilder: $9.Uid.create)
    ..aOM<$9.Uid>(6, 'to', subBuilder: $9.Uid.create)
    ..aInt64(7, 'replyToId')
    ..aOM<$9.Uid>(8, 'forwardFrom', subBuilder: $9.Uid.create)
    ..aOB(9, 'edited')
    ..aOB(10, 'encrypted')
  ...
  @$pb.TagNumber(5)
  $9.Uid get from => $_getN(3);
  @$pb.TagNumber(5)
  set from($9.Uid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFrom() => $_has(3);
  @$pb.TagNumber(5)
  void clearFrom() => clearField(5);
  @$pb.TagNumber(5)
  $9.Uid ensureFrom() => $_ensure(3);

  @$pb.TagNumber(6)
  $9.Uid get to => $_getN(4);
  @$pb.TagNumber(6)
  set to($9.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTo() => $_has(4);
  @$pb.TagNumber(6)
  void clearTo() => clearField(6);
  @$pb.TagNumber(6)
  $9.Uid ensureTo() => $_ensure(4);
  ...
  @$pb.TagNumber(8)
  $9.Uid get forwardFrom => $_getN(6);
  @$pb.TagNumber(8)
  set forwardFrom($9.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasForwardFrom() => $_has(6);
  @$pb.TagNumber(8)
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $9.Uid ensureForwardFrom() => $_ensure(6);
...
class MessageByClient extends $pb.GeneratedMessage {
  ...
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $9.Uid ensureForwardFrom() => $_ensure(3);
