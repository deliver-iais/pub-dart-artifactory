...
class MessageByBot extends $pb.GeneratedMessage {
  ...
  void clearFrom() => clearField(5);
  @$pb.TagNumber(5)
  $12.Uid ensureFrom() => $_ensure(1);

  @$pb.TagNumber(6)
  $12.Uid get to => $_getN(2);
  @$pb.TagNumber(6)
  set to($12.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  $12.Uid get forwardFrom => $_getN(4);
  @$pb.TagNumber(8)
  set forwardFrom($12.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $12.Uid ensureForwardFrom() => $_ensure(4);
  ...
  void clearFile() => clearField(12);
  @$pb.TagNumber(12)
  $14.File ensureFile() => $_ensure(7);

  @$pb.TagNumber(13)
  $14.File get sticker => $_getN(8);
  @$pb.TagNumber(13)
  set sticker($14.File v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  void clearSticker() => clearField(13);
  @$pb.TagNumber(13)
  $14.File ensureSticker() => $_ensure(8);
