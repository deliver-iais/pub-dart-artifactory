...
class PersistentEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PersistentEvent', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$8.Uid>(1, 'issuer', subBuilder: $8.Uid.create)
    ...
    ..aOM<$8.Uid>(3, 'assignee', subBuilder: $8.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $8.Uid get issuer => $_getN(0);
  @$pb.TagNumber(1)
  set issuer($8.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIssuer() => $_has(0);
  @$pb.TagNumber(1)
  void clearIssuer() => clearField(1);
  @$pb.TagNumber(1)
  $8.Uid ensureIssuer() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $8.Uid get assignee => $_getN(2);
  @$pb.TagNumber(3)
  set assignee($8.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAssignee() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssignee() => clearField(3);
  @$pb.TagNumber(3)
  $8.Uid ensureAssignee() => $_ensure(2);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Message', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aInt64(2, 'id')
    ..aInt64(4, 'time')
    ..aOM<$8.Uid>(5, 'from', subBuilder: $8.Uid.create)
    ..aOM<$8.Uid>(6, 'to', subBuilder: $8.Uid.create)
    ..aInt64(7, 'replyToId')
    ..aOM<$8.Uid>(8, 'forwardFrom', subBuilder: $8.Uid.create)
    ..aOB(9, 'edited')
    ..aOB(10, 'encrypted')
    ..aOM<Text>(11, 'text', subBuilder: Text.create)
    ..aOM<$11.File>(12, 'file', subBuilder: $11.File.create)
    ..aOM<$12.Sticker>(13, 'sticker', subBuilder: $12.Sticker.create)
  ...
  @$pb.TagNumber(5)
  $8.Uid get from => $_getN(3);
  @$pb.TagNumber(5)
  set from($8.Uid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFrom() => $_has(3);
  @$pb.TagNumber(5)
  void clearFrom() => clearField(5);
  @$pb.TagNumber(5)
  $8.Uid ensureFrom() => $_ensure(3);

  @$pb.TagNumber(6)
  $8.Uid get to => $_getN(4);
  @$pb.TagNumber(6)
  set to($8.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTo() => $_has(4);
  @$pb.TagNumber(6)
  void clearTo() => clearField(6);
  @$pb.TagNumber(6)
  $8.Uid ensureTo() => $_ensure(4);
  ...
  @$pb.TagNumber(8)
  $8.Uid get forwardFrom => $_getN(6);
  @$pb.TagNumber(8)
  set forwardFrom($8.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasForwardFrom() => $_has(6);
  @$pb.TagNumber(8)
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $8.Uid ensureForwardFrom() => $_ensure(6);
  ...
  @$pb.TagNumber(12)
  $11.File get file => $_getN(10);
  @$pb.TagNumber(12)
  set file($11.File v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasFile() => $_has(10);
  @$pb.TagNumber(12)
  void clearFile() => clearField(12);
  @$pb.TagNumber(12)
  $11.File ensureFile() => $_ensure(10);

  @$pb.TagNumber(13)
  $12.Sticker get sticker => $_getN(11);
  @$pb.TagNumber(13)
  set sticker($12.Sticker v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasSticker() => $_has(11);
  @$pb.TagNumber(13)
  void clearSticker() => clearField(13);
  @$pb.TagNumber(13)
  $12.Sticker ensureSticker() => $_ensure(11);
...
class MessageByClient extends $pb.GeneratedMessage {
  ...
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $8.Uid ensureForwardFrom() => $_ensure(3);
  ...
  void clearFile() => clearField(12);
  @$pb.TagNumber(12)
  $11.File ensureFile() => $_ensure(6);

  @$pb.TagNumber(13)
  $12.Sticker get sticker => $_getN(7);
  @$pb.TagNumber(13)
  set sticker($12.Sticker v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  void clearSticker() => clearField(13);
  @$pb.TagNumber(13)
  $12.Sticker ensureSticker() => $_ensure(7);
