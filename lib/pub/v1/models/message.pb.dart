...
import 'uid.pb.dart' as $11;
import 'file.pb.dart' as $13;
...
class MucSpecificPersistentEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MucSpecificPersistentEvent', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$11.Uid>(1, 'issuer', subBuilder: $11.Uid.create)
    ...
    ..aOM<$11.Uid>(3, 'assignee', subBuilder: $11.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $11.Uid get issuer => $_getN(0);
  @$pb.TagNumber(1)
  set issuer($11.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIssuer() => $_has(0);
  @$pb.TagNumber(1)
  void clearIssuer() => clearField(1);
  @$pb.TagNumber(1)
  $11.Uid ensureIssuer() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $11.Uid get assignee => $_getN(2);
  @$pb.TagNumber(3)
  set assignee($11.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAssignee() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssignee() => clearField(3);
  @$pb.TagNumber(3)
  $11.Uid ensureAssignee() => $_ensure(2);
}
...
class MessageDeliveryAck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MessageDeliveryAck', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aInt64(2, 'id')
    ..aInt64(3, 'time')
    ..aOM<$11.Uid>(4, 'from', subBuilder: $11.Uid.create)
    ..aOM<$11.Uid>(5, 'to', subBuilder: $11.Uid.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $11.Uid get from => $_getN(3);
  @$pb.TagNumber(4)
  set from($11.Uid v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasFrom() => $_has(3);
  @$pb.TagNumber(4)
  void clearFrom() => clearField(4);
  @$pb.TagNumber(4)
  $11.Uid ensureFrom() => $_ensure(3);

  @$pb.TagNumber(5)
  $11.Uid get to => $_getN(4);
  @$pb.TagNumber(5)
  set to($11.Uid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTo() => $_has(4);
  @$pb.TagNumber(5)
  void clearTo() => clearField(5);
  @$pb.TagNumber(5)
  $11.Uid ensureTo() => $_ensure(4);
}
...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Message', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..oo(0, [11, 12, 13, 14, 15, 16, 18, 19, 20])
    ..aOS(1, 'packetId')
    ..aInt64(2, 'id')
    ..aInt64(4, 'time')
    ..aOM<$11.Uid>(5, 'from', subBuilder: $11.Uid.create)
    ..aOM<$11.Uid>(6, 'to', subBuilder: $11.Uid.create)
    ..aInt64(7, 'replyToId')
    ..aOM<$11.Uid>(8, 'forwardFrom', subBuilder: $11.Uid.create)
    ..aOB(9, 'edited')
    ..aOB(10, 'encrypted')
    ..aOM<Text>(11, 'text', subBuilder: Text.create)
    ..aOM<$13.File>(12, 'file', subBuilder: $13.File.create)
    ..aOM<$13.File>(13, 'sticker', subBuilder: $13.File.create)
  ...
  $11.Uid get from => $_getN(3);
  @$pb.TagNumber(5)
  set from($11.Uid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasFrom() => $_has(3);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  $11.Uid get forwardFrom => $_getN(6);
  @$pb.TagNumber(8)
  set forwardFrom($11.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasForwardFrom() => $_has(6);
  @$pb.TagNumber(8)
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $11.Uid ensureForwardFrom() => $_ensure(6);
  ...
  @$pb.TagNumber(12)
  $13.File get file => $_getN(10);
  @$pb.TagNumber(12)
  set file($13.File v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasFile() => $_has(10);
  @$pb.TagNumber(12)
  void clearFile() => clearField(12);
  @$pb.TagNumber(12)
  $13.File ensureFile() => $_ensure(10);

  @$pb.TagNumber(13)
  $13.File get sticker => $_getN(11);
  @$pb.TagNumber(13)
  set sticker($13.File v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasSticker() => $_has(11);
  @$pb.TagNumber(13)
  void clearSticker() => clearField(13);
  @$pb.TagNumber(13)
  $13.File ensureSticker() => $_ensure(11);
  ...
  @$pb.TagNumber(20)
  Buttons get buttons => $_getN(17);
  @$pb.TagNumber(20)
  set buttons(Buttons v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasButtons() => $_has(17);
  @$pb.TagNumber(20)
  void clearButtons() => clearField(20);
  @$pb.TagNumber(20)
  Buttons ensureButtons() => $_ensure(17);
}
...
class MessageByClient extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(8)
  $11.Uid get forwardFrom => $_getN(3);
  @$pb.TagNumber(8)
  set forwardFrom($11.Uid v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  void clearForwardFrom() => clearField(8);
  @$pb.TagNumber(8)
  $11.Uid ensureForwardFrom() => $_ensure(3);
  ...
  void clearFile() => clearField(12);
  @$pb.TagNumber(12)
  $13.File ensureFile() => $_ensure(6);

  @$pb.TagNumber(13)
  $13.File get sticker => $_getN(7);
  @$pb.TagNumber(13)
  set sticker($13.File v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  void clearSticker() => clearField(13);
  @$pb.TagNumber(13)
  $13.File ensureSticker() => $_ensure(7);
