...
class FormResult_Result extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FormResult.Result', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..aOS(1, 'id')
    ..aOS(2, 'value')
    ..hasRequiredFields = false
  ;

  FormResult_Result._() : super();
  factory FormResult_Result() => create();
  factory FormResult_Result.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FormResult_Result.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  FormResult_Result clone() => FormResult_Result()..mergeFromMessage(this);
  FormResult_Result copyWith(void Function(FormResult_Result) updates) => super.copyWith((message) => updates(message as FormResult_Result));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static FormResult_Result create() => FormResult_Result._();
  FormResult_Result createEmptyInstance() => create();
  static $pb.PbList<FormResult_Result> createRepeated() => $pb.PbList<FormResult_Result>();
  @$core.pragma('dart2js:noInline')
  static FormResult_Result getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FormResult_Result>(create);
  static FormResult_Result _defaultInstance;
...
class FormResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('FormResult', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ..pc<FormResult_Result>(1, 'items', $pb.PbFieldType.PM, subBuilder: FormResult_Result.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $core.List<FormResult_Result> get items => $_getList(0);
}
