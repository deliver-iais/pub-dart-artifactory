...
class Message extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Message', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOS(23, 'replyBriefText')
    ..a<$core.List<$core.int>>(24, 'replyBriefThumbnail', $pb.PbFieldType.OY)
    ..a<$core.int>(25, 'ttl', $pb.PbFieldType.O3)
    ..aOM<$13.Uid>(26, 'mucTargetByUid', subBuilder: $13.Uid.create)
    ..e<$14.Role>(27, 'mucTargetByRole', $pb.PbFieldType.OE, defaultOrMaker: $14.Role.NONE, valueOf: $14.Role.valueOf, enumValues: $14.Role.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(23)
  $core.String get replyBriefText => $_getSZ(21);
  @$pb.TagNumber(23)
  set replyBriefText($core.String v) { $_setString(21, v); }
  @$pb.TagNumber(23)
  $core.bool hasReplyBriefText() => $_has(21);
  @$pb.TagNumber(23)
  void clearReplyBriefText() => clearField(23);

  @$pb.TagNumber(24)
  $core.List<$core.int> get replyBriefThumbnail => $_getN(22);
  @$pb.TagNumber(24)
  set replyBriefThumbnail($core.List<$core.int> v) { $_setBytes(22, v); }
  @$pb.TagNumber(24)
  $core.bool hasReplyBriefThumbnail() => $_has(22);
  @$pb.TagNumber(24)
  void clearReplyBriefThumbnail() => clearField(24);

  @$pb.TagNumber(25)
  $core.int get ttl => $_getIZ(23);
  @$pb.TagNumber(25)
  set ttl($core.int v) { $_setSignedInt32(23, v); }
  @$pb.TagNumber(25)
  $core.bool hasTtl() => $_has(23);
  @$pb.TagNumber(25)
  void clearTtl() => clearField(25);

  @$pb.TagNumber(26)
  $13.Uid get mucTargetByUid => $_getN(24);
  @$pb.TagNumber(26)
  set mucTargetByUid($13.Uid v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasMucTargetByUid() => $_has(24);
  @$pb.TagNumber(26)
  void clearMucTargetByUid() => clearField(26);
  @$pb.TagNumber(26)
  $13.Uid ensureMucTargetByUid() => $_ensure(24);

  @$pb.TagNumber(27)
  $14.Role get mucTargetByRole => $_getN(25);
  @$pb.TagNumber(27)
  set mucTargetByRole($14.Role v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasMucTargetByRole() => $_has(25);
  @$pb.TagNumber(27)
  void clearMucTargetByRole() => clearField(27);
}
...
class MessageByClient extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('MessageByClient', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$19.FormResult>(22, 'formResult', subBuilder: $19.FormResult.create)
    ..aOS(23, 'replyBriefText')
    ..a<$core.List<$core.int>>(24, 'replyBriefImgThumbnail', $pb.PbFieldType.OY)
    ..a<$core.int>(25, 'ttl', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(23)
  $core.String get replyBriefText => $_getSZ(15);
  @$pb.TagNumber(23)
  set replyBriefText($core.String v) { $_setString(15, v); }
  @$pb.TagNumber(23)
  $core.bool hasReplyBriefText() => $_has(15);
  @$pb.TagNumber(23)
  void clearReplyBriefText() => clearField(23);

  @$pb.TagNumber(24)
  $core.List<$core.int> get replyBriefImgThumbnail => $_getN(16);
  @$pb.TagNumber(24)
  set replyBriefImgThumbnail($core.List<$core.int> v) { $_setBytes(16, v); }
  @$pb.TagNumber(24)
  $core.bool hasReplyBriefImgThumbnail() => $_has(16);
  @$pb.TagNumber(24)
  void clearReplyBriefImgThumbnail() => clearField(24);

  @$pb.TagNumber(25)
  $core.int get ttl => $_getIZ(17);
  @$pb.TagNumber(25)
  set ttl($core.int v) { $_setSignedInt32(17, v); }
  @$pb.TagNumber(25)
  $core.bool hasTtl() => $_has(17);
  @$pb.TagNumber(25)
  void clearTtl() => clearField(25);
}
