...
class ServerLessPacket extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerLessPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$48.ShareLocalNetworkInfo>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localNetworkInfo', subBuilder: $48.ShareLocalNetworkInfo.create)
  ...
  factory ServerLessPacket({
    ...
    $48.ShareLocalNetworkInfo? localNetworkInfo,
  ...
  @$pb.TagNumber(10)
  $48.ShareLocalNetworkInfo get localNetworkInfo => $_getN(8);
  @$pb.TagNumber(10)
  set localNetworkInfo($48.ShareLocalNetworkInfo v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasLocalNetworkInfo() => $_has(8);
  @$pb.TagNumber(10)
  void clearLocalNetworkInfo() => clearField(10);
  @$pb.TagNumber(10)
  $48.ShareLocalNetworkInfo ensureLocalNetworkInfo() => $_ensure(8);
