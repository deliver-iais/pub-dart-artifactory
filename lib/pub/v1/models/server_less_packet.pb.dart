...
import 'local_network_file.pb.dart' as $48;
import 'register.pb.dart' as $49;
...
class ServerLessPacket extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ServerLessPacket_Type> _ServerLessPacket_TypeByTag = {
    ...
    6 : ServerLessPacket_Type.addMembersReq,
    7 : ServerLessPacket_Type.activity,
    8 : ServerLessPacket_Type.sendFileRequest,
    9 : ServerLessPacket_Type.resendFileRequest,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerLessPacket', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$30.CallEvent>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callEvent', subBuilder: $30.CallEvent.create)
    ...
    ..aOM<$5.AddMembersReq>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addMembersReq', subBuilder: $5.AddMembersReq.create)
    ..aOM<$36.Activity>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activity', subBuilder: $36.Activity.create)
    ..aOM<$48.SendFileRequest>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sendFileRequest', subBuilder: $48.SendFileRequest.create)
    ..aOM<$48.ResendFileRequest>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resendFileRequest', subBuilder: $48.ResendFileRequest.create)
    ..aOM<$49.LocalNetworkInfo>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localNetworkInfo', subBuilder: $49.LocalNetworkInfo.create)
  ...
  factory ServerLessPacket({
    ...
    $5.AddMembersReq? addMembersReq,
    $36.Activity? activity,
    $48.SendFileRequest? sendFileRequest,
    $48.ResendFileRequest? resendFileRequest,
    $49.LocalNetworkInfo? localNetworkInfo,
  }) {
    ...
    if (addMembersReq != null) {
      _result.addMembersReq = addMembersReq;
    }
    if (activity != null) {
    ...
    if (resendFileRequest != null) {
      _result.resendFileRequest = resendFileRequest;
    }
  ...
  @$pb.TagNumber(3)
  $30.CallEvent get callEvent => $_getN(2);
  @$pb.TagNumber(3)
  set callEvent($30.CallEvent v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasCallEvent() => $_has(2);
  @$pb.TagNumber(3)
  void clearCallEvent() => clearField(3);
  @$pb.TagNumber(3)
  $30.CallEvent ensureCallEvent() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $5.AddMembersReq get addMembersReq => $_getN(5);
  @$pb.TagNumber(6)
  set addMembersReq($5.AddMembersReq v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAddMembersReq() => $_has(5);
  @$pb.TagNumber(6)
  void clearAddMembersReq() => clearField(6);
  @$pb.TagNumber(6)
  $5.AddMembersReq ensureAddMembersReq() => $_ensure(5);
  ...
  @$pb.TagNumber(8)
  $48.SendFileRequest get sendFileRequest => $_getN(7);
  @$pb.TagNumber(8)
  set sendFileRequest($48.SendFileRequest v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSendFileRequest() => $_has(7);
  @$pb.TagNumber(8)
  void clearSendFileRequest() => clearField(8);
  @$pb.TagNumber(8)
  $48.SendFileRequest ensureSendFileRequest() => $_ensure(7);

  @$pb.TagNumber(9)
  $48.ResendFileRequest get resendFileRequest => $_getN(8);
  @$pb.TagNumber(9)
  set resendFileRequest($48.ResendFileRequest v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasResendFileRequest() => $_has(8);
  @$pb.TagNumber(9)
  void clearResendFileRequest() => clearField(9);
  @$pb.TagNumber(9)
  $48.ResendFileRequest ensureResendFileRequest() => $_ensure(8);

  @$pb.TagNumber(10)
  $49.LocalNetworkInfo get localNetworkInfo => $_getN(9);
  @$pb.TagNumber(10)
  set localNetworkInfo($49.LocalNetworkInfo v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasLocalNetworkInfo() => $_has(9);
  @$pb.TagNumber(10)
  void clearLocalNetworkInfo() => clearField(10);
  @$pb.TagNumber(10)
  $49.LocalNetworkInfo ensureLocalNetworkInfo() => $_ensure(9);
}
