...
class ServerLessPacket extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  $48.LocalNetworkInfo get localNetworkInfo => $_getN(7);
  @$pb.TagNumber(10)
  set localNetworkInfo($48.LocalNetworkInfo v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasLocalNetworkInfo() => $_has(7);
  @$pb.TagNumber(10)
  void clearLocalNetworkInfo() => clearField(10);
  @$pb.TagNumber(10)
  $48.LocalNetworkInfo ensureLocalNetworkInfo() => $_ensure(7);

  @$pb.TagNumber(11)
  $20.Uid get uid => $_getN(8);
  @$pb.TagNumber(11)
