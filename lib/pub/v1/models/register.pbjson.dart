...
const MyLocalNetworkInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'target', '3': 3, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'target'},
  ],
};

/// Descriptor for `MyLocalNetworkInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List myLocalNetworkInfoDescriptor = $convert.base64Decode('ChJNeUxvY2FsTmV0d29ya0luZm8SLAoEZnJvbRgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgRmcm9tEjYKB2FkZHJlc3MYAiABKAsyHC5wcm90by5wdWIudjEubW9kZWxzLkFkZHJlc3NSB2FkZHJlc3MSMAoGdGFyZ2V0GAMgASgLMhgucHJvdG8ucHViLnYxLm1vZGVscy5VaWRSBnRhcmdldA==');
