...
class MucSpecificPersistentEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MucSpecificPersistentEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$20.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuer', subBuilder: $20.Uid.create)
    ...
    ..aOM<$20.Uid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assignee', subBuilder: $20.Uid.create)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageId')
    ..aOM<$21.Avatar>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avatar', subBuilder: $21.Avatar.create)
  ...
  @$pb.TagNumber(1)
  $20.Uid get issuer => $_getN(0);
  @$pb.TagNumber(1)
  set issuer($20.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIssuer() => $_has(0);
  @$pb.TagNumber(1)
  void clearIssuer() => clearField(1);
  @$pb.TagNumber(1)
  $20.Uid ensureIssuer() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $20.Uid get assignee => $_getN(2);
  @$pb.TagNumber(3)
  set assignee($20.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAssignee() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssignee() => clearField(3);
  @$pb.TagNumber(3)
  $20.Uid ensureAssignee() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $21.Avatar get avatar => $_getN(4);
  @$pb.TagNumber(5)
  set avatar($21.Avatar v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAvatar() => $_has(4);
  @$pb.TagNumber(5)
  void clearAvatar() => clearField(5);
  @$pb.TagNumber(5)
  $21.Avatar ensureAvatar() => $_ensure(4);
