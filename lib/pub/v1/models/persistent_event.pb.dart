...
class MucSpecificPersistentEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MucSpecificPersistentEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$14.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuer', subBuilder: $14.Uid.create)
    ...
    ..aOM<$14.Uid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assignee', subBuilder: $14.Uid.create)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageId')
    ..aOM<$15.Avatar>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avatar', subBuilder: $15.Avatar.create)
  ...
  @$pb.TagNumber(5)
  $15.Avatar get avatar => $_getN(4);
  @$pb.TagNumber(5)
  set avatar($15.Avatar v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAvatar() => $_has(4);
  @$pb.TagNumber(5)
  void clearAvatar() => clearField(5);
  @$pb.TagNumber(5)
  $15.Avatar ensureAvatar() => $_ensure(4);
