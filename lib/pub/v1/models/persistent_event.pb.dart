...
class MucSpecificPersistentEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MucSpecificPersistentEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..aOM<$18.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuer', subBuilder: $18.Uid.create)
    ...
    ..aOM<$18.Uid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assignee', subBuilder: $18.Uid.create)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageId')
    ..aOM<$19.Avatar>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avatar', subBuilder: $19.Avatar.create)
  ...
  @$pb.TagNumber(1)
  $18.Uid get issuer => $_getN(0);
  @$pb.TagNumber(1)
  set issuer($18.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIssuer() => $_has(0);
  @$pb.TagNumber(1)
  void clearIssuer() => clearField(1);
  @$pb.TagNumber(1)
  $18.Uid ensureIssuer() => $_ensure(0);
  ...
  @$pb.TagNumber(3)
  $18.Uid get assignee => $_getN(2);
  @$pb.TagNumber(3)
  set assignee($18.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAssignee() => $_has(2);
  @$pb.TagNumber(3)
  void clearAssignee() => clearField(3);
  @$pb.TagNumber(3)
  $18.Uid ensureAssignee() => $_ensure(2);
  ...
  @$pb.TagNumber(5)
  $19.Avatar get avatar => $_getN(4);
  @$pb.TagNumber(5)
  set avatar($19.Avatar v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasAvatar() => $_has(4);
  @$pb.TagNumber(5)
  void clearAvatar() => clearField(5);
  @$pb.TagNumber(5)
  $19.Avatar ensureAvatar() => $_ensure(4);
