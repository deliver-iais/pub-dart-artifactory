...
class PersistentEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('PersistentEvent', package: const $pb.PackageName('proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$13.Uid>(26, 'targetByUid', subBuilder: $13.Uid.create)
    ..e<$14.Role>(27, 'targetByRole', $pb.PbFieldType.OE, defaultOrMaker: $14.Role.NONE, valueOf: $14.Role.valueOf, enumValues: $14.Role.values)
  ...
  @$pb.TagNumber(26)
  $13.Uid get targetByUid => $_getN(3);
  @$pb.TagNumber(26)
  set targetByUid($13.Uid v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasTargetByUid() => $_has(3);
  @$pb.TagNumber(26)
  void clearTargetByUid() => clearField(26);
  @$pb.TagNumber(26)
  $13.Uid ensureTargetByUid() => $_ensure(3);

  @$pb.TagNumber(27)
  $14.Role get targetByRole => $_getN(4);
  @$pb.TagNumber(27)
  set targetByRole($14.Role v) { setField(27, v); }
  @$pb.TagNumber(27)
  $core.bool hasTargetByRole() => $_has(4);
  @$pb.TagNumber(27)
  void clearTargetByRole() => clearField(27);
}
