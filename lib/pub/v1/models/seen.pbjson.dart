...
@$core.Deprecated('Use seenByBotDescriptor instead')
const SeenByBot$json = const {
  '1': 'SeenByBot',
  '2': const [
    const {'1': 'from', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'from'},
    const {'1': 'to', '3': 2, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'to'},
...
/// Descriptor for `SeenByBot`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List seenByBotDescriptor = $convert.base64Decode('CglTZWVuQnlCb3QSLAoEZnJvbRgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgRmcm9tEigKAnRvGAIgASgLMhgucHJvdG8ucHViLnYxLm1vZGVscy5VaWRSAnRvEg4KAmlkGAMgASgDUgJpZA==');
