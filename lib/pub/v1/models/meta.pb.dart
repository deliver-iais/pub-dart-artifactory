...
class Meta extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Meta_Meta> _Meta_MetaByTag = {
    6 : Meta_Meta.file,
    7 : Meta_Meta.link,
    8 : Meta_Meta.call,
    0 : Meta_Meta.notSet
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Meta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$26.CallInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'call', subBuilder: $26.CallInfo.create)
  ...
  Meta_Meta whichMeta() => _Meta_MetaByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(8)
  set call($26.CallInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCall() => $_has(7);
  @$pb.TagNumber(8)
  void clearCall() => clearField(8);
  @$pb.TagNumber(8)
