...
class Meta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Meta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$20.Uid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sender', subBuilder: $20.Uid.create)
    ...
    ..aOM<$30.CallInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callInfo', subBuilder: $30.CallInfo.create)
  ...
  @$pb.TagNumber(3)
  $20.Uid get sender => $_getN(2);
  @$pb.TagNumber(3)
  set sender($20.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSender() => $_has(2);
  @$pb.TagNumber(3)
  void clearSender() => clearField(3);
  @$pb.TagNumber(3)
  $20.Uid ensureSender() => $_ensure(2);
  ...
  @$pb.TagNumber(8)
  $30.CallInfo get callInfo => $_getN(7);
  @$pb.TagNumber(8)
  set callInfo($30.CallInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCallInfo() => $_has(7);
  @$pb.TagNumber(8)
  void clearCallInfo() => clearField(8);
  @$pb.TagNumber(8)
  $30.CallInfo ensureCallInfo() => $_ensure(7);
}
