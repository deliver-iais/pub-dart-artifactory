...
class Meta extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Meta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ...
    ..aOM<$18.Uid>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sender', subBuilder: $18.Uid.create)
    ...
    ..aOM<$16.File>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'file', subBuilder: $16.File.create)
    ..aOM<Link>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'link', subBuilder: Link.create)
    ..aOM<$27.CallInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callInfo', subBuilder: $27.CallInfo.create)
  ...
  @$pb.TagNumber(3)
  $18.Uid get sender => $_getN(2);
  @$pb.TagNumber(3)
  set sender($18.Uid v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSender() => $_has(2);
  @$pb.TagNumber(3)
  void clearSender() => clearField(3);
  @$pb.TagNumber(3)
  $18.Uid ensureSender() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  $16.File get file => $_getN(5);
  @$pb.TagNumber(6)
  set file($16.File v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFile() => $_has(5);
  @$pb.TagNumber(6)
  void clearFile() => clearField(6);
  @$pb.TagNumber(6)
  $16.File ensureFile() => $_ensure(5);
  ...
  @$pb.TagNumber(8)
  $27.CallInfo get callInfo => $_getN(7);
  @$pb.TagNumber(8)
  set callInfo($27.CallInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasCallInfo() => $_has(7);
  @$pb.TagNumber(8)
  void clearCallInfo() => clearField(8);
  @$pb.TagNumber(8)
  $27.CallInfo ensureCallInfo() => $_ensure(7);
}
