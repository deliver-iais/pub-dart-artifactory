...
import 'categories.pbenum.dart' as $12;
...
class Avatar extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Avatar', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..e<$12.Categories>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: $12.Categories.USER, valueOf: $12.Categories.valueOf, enumValues: $12.Categories.values)
  ...
  @$pb.TagNumber(1)
  $12.Categories get category => $_getN(0);
  @$pb.TagNumber(1)
  set category($12.Categories v) { setField(1, v); }
  @$pb.TagNumber(1)
