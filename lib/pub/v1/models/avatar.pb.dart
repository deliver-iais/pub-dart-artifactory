...
import 'categories.pbenum.dart' as $13;
...
class Avatar extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Avatar', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.models'), createEmptyInstance: create)
    ..e<$13.Categories>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: $13.Categories.USER, valueOf: $13.Categories.valueOf, enumValues: $13.Categories.values)
  ...
  @$pb.TagNumber(1)
  $13.Categories get category => $_getN(0);
  @$pb.TagNumber(1)
  set category($13.Categories v) { setField(1, v); }
  @$pb.TagNumber(1)
