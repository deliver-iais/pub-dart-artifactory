...
@$core.Deprecated('Use channelAdminDescriptor instead')
...
/// Descriptor for `ChannelAdmin`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List channelAdminDescriptor = $convert.base64Decode('CgxDaGFubmVsQWRtaW4SLgoFYWRtaW4YASABKAsyGC5wcm90by5wdWIudjEubW9kZWxzLlVpZFIFYWRtaW4SMgoHY2hhbm5lbBgCIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgdjaGFubmVs');
...
final $typed_data.Uint8List getChannelReqDescriptor = $convert.base64Decode('Cg1HZXRDaGFubmVsUmVxEioKA3VpZBgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgN1aWQ=');
...
final $typed_data.Uint8List getChannelResDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use getPermissionReqDescriptor instead')
...
/// Descriptor for `GetPermissionReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getPermissionReqDescriptor = $convert.base64Decode('ChBHZXRQZXJtaXNzaW9uUmVxEjIKB2NoYW5uZWwYASABKAsyGC5wcm90by5wdWIudjEubW9kZWxzLlVpZFIHY2hhbm5lbBJDCgxhY2Nlc3NfZmllbGQYAiABKA4yIC5wcm90by5wdWIudjEubW9kZWxzLkFjY2Vzc0ZpZWxkUgthY2Nlc3NGaWVsZA==');
@$core.Deprecated('Use getPermissionResDescriptor instead')
...
/// Descriptor for `GetPermissionRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getPermissionResDescriptor = $convert.base64Decode('ChBHZXRQZXJtaXNzaW9uUmVzEhQKBXRva2VuGAEgASgJUgV0b2tlbg==');
