...
const GetPermissionInChannelReq$json = const {
  '1': 'GetPermissionInChannelReq',
  '2': const [
    const {'1': 'channel', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'channel'},
    const {'1': 'access_field', '3': 2, '4': 1, '5': 14, '6': '.proto.pub.v1.channel.GetPermissionInChannelReq.AccessField', '10': 'accessField'},
  ],
  '4': const [GetPermissionInChannelReq_AccessField$json],
};

const GetPermissionInChannelReq_AccessField$json = const {
  '1': 'AccessField',
  '2': const [
...
const GetPermissionInChannelRes$json = const {
  '1': 'GetPermissionInChannelRes',
  '2': const [
