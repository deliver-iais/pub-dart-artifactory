...
final $typed_data.Uint8List channelInfoDescriptor = $convert.base64Decode('CgtDaGFubmVsSW5mbxISCgRuYW1lGAEgASgJUgRuYW1lEhIKBGluZm8YAiABKAlSBGluZm8SNQoEdHlwZRgDIAEoDjIhLnByb3RvLnB1Yi52MS5jaGFubmVsLkNoYW5uZWxUeXBlUgR0eXBlEg4KAmlkGAQgASgJUgJpZBIqChFsYXN0X3VwZGF0ZWRfdGltZRgFIAEoA1IPbGFzdFVwZGF0ZWRUaW1l');
...
@$core.Deprecated('Use addMemberToLocalMucDescriptor instead')
const AddMemberToLocalMuc$json = const {
  '1': 'AddMemberToLocalMuc',
  '2': const [
    const {'1': 'mucUid', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'mucUid'},
    const {'1': 'old_members', '3': 2, '4': 3, '5': 11, '6': '.proto.pub.v1.models.Member', '10': 'oldMembers'},
    const {'1': 'new_members', '3': 3, '4': 3, '5': 11, '6': '.proto.pub.v1.models.Member', '10': 'newMembers'},
    const {'1': 'name', '3': 4, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'issuer', '3': 5, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Member', '10': 'issuer'},
    const {'1': 'last_message_id', '3': 6, '4': 1, '5': 3, '10': 'lastMessageId'},
  ],
};

/// Descriptor for `AddMemberToLocalMuc`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addMemberToLocalMucDescriptor = $convert.base64Decode('');
...
const GetChannelRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'last_update', '3': 7, '4': 1, '5': 3, '10': 'lastUpdate'},
  ],
};

/// Descriptor for `GetChannelRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getChannelResDescriptor = $convert.base64Decode('');
