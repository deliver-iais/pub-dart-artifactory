...
class GetInfoReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetInfoReq', package: const $pb.PackageName('proto.pub.v1.sticker'), createEmptyInstance: create)
...
class GetInfoRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetInfoRes', package: const $pb.PackageName('proto.pub.v1.sticker'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOS(2, 'description')
    ..m<$core.String, $core.String>(3, 'commands', entryClassName: 'GetInfoRes.CommandsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('proto.pub.v1.sticker'))
    ..hasRequiredFields = false
  ;
...
class SearchByNameReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchByNameReq', package: const $pb.PackageName('proto.pub.v1.sticker'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..hasRequiredFields = false
  ;
...
class SearchByNameRes_SearchBotResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchByNameRes.SearchBotResult', package: const $pb.PackageName('proto.pub.v1.sticker'), createEmptyInstance: create)
    ..aOM<$12.Uid>(1, 'bot', subBuilder: $12.Uid.create)
    ..aOS(2, 'name')
    ..hasRequiredFields = false
  ;
...
class SearchByNameRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SearchByNameRes', package: const $pb.PackageName('proto.pub.v1.sticker'), createEmptyInstance: create)
