...
import 'models/file.pb.dart' as $15;
import 'models/form.pb.dart' as $23;
...
class GetInfoReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetInfoReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ..aOM<$17.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bot', subBuilder: $17.Uid.create)
  ...
  @$pb.TagNumber(1)
  $17.Uid get bot => $_getN(0);
  @$pb.TagNumber(1)
  set bot($17.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBot() => $_has(0);
  @$pb.TagNumber(1)
  void clearBot() => clearField(1);
  @$pb.TagNumber(1)
  $17.Uid ensureBot() => $_ensure(0);
}
...
class InlineQueryReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ...
    ..aOM<$17.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bot', subBuilder: $17.Uid.create)
    ...
    ..aOM<$17.Uid>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chat', subBuilder: $17.Uid.create)
    ..aOM<$20.Location>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $20.Location.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $17.Uid get bot => $_getN(1);
  @$pb.TagNumber(2)
  set bot($17.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBot() => $_has(1);
  @$pb.TagNumber(2)
  void clearBot() => clearField(2);
  @$pb.TagNumber(2)
  $17.Uid ensureBot() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $17.Uid get chat => $_getN(4);
  @$pb.TagNumber(6)
  set chat($17.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasChat() => $_has(4);
  @$pb.TagNumber(6)
  void clearChat() => clearField(6);
  @$pb.TagNumber(6)
  $17.Uid ensureChat() => $_ensure(4);

  @$pb.TagNumber(7)
  $20.Location get location => $_getN(5);
  @$pb.TagNumber(7)
  set location($20.Location v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLocation() => $_has(5);
  @$pb.TagNumber(7)
  void clearLocation() => clearField(7);
  @$pb.TagNumber(7)
  $20.Location ensureLocation() => $_ensure(5);
}
...
class InlineQueryResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6])
    ..aOM<$29.Text>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text', subBuilder: $29.Text.create)
    ..aOM<$15.File>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'file', subBuilder: $15.File.create)
    ..aOM<$15.File>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sticker', subBuilder: $15.File.create)
    ..aOM<$20.Location>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $20.Location.create)
    ..aOM<$29.ShareUid>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shareUid', subBuilder: $29.ShareUid.create)
    ..aOM<$23.Table>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table', subBuilder: $23.Table.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $29.Text get text => $_getN(0);
  @$pb.TagNumber(1)
  set text($29.Text v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasText() => $_has(0);
  @$pb.TagNumber(1)
  void clearText() => clearField(1);
  @$pb.TagNumber(1)
  $29.Text ensureText() => $_ensure(0);

  @$pb.TagNumber(2)
  $15.File get file => $_getN(1);
  @$pb.TagNumber(2)
  set file($15.File v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFile() => $_has(1);
  @$pb.TagNumber(2)
  void clearFile() => clearField(2);
  @$pb.TagNumber(2)
  $15.File ensureFile() => $_ensure(1);

  @$pb.TagNumber(3)
  $15.File get sticker => $_getN(2);
  @$pb.TagNumber(3)
  set sticker($15.File v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSticker() => $_has(2);
  @$pb.TagNumber(3)
  void clearSticker() => clearField(3);
  @$pb.TagNumber(3)
  $15.File ensureSticker() => $_ensure(2);

  @$pb.TagNumber(4)
  $20.Location get location => $_getN(3);
  @$pb.TagNumber(4)
  set location($20.Location v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLocation() => $_has(3);
  @$pb.TagNumber(4)
  void clearLocation() => clearField(4);
  @$pb.TagNumber(4)
  $20.Location ensureLocation() => $_ensure(3);

  @$pb.TagNumber(5)
  $29.ShareUid get shareUid => $_getN(4);
  @$pb.TagNumber(5)
  set shareUid($29.ShareUid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasShareUid() => $_has(4);
  @$pb.TagNumber(5)
  void clearShareUid() => clearField(5);
  @$pb.TagNumber(5)
  $29.ShareUid ensureShareUid() => $_ensure(4);

  @$pb.TagNumber(6)
  $23.Table get table => $_getN(5);
  @$pb.TagNumber(6)
  set table($23.Table v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTable() => $_has(5);
  @$pb.TagNumber(6)
  void clearTable() => clearField(6);
  @$pb.TagNumber(6)
  $23.Table ensureTable() => $_ensure(5);
}
...
class CallbackQueryReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallbackQueryReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messagePacketId')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageId')
  ...
  @$pb.TagNumber(2)
  $core.String get messagePacketId => $_getSZ(1);
  @$pb.TagNumber(2)
  set messagePacketId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasMessagePacketId() => $_has(1);
  @$pb.TagNumber(2)
  void clearMessagePacketId() => clearField(2);
