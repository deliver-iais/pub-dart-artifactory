...
import 'models/form.pb.dart' as $25;
...
class GetInfoReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetInfoReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ..aOM<$18.Uid>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bot', subBuilder: $18.Uid.create)
  ...
  @$pb.TagNumber(1)
  $18.Uid get bot => $_getN(0);
  @$pb.TagNumber(1)
  set bot($18.Uid v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasBot() => $_has(0);
  @$pb.TagNumber(1)
  void clearBot() => clearField(1);
  @$pb.TagNumber(1)
  $18.Uid ensureBot() => $_ensure(0);
}
...
class InlineQueryReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ...
    ..aOM<$18.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bot', subBuilder: $18.Uid.create)
    ...
    ..aOM<$18.Uid>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chat', subBuilder: $18.Uid.create)
    ..aOM<$22.Location>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $22.Location.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $18.Uid get bot => $_getN(1);
  @$pb.TagNumber(2)
  set bot($18.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBot() => $_has(1);
  @$pb.TagNumber(2)
  void clearBot() => clearField(2);
  @$pb.TagNumber(2)
  $18.Uid ensureBot() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $18.Uid get chat => $_getN(4);
  @$pb.TagNumber(6)
  set chat($18.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasChat() => $_has(4);
  @$pb.TagNumber(6)
  void clearChat() => clearField(6);
  @$pb.TagNumber(6)
  $18.Uid ensureChat() => $_ensure(4);

  @$pb.TagNumber(7)
  $22.Location get location => $_getN(5);
  @$pb.TagNumber(7)
  set location($22.Location v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLocation() => $_has(5);
  @$pb.TagNumber(7)
  void clearLocation() => clearField(7);
  @$pb.TagNumber(7)
  $22.Location ensureLocation() => $_ensure(5);
}
...
class InlineQueryResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6])
    ..aOM<$31.Text>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text', subBuilder: $31.Text.create)
    ...
    ..aOM<$22.Location>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $22.Location.create)
    ..aOM<$31.ShareUid>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shareUid', subBuilder: $31.ShareUid.create)
    ..aOM<$25.Table>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table', subBuilder: $25.Table.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $31.Text get text => $_getN(0);
  @$pb.TagNumber(1)
  set text($31.Text v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasText() => $_has(0);
  @$pb.TagNumber(1)
  void clearText() => clearField(1);
  @$pb.TagNumber(1)
  $31.Text ensureText() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $22.Location get location => $_getN(3);
  @$pb.TagNumber(4)
  set location($22.Location v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLocation() => $_has(3);
  @$pb.TagNumber(4)
  void clearLocation() => clearField(4);
  @$pb.TagNumber(4)
  $22.Location ensureLocation() => $_ensure(3);

  @$pb.TagNumber(5)
  $31.ShareUid get shareUid => $_getN(4);
  @$pb.TagNumber(5)
  set shareUid($31.ShareUid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasShareUid() => $_has(4);
  @$pb.TagNumber(5)
  void clearShareUid() => clearField(5);
  @$pb.TagNumber(5)
  $31.ShareUid ensureShareUid() => $_ensure(4);

  @$pb.TagNumber(6)
  $25.Table get table => $_getN(5);
  @$pb.TagNumber(6)
  set table($25.Table v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTable() => $_has(5);
  @$pb.TagNumber(6)
  void clearTable() => clearField(6);
  @$pb.TagNumber(6)
  $25.Table ensureTable() => $_ensure(5);
}
...
class CallbackQueryRes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallbackQueryRes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'redirectionUrl')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.String get redirectionUrl => $_getSZ(3);
  @$pb.TagNumber(4)
  set redirectionUrl($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasRedirectionUrl() => $_has(3);
  @$pb.TagNumber(4)
  void clearRedirectionUrl() => clearField(4);
}
