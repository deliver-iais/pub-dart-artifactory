...
import 'models/form.pb.dart' as $27;
...
class InlineQueryReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ...
    ..aOM<$20.Uid>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bot', subBuilder: $20.Uid.create)
    ...
    ..aOM<$20.Uid>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chat', subBuilder: $20.Uid.create)
    ..aOM<$24.Location>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $24.Location.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $20.Uid get bot => $_getN(1);
  @$pb.TagNumber(2)
  set bot($20.Uid v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBot() => $_has(1);
  @$pb.TagNumber(2)
  void clearBot() => clearField(2);
  @$pb.TagNumber(2)
  $20.Uid ensureBot() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $20.Uid get chat => $_getN(4);
  @$pb.TagNumber(6)
  set chat($20.Uid v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasChat() => $_has(4);
  @$pb.TagNumber(6)
  void clearChat() => clearField(6);
  @$pb.TagNumber(6)
  $20.Uid ensureChat() => $_ensure(4);

  @$pb.TagNumber(7)
  $24.Location get location => $_getN(5);
  @$pb.TagNumber(7)
  set location($24.Location v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLocation() => $_has(5);
  @$pb.TagNumber(7)
  void clearLocation() => clearField(7);
  @$pb.TagNumber(7)
  $24.Location ensureLocation() => $_ensure(5);
}
...
class InlineQueryResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6])
    ..aOM<$33.Text>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text', subBuilder: $33.Text.create)
    ..aOM<$18.File>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'file', subBuilder: $18.File.create)
    ..aOM<$18.File>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sticker', subBuilder: $18.File.create)
    ..aOM<$24.Location>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $24.Location.create)
    ..aOM<$33.ShareUid>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shareUid', subBuilder: $33.ShareUid.create)
    ..aOM<$27.Table>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table', subBuilder: $27.Table.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $33.Text get text => $_getN(0);
  @$pb.TagNumber(1)
  set text($33.Text v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasText() => $_has(0);
  @$pb.TagNumber(1)
  void clearText() => clearField(1);
  @$pb.TagNumber(1)
  $33.Text ensureText() => $_ensure(0);

  @$pb.TagNumber(2)
  $18.File get file => $_getN(1);
  @$pb.TagNumber(2)
  set file($18.File v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFile() => $_has(1);
  @$pb.TagNumber(2)
  void clearFile() => clearField(2);
  @$pb.TagNumber(2)
  $18.File ensureFile() => $_ensure(1);

  @$pb.TagNumber(3)
  $18.File get sticker => $_getN(2);
  @$pb.TagNumber(3)
  set sticker($18.File v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasSticker() => $_has(2);
  @$pb.TagNumber(3)
  void clearSticker() => clearField(3);
  @$pb.TagNumber(3)
  $18.File ensureSticker() => $_ensure(2);

  @$pb.TagNumber(4)
  $24.Location get location => $_getN(3);
  @$pb.TagNumber(4)
  set location($24.Location v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLocation() => $_has(3);
  @$pb.TagNumber(4)
  void clearLocation() => clearField(4);
  @$pb.TagNumber(4)
  $24.Location ensureLocation() => $_ensure(3);

  @$pb.TagNumber(5)
  $33.ShareUid get shareUid => $_getN(4);
  @$pb.TagNumber(5)
  set shareUid($33.ShareUid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasShareUid() => $_has(4);
  @$pb.TagNumber(5)
  void clearShareUid() => clearField(5);
  @$pb.TagNumber(5)
  $33.ShareUid ensureShareUid() => $_ensure(4);

  @$pb.TagNumber(6)
  $27.Table get table => $_getN(5);
  @$pb.TagNumber(6)
  set table($27.Table v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTable() => $_has(5);
  @$pb.TagNumber(6)
  void clearTable() => clearField(6);
  @$pb.TagNumber(6)
  $27.Table ensureTable() => $_ensure(5);
}
