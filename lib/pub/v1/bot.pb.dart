...
import 'models/form.pb.dart' as $24;
...
class InlineQueryReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ...
    ..aOM<$21.Location>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $21.Location.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $21.Location get location => $_getN(5);
  @$pb.TagNumber(7)
  set location($21.Location v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLocation() => $_has(5);
  @$pb.TagNumber(7)
  void clearLocation() => clearField(7);
  @$pb.TagNumber(7)
  $21.Location ensureLocation() => $_ensure(5);
}
...
class InlineQueryResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineQueryResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto.pub.v1.bot'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6])
    ..aOM<$30.Text>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text', subBuilder: $30.Text.create)
    ...
    ..aOM<$21.Location>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $21.Location.create)
    ..aOM<$30.ShareUid>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shareUid', subBuilder: $30.ShareUid.create)
    ..aOM<$24.Table>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table', subBuilder: $24.Table.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $30.Text get text => $_getN(0);
  @$pb.TagNumber(1)
  set text($30.Text v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasText() => $_has(0);
  @$pb.TagNumber(1)
  void clearText() => clearField(1);
  @$pb.TagNumber(1)
  $30.Text ensureText() => $_ensure(0);
  ...
  @$pb.TagNumber(4)
  $21.Location get location => $_getN(3);
  @$pb.TagNumber(4)
  set location($21.Location v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasLocation() => $_has(3);
  @$pb.TagNumber(4)
  void clearLocation() => clearField(4);
  @$pb.TagNumber(4)
  $21.Location ensureLocation() => $_ensure(3);

  @$pb.TagNumber(5)
  $30.ShareUid get shareUid => $_getN(4);
  @$pb.TagNumber(5)
  set shareUid($30.ShareUid v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasShareUid() => $_has(4);
  @$pb.TagNumber(5)
  void clearShareUid() => clearField(5);
  @$pb.TagNumber(5)
  $30.ShareUid ensureShareUid() => $_ensure(4);

  @$pb.TagNumber(6)
  $24.Table get table => $_getN(5);
  @$pb.TagNumber(6)
  set table($24.Table v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasTable() => $_has(5);
  @$pb.TagNumber(6)
  void clearTable() => clearField(6);
  @$pb.TagNumber(6)
  $24.Table ensureTable() => $_ensure(5);
}
