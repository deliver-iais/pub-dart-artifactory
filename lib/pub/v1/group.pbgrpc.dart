...
class GroupServiceClient extends $grpc.Client {
  ...
  static final _$hasPermission =
      $grpc.ClientMethod<$5.HasPermissionReq, $5.HasPermissionRes>(
          '/proto.pub.v1.group.GroupService/HasPermission',
          ($5.HasPermissionReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $5.HasPermissionRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$5.HasPermissionRes> hasPermission(
      $5.HasPermissionReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$hasPermission, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
}
...
abstract class GroupServiceBase extends $grpc.Service {
  ...
  GroupServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$5.HasPermissionReq, $5.HasPermissionRes>(
        'HasPermission',
        hasPermission_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $5.HasPermissionReq.fromBuffer(value),
        ($5.HasPermissionRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$5.HasPermissionRes> hasPermission_Pre($grpc.ServiceCall call,
      $async.Future<$5.HasPermissionReq> request) async {
  ...
  $async.Future<$5.HasPermissionRes> hasPermission(
      $grpc.ServiceCall call, $5.HasPermissionReq request);
}
