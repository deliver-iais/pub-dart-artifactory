...
class GroupServiceClient extends $grpc.Client {
  ...
  static final _$getPermissionInGroup = $grpc.ClientMethod<
          $5.GetPermissionInGroupReq, $5.GetPermissionInGroupRes>(
      '/proto.pub.v1.group.GroupService/GetPermissionInGroup',
      ($5.GetPermissionInGroupReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $5.GetPermissionInGroupRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$5.GetPermissionInGroupRes> getPermissionInGroup(
      $5.GetPermissionInGroupReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$getPermissionInGroup, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
}
...
abstract class GroupServiceBase extends $grpc.Service {
  ...
  GroupServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$5.GetPermissionInGroupReq,
            $5.GetPermissionInGroupRes>(
        'GetPermissionInGroup',
        getPermissionInGroup_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $5.GetPermissionInGroupReq.fromBuffer(value),
        ($5.GetPermissionInGroupRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$5.GetPermissionInGroupRes> getPermissionInGroup_Pre(
      $grpc.ServiceCall call,
      $async.Future<$5.GetPermissionInGroupReq> request) async {
    return getPermissionInGroup(call, await request);
  }
  ...
  $async.Future<$5.GetPermissionInGroupRes> getPermissionInGroup(
      $grpc.ServiceCall call, $5.GetPermissionInGroupReq request);
}
