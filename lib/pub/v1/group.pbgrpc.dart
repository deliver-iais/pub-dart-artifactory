...
class GroupServiceClient extends $grpc.Client {
  ...
  static final _$syncLocalGroup =
      $grpc.ClientMethod<$8.SyncLocalGroupReq, $8.SyncLocalGroupRes>(
          '/proto.pub.v1.group.GroupService/SyncLocalGroup',
          ($8.SyncLocalGroupReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $8.SyncLocalGroupRes.fromBuffer(value));
  static final _$addMemberToLocalMuc = $grpc.ClientMethod<
          $8.AddMembersToLocalMucReq, $8.AddMembersToLocalMucRes>(
      '/proto.pub.v1.group.GroupService/AddMemberToLocalMuc',
      ($8.AddMembersToLocalMucReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $8.AddMembersToLocalMucRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$8.SyncLocalGroupRes> syncLocalGroup(
      $8.SyncLocalGroupReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$syncLocalGroup, request, options: options);
  }

  $grpc.ResponseFuture<$8.AddMembersToLocalMucRes> addMemberToLocalMuc(
      $8.AddMembersToLocalMucReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$addMemberToLocalMuc, request, options: options);
  }
}
...
abstract class GroupServiceBase extends $grpc.Service {
  ...
  GroupServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$8.SyncLocalGroupReq, $8.SyncLocalGroupRes>(
        'SyncLocalGroup',
        syncLocalGroup_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $8.SyncLocalGroupReq.fromBuffer(value),
        ($8.SyncLocalGroupRes value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$8.AddMembersToLocalMucReq,
            $8.AddMembersToLocalMucRes>(
        'AddMemberToLocalMuc',
        addMemberToLocalMuc_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $8.AddMembersToLocalMucReq.fromBuffer(value),
        ($8.AddMembersToLocalMucRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$8.SyncLocalGroupRes> syncLocalGroup_Pre($grpc.ServiceCall call,
      $async.Future<$8.SyncLocalGroupReq> request) async {
    return syncLocalGroup(call, await request);
  }

  $async.Future<$8.AddMembersToLocalMucRes> addMemberToLocalMuc_Pre(
      $grpc.ServiceCall call,
      $async.Future<$8.AddMembersToLocalMucReq> request) async {
    return addMemberToLocalMuc(call, await request);
  }
  ...
  $async.Future<$8.SyncLocalGroupRes> syncLocalGroup(
      $grpc.ServiceCall call, $8.SyncLocalGroupReq request);
  $async.Future<$8.AddMembersToLocalMucRes> addMemberToLocalMuc(
      $grpc.ServiceCall call, $8.AddMembersToLocalMucReq request);
}
