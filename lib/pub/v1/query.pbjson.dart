...
const SaveLocalMessageRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'messages_size', '3': 2, '4': 1, '5': 3, '10': 'messagesSize'},
  ],
};

/// Descriptor for `SaveLocalMessageRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List saveLocalMessageResDescriptor = $convert.base64Decode('ChNTYXZlTG9jYWxNZXNzYWdlUmVzEiYKD2xhc3RfbWVzc2FnZV9pZBgBIAEoA1INbGFzdE1lc3NhZ2VJZBIjCg1tZXNzYWdlc19zaXplGAIgASgDUgxtZXNzYWdlc1NpemU=');
