...
@$core.Deprecated('Use getIsVerifiedReqDescriptor instead')
const GetIsVerifiedReq$json = const {
  '1': 'GetIsVerifiedReq',
  '2': const [
    const {'1': 'uid', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'uid'},
  ],
...
/// Descriptor for `GetIsVerifiedReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getIsVerifiedReqDescriptor = $convert.base64Decode('ChBHZXRJc1ZlcmlmaWVkUmVxEioKA3VpZBgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgN1aWQ=');
@$core.Deprecated('Use getIsVerifiedResDescriptor instead')
const GetIsVerifiedRes$json = const {
  '1': 'GetIsVerifiedRes',
  '2': const [
    const {'1': 'expire_time', '3': 1, '4': 1, '5': 3, '10': 'expireTime'},
  ],
};

/// Descriptor for `GetIsVerifiedRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getIsVerifiedResDescriptor = $convert.base64Decode('ChBHZXRJc1ZlcmlmaWVkUmVzEh8KC2V4cGlyZV90aW1lGAEgASgDUgpleHBpcmVUaW1l');
...
const GetLastActivityRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'last_seen_status', '3': 2, '4': 1, '5': 14, '6': '.proto.pub.v1.models.LastSeenStatus', '10': 'lastSeenStatus'},
  ],
};

/// Descriptor for `GetLastActivityRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getLastActivityResDescriptor = $convert.base64Decode('ChJHZXRMYXN0QWN0aXZpdHlSZXMSLAoSbGFzdF9hY3Rpdml0eV90aW1lGAEgASgDUhBsYXN0QWN0aXZpdHlUaW1lEk0KEGxhc3Rfc2Vlbl9zdGF0dXMYAiABKA4yIy5wcm90by5wdWIudjEubW9kZWxzLkxhc3RTZWVuU3RhdHVzUg5sYXN0U2VlblN0YXR1cw==');
@$core.Deprecated('Use checkCallAvailabilityStatusReqDescriptor instead')
const CheckCallAvailabilityStatusReq$json = const {
  '1': 'CheckCallAvailabilityStatusReq',
  '2': const [
    const {'1': 'uid', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'uid'},
  ],
};

/// Descriptor for `CheckCallAvailabilityStatusReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List checkCallAvailabilityStatusReqDescriptor = $convert.base64Decode('Ch5DaGVja0NhbGxBdmFpbGFiaWxpdHlTdGF0dXNSZXESKgoDdWlkGAEgASgLMhgucHJvdG8ucHViLnYxLm1vZGVscy5VaWRSA3VpZA==');
@$core.Deprecated('Use checkCallAvailabilityStatusResDescriptor instead')
const CheckCallAvailabilityStatusRes$json = const {
  '1': 'CheckCallAvailabilityStatusRes',
  '2': const [
    const {'1': 'is_allowed', '3': 1, '4': 1, '5': 8, '10': 'isAllowed'},
  ],
};

/// Descriptor for `CheckCallAvailabilityStatusRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List checkCallAvailabilityStatusResDescriptor = $convert.base64Decode('Ch5DaGVja0NhbGxBdmFpbGFiaWxpdHlTdGF0dXNSZXMSHQoKaXNfYWxsb3dlZBgBIAEoCFIJaXNBbGxvd2Vk');
@$core.Deprecated('Use saveLocalMessageReqDescriptor instead')
const SaveLocalMessageReq$json = const {
  '1': 'SaveLocalMessageReq',
  '2': const [
    const {'1': 'local_chat_id', '3': 1, '4': 1, '5': 3, '10': 'localChatId'},
    const {'1': 'messages', '3': 2, '4': 3, '5': 11, '6': '.proto.pub.v1.models.LocalChatMessage', '10': 'messages'},
    const {'1': 'room_uid', '3': 3, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'roomUid'},
  ],
};

/// Descriptor for `SaveLocalMessageReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List saveLocalMessageReqDescriptor = $convert.base64Decode('ChNTYXZlTG9jYWxNZXNzYWdlUmVxEiIKDWxvY2FsX2NoYXRfaWQYASABKANSC2xvY2FsQ2hhdElkEkEKCG1lc3NhZ2VzGAIgAygLMiUucHJvdG8ucHViLnYxLm1vZGVscy5Mb2NhbENoYXRNZXNzYWdlUghtZXNzYWdlcxIzCghyb29tX3VpZBgDIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgdyb29tVWlk');
@$core.Deprecated('Use saveLocalMessageResDescriptor instead')
const SaveLocalMessageRes$json = const {
  '1': 'SaveLocalMessageRes',
  '2': const [
    const {'1': 'last_message_id', '3': 1, '4': 1, '5': 3, '10': 'lastMessageId'},
    const {'1': 'last_local_chat_id', '3': 2, '4': 1, '5': 3, '10': 'lastLocalChatId'},
  ],
};

/// Descriptor for `SaveLocalMessageRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List saveLocalMessageResDescriptor = $convert.base64Decode('ChNTYXZlTG9jYWxNZXNzYWdlUmVzEiYKD2xhc3RfbWVzc2FnZV9pZBgBIAEoA1INbGFzdE1lc3NhZ2VJZBIrChJsYXN0X2xvY2FsX2NoYXRfaWQYAiABKANSD2xhc3RMb2NhbENoYXRJZA==');
...
const GetMetaCountsRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'all_media_deleted_count', '3': 7, '4': 1, '5': 3, '10': 'allMediaDeletedCount'},
    const {'1': 'all_files_deleted_count', '3': 8, '4': 1, '5': 3, '10': 'allFilesDeletedCount'},
    const {'1': 'all_musics_deleted_count', '3': 9, '4': 1, '5': 3, '10': 'allMusicsDeletedCount'},
    const {'1': 'all_voices_deleted_count', '3': 10, '4': 1, '5': 3, '10': 'allVoicesDeletedCount'},
    const {'1': 'all_links_deleted_count', '3': 11, '4': 1, '5': 3, '10': 'allLinksDeletedCount'},
    const {'1': 'all_call_deleted_count', '3': 12, '4': 1, '5': 3, '10': 'allCallDeletedCount'},
  ],
};

/// Descriptor for `GetMetaCountsRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMetaCountsResDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use setMuteSettingsOfRoomReqDescriptor instead')
const SetMuteSettingsOfRoomReq$json = const {
  '1': 'SetMuteSettingsOfRoomReq',
  '2': const [
    const {'1': 'room', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'room'},
    const {'1': 'settings', '3': 2, '4': 1, '5': 11, '6': '.proto.pub.v1.models.MuteSettings', '10': 'settings'},
  ],
};

/// Descriptor for `SetMuteSettingsOfRoomReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List setMuteSettingsOfRoomReqDescriptor = $convert.base64Decode('ChhTZXRNdXRlU2V0dGluZ3NPZlJvb21SZXESLAoEcm9vbRgBIAEoCzIYLnByb3RvLnB1Yi52MS5tb2RlbHMuVWlkUgRyb29tEj0KCHNldHRpbmdzGAIgASgLMiEucHJvdG8ucHViLnYxLm1vZGVscy5NdXRlU2V0dGluZ3NSCHNldHRpbmdz');
@$core.Deprecated('Use setMuteSettingsOfRoomResDescriptor instead')
const SetMuteSettingsOfRoomRes$json = const {
  '1': 'SetMuteSettingsOfRoomRes',
};

/// Descriptor for `SetMuteSettingsOfRoomRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List setMuteSettingsOfRoomResDescriptor = $convert.base64Decode('ChhTZXRNdXRlU2V0dGluZ3NPZlJvb21SZXM=');
@$core.Deprecated('Use updateSettingsReqDescriptor instead')
const UpdateSettingsReq$json = const {
  '1': 'UpdateSettingsReq',
  '2': const [
    const {'1': 'settings', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Settings', '10': 'settings'},
  ],
};

/// Descriptor for `UpdateSettingsReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateSettingsReqDescriptor = $convert.base64Decode('ChFVcGRhdGVTZXR0aW5nc1JlcRI5CghzZXR0aW5ncxgBIAEoCzIdLnByb3RvLnB1Yi52MS5tb2RlbHMuU2V0dGluZ3NSCHNldHRpbmdz');
@$core.Deprecated('Use updateSettingsResDescriptor instead')
const UpdateSettingsRes$json = const {
  '1': 'UpdateSettingsRes',
  '2': const [
    const {'1': 'settings', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Settings', '10': 'settings'},
  ],
...
/// Descriptor for `UpdateSettingsRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateSettingsResDescriptor = $convert.base64Decode('ChFVcGRhdGVTZXR0aW5nc1JlcxI5CghzZXR0aW5ncxgBIAEoCzIdLnByb3RvLnB1Yi52MS5tb2RlbHMuU2V0dGluZ3NSCHNldHRpbmdz');
@$core.Deprecated('Use getSettingsReqDescriptor instead')
const GetSettingsReq$json = const {
  '1': 'GetSettingsReq',
};

/// Descriptor for `GetSettingsReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSettingsReqDescriptor = $convert.base64Decode('Cg5HZXRTZXR0aW5nc1JlcQ==');
@$core.Deprecated('Use getSettingsResDescriptor instead')
const GetSettingsRes$json = const {
  '1': 'GetSettingsRes',
  '2': const [
    const {'1': 'settings', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Settings', '10': 'settings'},
  ],
...
/// Descriptor for `GetSettingsRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSettingsResDescriptor = $convert.base64Decode('Cg5HZXRTZXR0aW5nc1JlcxI5CghzZXR0aW5ncxgBIAEoCzIdLnByb3RvLnB1Yi52MS5tb2RlbHMuU2V0dGluZ3NSCHNldHRpbmdz');
