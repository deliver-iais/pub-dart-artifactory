...
const SaveLocalMessageReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'messages', '3': 2, '4': 3, '5': 11, '6': '.proto.pub.v1.models.MessageByClient', '10': 'messages'},
  ],
};

/// Descriptor for `SaveLocalMessageReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List saveLocalMessageReqDescriptor = $convert.base64Decode('ChNTYXZlTG9jYWxNZXNzYWdlUmVxEiIKDWxvY2FsX2NoYXRfaWQYASABKANSC2xvY2FsQ2hhdElkEkAKCG1lc3NhZ2VzGAIgAygLMiQucHJvdG8ucHViLnYxLm1vZGVscy5NZXNzYWdlQnlDbGllbnRSCG1lc3NhZ2Vz');
