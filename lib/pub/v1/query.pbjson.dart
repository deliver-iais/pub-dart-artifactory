...
const QueryDirection$json = const {
  ...
  '2': const [
    ...
    const {'1': 'FORWARD_EXCLUSIVE', '2': 2},
    const {'1': 'BACKWARD_EXCLUSIVE', '2': 3},
  ],
};

/// Descriptor for `QueryDirection`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List queryDirectionDescriptor = $convert.base64Decode('Cg5RdWVyeURpcmVjdGlvbhIVChFGT1JXQVJEX0lOQ0xVU0lWRRAAEhYKEkJBQ0tXQVJEX0lOQ0xVU0lWRRABEhUKEUZPUldBUkRfRVhDTFVTSVZFEAISFgoSQkFDS1dBUkRfRVhDTFVTSVZFEAM=');
...
@$core.Deprecated('Use fetchMetaReqDescriptor instead')
const FetchMetaReq$json = const {
  '1': 'FetchMetaReq',
  '2': const [
    const {'1': 'room_uid', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'roomUid'},
    const {'1': 'pointer', '3': 2, '4': 1, '5': 3, '10': 'pointer'},
    const {'1': 'year', '3': 3, '4': 1, '5': 5, '10': 'year'},
    const {'1': 'group', '3': 4, '4': 1, '5': 14, '6': '.proto.pub.v1.models.MetaGroup', '10': 'group'},
    const {'1': 'direction', '3': 5, '4': 1, '5': 14, '6': '.proto.pub.v1.query.QueryDirection', '10': 'direction'},
    const {'1': 'limit', '3': 6, '4': 1, '5': 5, '10': 'limit'},
  ],
};

/// Descriptor for `FetchMetaReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fetchMetaReqDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use fetchMetaResDescriptor instead')
const FetchMetaRes$json = const {
  '1': 'FetchMetaRes',
  '2': const [
...
/// Descriptor for `FetchMetaRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fetchMetaResDescriptor = $convert.base64Decode('CgxGZXRjaE1ldGFSZXMSNgoJbWV0YV9saXN0GAEgAygLMhkucHJvdG8ucHViLnYxLm1vZGVscy5NZXRhUghtZXRhTGlzdA==');
...
final $typed_data.Uint8List fetchMessageMetaIndexReqDescriptor = $convert.base64Decode('ChhGZXRjaE1lc3NhZ2VNZXRhSW5kZXhSZXESMwoIcm9vbV91aWQYASABKAsyGC5wcm90by5wdWIudjEubW9kZWxzLlVpZFIHcm9vbVVpZBIdCgptZXNzYWdlX2lkGAIgASgDUgltZXNzYWdlSWQSEgoEeWVhchgDIAEoBVIEeWVhchI0CgVncm91cBgEIAEoDjIeLnByb3RvLnB1Yi52MS5tb2RlbHMuTWV0YUdyb3VwUgVncm91cA==');
...
final $typed_data.Uint8List fetchMetaDeletedIndexesReqDescriptor = $convert.base64Decode('');
