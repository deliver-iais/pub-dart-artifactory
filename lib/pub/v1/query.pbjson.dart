...
const GetMetaCountsRes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'all_voices_count', '3': 3, '4': 1, '5': 3, '10': 'allVoicesCount'},
    const {'1': 'all_musics_count', '3': 4, '4': 1, '5': 3, '10': 'allMusicsCount'},
...
final $typed_data.Uint8List getMetaCountsResDescriptor = $convert.base64Decode('');
...
const FetchMetaReq$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pointer', '3': 2, '4': 1, '5': 3, '10': 'pointer'},
    const {'1': 'year', '3': 3, '4': 1, '5': 5, '10': 'year'},
    const {'1': 'media_type', '3': 4, '4': 1, '5': 14, '6': '.proto.pub.v1.query.FetchMetaReq.Group', '10': 'mediaType'},
    const {'1': 'fetching_direction_type', '3': 5, '4': 1, '5': 14, '6': '.proto.pub.v1.query.FetchMetaReq.Direction', '10': 'fetchingDirectionType'},
    const {'1': 'limit', '3': 6, '4': 1, '5': 5, '10': 'limit'},
  ],
  '4': const [FetchMetaReq_Group$json, FetchMetaReq_Direction$json],
};

@$core.Deprecated('Use fetchMetaReqDescriptor instead')
const FetchMetaReq_Group$json = const {
  '1': 'Group',
  '2': const [
    const {'1': 'MEDIA', '2': 0},
    const {'1': 'MUSICS', '2': 1},
...
@$core.Deprecated('Use fetchMetaReqDescriptor instead')
const FetchMetaReq_Direction$json = const {
  '1': 'Direction',
  '2': const [
    const {'1': 'FORWARD_FETCH', '2': 0},
    const {'1': 'BACKWARD_FETCH', '2': 1},
...
final $typed_data.Uint8List fetchMetaReqDescriptor = $convert.base64Decode('');
