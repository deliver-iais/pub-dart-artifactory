...
@$core.Deprecated('Use removeRoomReqDescriptor instead')
const RemoveRoomReq$json = const {
  '1': 'RemoveRoomReq',
  '2': const [
    const {'1': 'room_uid', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.models.Uid', '10': 'roomUid'},
  ],
...
/// Descriptor for `RemoveRoomReq`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List removeRoomReqDescriptor = $convert.base64Decode('Cg1SZW1vdmVSb29tUmVxEjMKCHJvb21fdWlkGAEgASgLMhgucHJvdG8ucHViLnYxLm1vZGVscy5VaWRSB3Jvb21VaWQ=');
@$core.Deprecated('Use removeRoomResDescriptor instead')
const RemoveRoomRes$json = const {
  '1': 'RemoveRoomRes',
};

/// Descriptor for `RemoveRoomRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List removeRoomResDescriptor = $convert.base64Decode('Cg1SZW1vdmVSb29tUmVz');
