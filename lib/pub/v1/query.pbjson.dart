...
const GetAllUserRoomMetaRes$json = const {
  ...
  '2': const [
    const {'1': 'roomsMeta', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.RoomMetadata', '10': 'roomsMeta'},
    const {'1': 'finished', '3': 2, '4': 1, '5': 8, '10': 'finished'},
  ],
};

/// Descriptor for `GetAllUserRoomMetaRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAllUserRoomMetaResDescriptor = $convert.base64Decode('ChVHZXRBbGxVc2VyUm9vbU1ldGFSZXMSPwoJcm9vbXNNZXRhGAEgAygLMiEucHJvdG8ucHViLnYxLm1vZGVscy5Sb29tTWV0YWRhdGFSCXJvb21zTWV0YRIaCghmaW5pc2hlZBgCIAEoCFIIZmluaXNoZWQ=');
