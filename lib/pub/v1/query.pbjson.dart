...
const IdIsAvailableRes$json = const {
  '1': 'IdIsAvailableRes',
  '2': const [
    const {'1': 'status', '3': 1, '4': 1, '5': 14, '6': '.proto.pub.v1.query.IdIsAvailableRes.Status', '10': 'status'},
  ],
  '4': const [IdIsAvailableRes_Status$json],
};

const IdIsAvailableRes_Status$json = const {
  '1': 'Status',
  '2': const [
...
const SetIdRes$json = const {
  '1': 'SetIdRes',
  '2': const [
    const {'1': 'status', '3': 1, '4': 1, '5': 14, '6': '.proto.pub.v1.query.SetIdRes.Status', '10': 'status'},
  ],
  '4': const [SetIdRes_Status$json],
};

const SetIdRes_Status$json = const {
  '1': 'Status',
  '2': const [
    const {'1': 'OK', '2': 0},
    const {'1': 'ALREADY_EXIST', '2': 1},
