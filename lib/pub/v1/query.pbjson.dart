...
const GetShowcasesReq$json = const {
  '1': 'GetShowcasesReq',
  '2': const [
    const {'1': 'user_preference', '3': 1, '4': 1, '5': 11, '6': '.proto.pub.v1.query.UserPreference', '10': 'userPreference'},
    const {'1': 'pointer', '3': 2, '4': 1, '5': 3, '10': 'pointer'},
    const {'1': 'limit', '3': 3, '4': 1, '5': 3, '10': 'limit'},
  ],
};
...
final $typed_data.Uint8List getShowcasesReqDescriptor = $convert.base64Decode('Cg9HZXRTaG93Y2FzZXNSZXESSwoPdXNlcl9wcmVmZXJlbmNlGAEgASgLMiIucHJvdG8ucHViLnYxLnF1ZXJ5LlVzZXJQcmVmZXJlbmNlUg51c2VyUHJlZmVyZW5jZRIYCgdwb2ludGVyGAIgASgDUgdwb2ludGVyEhQKBWxpbWl0GAMgASgDUgVsaW1pdA==');
...
final $typed_data.Uint8List getAnnouncementReqDescriptor = $convert.base64Decode('ChJHZXRBbm5vdW5jZW1lbnRSZXESSwoPdXNlcl9wcmVmZXJlbmNlGAEgASgLMiIucHJvdG8ucHViLnYxLnF1ZXJ5LlVzZXJQcmVmZXJlbmNlUg51c2VyUHJlZmVyZW5jZQ==');
@$core.Deprecated('Use getAnnouncementResDescriptor instead')
const GetAnnouncementRes$json = const {
  '1': 'GetAnnouncementRes',
  '2': const [
    const {'1': 'announcement', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.Announcement', '10': 'announcement'},
  ],
};

/// Descriptor for `GetAnnouncementRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAnnouncementResDescriptor = $convert.base64Decode('ChJHZXRBbm5vdW5jZW1lbnRSZXMSRQoMYW5ub3VuY2VtZW50GAEgAygLMiEucHJvdG8ucHViLnYxLm1vZGVscy5Bbm5vdW5jZW1lbnRSDGFubm91bmNlbWVudA==');
