...
const FetchUserCallsRes$json = const {
  '1': 'FetchUserCallsRes',
  '2': const [
    const {'1': 'cellEvents', '3': 1, '4': 3, '5': 11, '6': '.proto.pub.v1.models.CallEvent', '10': 'cellEvents'},
  ],
};

/// Descriptor for `FetchUserCallsRes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fetchUserCallsResDescriptor = $convert.base64Decode('ChFGZXRjaFVzZXJDYWxsc1JlcxI+CgpjZWxsRXZlbnRzGAEgAygLMh4ucHJvdG8ucHViLnYxLm1vZGVscy5DYWxsRXZlbnRSCmNlbGxFdmVudHM=');
