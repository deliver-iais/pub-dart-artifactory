...
class AuthServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$9.SendErasePasswordEmailRes> sendErasePasswordEmail(
...
abstract class AuthServiceBase extends $grpc.Service {
  ...
  AuthServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$9.SendErasePasswordEmailReq,
        ...
        ($9.SendErasePasswordEmailRes value) => value.writeToBuffer()));
  ...
  $async.Future<$9.SendErasePasswordEmailRes> sendErasePasswordEmail_Pre(
      $grpc.ServiceCall call,
  ...
  $async.Future<$9.SendErasePasswordEmailRes> sendErasePasswordEmail(
