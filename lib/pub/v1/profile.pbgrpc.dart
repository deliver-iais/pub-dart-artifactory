...
class AuthServiceClient extends $grpc.Client {
  ...
  static final _$getQrCodeToken =
      $grpc.ClientMethod<$9.GetQrCodeTokenReq, $9.GetQrCodeTokenRes>(
          '/proto.pub.v1.profile.AuthService/GetQrCodeToken',
          ($9.GetQrCodeTokenReq value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $9.GetQrCodeTokenRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$9.GetQrCodeTokenRes> getQrCodeToken(
      $9.GetQrCodeTokenReq request,
      {$grpc.CallOptions options}) {
    return $createUnaryCall(_$getQrCodeToken, request, options: options);
  }
...
abstract class AuthServiceBase extends $grpc.Service {
  ...
  AuthServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$9.GetQrCodeTokenReq, $9.GetQrCodeTokenRes>(
        'GetQrCodeToken',
        getQrCodeToken_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $9.GetQrCodeTokenReq.fromBuffer(value),
        ($9.GetQrCodeTokenRes value) => value.writeToBuffer()));
  ...
  $async.Future<$9.GetQrCodeTokenRes> getQrCodeToken_Pre($grpc.ServiceCall call,
      $async.Future<$9.GetQrCodeTokenReq> request) async {
    return getQrCodeToken(call, await request);
  }
  ...
  $async.Future<$9.GetQrCodeTokenRes> getQrCodeToken(
      $grpc.ServiceCall call, $9.GetQrCodeTokenReq request);
