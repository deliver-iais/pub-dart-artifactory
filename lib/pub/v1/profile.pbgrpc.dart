...
class ContactServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$5.UserSearchRes> searchUserByName(
      $5.UserSearchReq request,
      {$grpc.CallOptions options}) {
    final call = $createCall(
...
abstract class ContactServiceBase extends $grpc.Service {
  ...
  $async.Future<$5.UserSearchRes> searchUserByName_Pre(
  ...
  $async.Future<$5.UserSearchRes> searchUserByName(
