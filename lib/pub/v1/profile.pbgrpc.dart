...
class UserServiceClient extends $grpc.Client {
  ...
  static final _$getWebViewIdentifyToken = $grpc.ClientMethod<
          $13.GetWebViewIdentifyTokenReq, $13.GetWebViewIdentifyTokenRes>(
      '/proto.pub.v1.profile.UserService/GetWebViewIdentifyToken',
      ($13.GetWebViewIdentifyTokenReq value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $13.GetWebViewIdentifyTokenRes.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$13.GetWebViewIdentifyTokenRes> getWebViewIdentifyToken(
      $13.GetWebViewIdentifyTokenReq request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getWebViewIdentifyToken, request,
        options: options);
  }
}
...
abstract class UserServiceBase extends $grpc.Service {
  ...
  UserServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$13.GetWebViewIdentifyTokenReq,
            $13.GetWebViewIdentifyTokenRes>(
        'GetWebViewIdentifyToken',
        getWebViewIdentifyToken_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $13.GetWebViewIdentifyTokenReq.fromBuffer(value),
        ($13.GetWebViewIdentifyTokenRes value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$13.GetWebViewIdentifyTokenRes> getWebViewIdentifyToken_Pre(
      $grpc.ServiceCall call,
      $async.Future<$13.GetWebViewIdentifyTokenReq> request) async {
    return getWebViewIdentifyToken(call, await request);
  }
  ...
  $async.Future<$13.GetWebViewIdentifyTokenRes> getWebViewIdentifyToken(
      $grpc.ServiceCall call, $13.GetWebViewIdentifyTokenReq request);
}
